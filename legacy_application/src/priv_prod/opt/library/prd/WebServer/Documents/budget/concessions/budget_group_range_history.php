...
$query3="select budget_group,cash_type,gmp,sum(year1) as 'year1',sum(year2) as 'year2',sum(year2-year1) as 'difference'
...
extract($row5);
*/
echo "<table align='center'><tr><td>Centers:<font color='red'> $num3 </font></td></tr></table>";
