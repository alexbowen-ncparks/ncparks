...
echo "<tr><td colspan='3'><a href='stepL3e.php?project_category=$project_category&project_name=$project_name&step_group=$step_group&step_num=$step_num'>Mark Complete</a></td></tr>";
echo "</table>";
