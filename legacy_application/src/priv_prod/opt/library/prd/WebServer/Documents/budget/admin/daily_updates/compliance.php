...
$buof_comment_query="update cash_summary set buof_comment='$buof_comment',compliance='$compliance',buof_player='$tempID',buof_comment_date='$system_entry_date' where id='$comment_id' ";

echo "<br />buof_comment_query=$buof_comment_query<br />";  exit;
