...
from report_budget_history_multiyear2
where 1
and account='434196001' or account='434196002' or account='434400'
group by center;
";
...
from report_budget_history_multiyear2
where 1
and  (cash_type='receipt' and account != '434410003' and account != '434410004' and account != '434196001' and account != '434196002' and account != '434400')
or 
