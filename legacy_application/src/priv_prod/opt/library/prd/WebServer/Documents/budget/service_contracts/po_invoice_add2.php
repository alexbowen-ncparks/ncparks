...
$query2=" insert into `budget_service_contracts`.`invoices` set
          `scid`='$scid',`invoice_num`='$invoice_num2',`invoice_date`='$invoice_date',`invoice_amount`='$invoice_amount2',`ncas_account`='$ncas_account',`center`='$center',`park`='$park',`company`='$company',
		  `service_period`='$service_period',`cashier`='$tempid',`cashier_date`='$system_entry_date',`remit_name`='$remit_name',`remit_address`='$remit_address'  ";
...
$query1="insert into `budget_service_contracts`.`pay_lines` SET";
...
//if($po_line_num_beg_bal2==''){continue;}
	...
	$query2.=" payline_num='$payline_num[$j]',";
	$query2.=" payline_amount='$payline_amount2',";
	$query2.=" scid='$scid',";
	$query2.=" invoice_num='$invoice_num2'";
...
header("location: po_invoice_update.php?scid=$scid&eid=$last_id ");
