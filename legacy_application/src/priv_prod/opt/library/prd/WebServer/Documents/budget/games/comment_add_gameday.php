...
$query2=" insert into gameday_comments set
gid='$gid',user='$tempID',park='$infotrack_location',system_entry_date='$system_entry_date',
...
header("location: gameday.php?comment=y&add_comment=y&folder=community&gid=$gid");
