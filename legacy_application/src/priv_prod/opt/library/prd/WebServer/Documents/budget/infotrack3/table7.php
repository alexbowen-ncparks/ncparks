...
include("style1.html");
echo "<table class='center'><tr><td><a href='table7.php?add=y'>ADD Record</a></td></tr></table>"; 
//$decimalFields=array("");
$skip_array=array("");
$primaryField="id";
...
//if($district==''){exit;}
echo "<form method='post' action='table7.php'>";
...
echo "<th><a href='table7.php?order_by=$v&asc_desc=$asc_desc2'>$v</a><br />sorted $asc_desc <br />";include('autocomplete_table7.php'); echo"</th>";
}
else
{
echo "<th><a href='table7.php?order_by=$v'>$v</a></th>";
}
}
echo "</tr>";
...
foreach($ARRAY as $k=>$v)
	...
	echo "<tr$tr>";
		...
		foreach($v as $k1=>$v1){// each field, e.g., $tempID=$v[tempID];
			...
			if($k1==$primaryField){echo "<td>$v1 <a href='table7.php?edit=y&pf=$v1'>Edit</a></td>";} else  {echo "<td>$v1</td>";}
