...
if($id!=$idS)
{
echo "<td><a href=sspd1.php?menu_fa=fa1&type=search&parkS=$parkS&fas_numS=$fas_numS&del=yes&idS=$id><img height='15' width='15' src='/budget/infotrack/icon_photos/mission_icon_photos_263.png' alt='red trash can' title='delete'></img></a></td>";
}
if($id==$idS)
{
echo "<td><font class='cartRow'><font color='red'>Delete Record?</font><br /><br /><table align='center' cellpadding='10'><tr$t><th><a href='sspd1.php?menu_fa_fa1&type=search&parkS=$parkS&fas_numS=$fas_numS'>Yes</a></th><th><a href='sspd1.php?menu_fa_fa1&type=search&parkS=$parkS&fas_numS=$fas_numS'>No</a></th></tr></table></font></td>";
