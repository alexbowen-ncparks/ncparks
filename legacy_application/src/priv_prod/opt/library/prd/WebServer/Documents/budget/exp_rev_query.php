...
//echo "Line 34: Center Session New=$_SESSION['budget']['centerSess_new']<br />";
//echo $_SESSION['budget']['centerSess'];
//echo "<br />";
//echo $_SESSION['budget']['centerSess_new'];
if($level<2){
//$S=$_SESSION['budget']['centerSess'];
$S=$_SESSION['budget']['centerSess_new'];
...
$result = mysqli_query($connection, $q) or die ("Couldn't execute query. $q");
$row=mysqli_fetch_array($result);extract($row);
