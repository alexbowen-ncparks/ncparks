...
$query="insert into $table(user,system_entry_date,project_category,project_name,project_note,weblink,author) 
values ('$user','$system_entry_date','$project_category','$project_name','$project_note','$weblink','$myusername')";

mysqli_query($connection, $query) or die ("Couldn't execute query 1.  $query");


////mysql_close();
header("location:search_notes.php?project_category=$project_category&project_name=$project_name&user_id=$user");
