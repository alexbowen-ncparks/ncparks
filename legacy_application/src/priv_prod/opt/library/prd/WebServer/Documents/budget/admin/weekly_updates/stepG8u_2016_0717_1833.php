...
$query2="insert into exp_rev_ws(center,fund,acctdate,invoice,pe,description,debit,credit,sys,acct,f_year)
select center,'1280',post_date,invoice_new,'','warehouse',pricexquantity,'','wa',acct,f_year
