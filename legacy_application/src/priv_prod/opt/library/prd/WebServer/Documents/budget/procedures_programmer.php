...
if($pid==''){echo "<br />Add Programmer Procedure<br />"; exit;}

$query4a="select procedure_document from procedures_programmer where pid='$pid' ";
...
if($show_order==''){$show_order='newest';}
if($show_order=='newest'){$order2=" order by cid desc ";}
if($show_order=='oldest'){$order2=" order by cid asc ";}

$query4b="select * from procedures_programmer_comments where 1 and pid='$pid' $order2 ";

echo "Line 110: $query4b";		 
...
<td><a href='procedures_programmer.php?comment=y&add_comment=y&folder=community&pid=$pid&editP=y'>Edit</a></font></td>";
/*
if($pid=='12'){
echo "pid=$pid";
...
$query4c="select procedure_document from procedures_programmer where pid='$pid' ";
...
echo "<form method='post' action='procedures_programmer_edit.php'>";
...
echo "<table border='1'><td><a href='procedures_programmer.php?comment=y&add_comment=y&folder=community&pid=$pid'><font color='brown' $shade_comment>Comments</font></a></td>";
...
echo "<form method='post' action='comment_add_procedures_programmer.php' name='form3' onsubmit='return validateForm()'  >";
...
echo "<td><a href='procedures_programmer.php?comment=y&add_comment=y&folder=community&pid=$pid&show_order=newest'><font size='3' $shade_newest>Newest on top</font></a></td>";
echo "<td><a href='procedures_programmer.php?comment=y&add_comment=y&folder=community&pid=$pid&show_order=oldest'><font size='3' $shade_oldest>Newest on bottom</font></a></td>";
...
echo  "<form method='post' autocomplete='off' action='comment_update_procedures_programmer.php'>";
