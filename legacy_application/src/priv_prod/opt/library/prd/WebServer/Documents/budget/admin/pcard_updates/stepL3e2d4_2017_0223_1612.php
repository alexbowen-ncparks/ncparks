...
/*
$query1="insert into pcard_unreconciled(location,admin_num,post_date,trans_date,amount,vendor_name,trans_id,pcard_num,xtnd_rundate,transdate_new,cardholder,transid_new,postdate_new,xtnd_rundate_new,center,company,last_name,first_name,report_date)
select location,admin_num,date_posted,date_purchased,purchase_amount,vendor,document,account_id,
'$xtnd_rundate',date_purchased_new,primary_account_holder,document,date_posted_new,'$end_date',center,company,last_name,first_name,'$end_date'
from pcard_works
where dpr='y' ; ";
