...
(  `f_year` varchar( 4  )  NOT  NULL ,
 ...
 `water_account_number` varchar( 50  )  NOT  NULL default  '',
 ...
 `total_usage_gal` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `total_cost_dollars` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `average_rate` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `park` (  `park` ,  `water_account_number` ,  `f_year`  ) ,
 KEY  `centerpark` (  `park`  ) ,
 KEY  `utility_account_number` (  `water_account_number`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
