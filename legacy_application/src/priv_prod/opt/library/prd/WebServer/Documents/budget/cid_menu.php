...
<div class='column1of4'>
   <ul>
      ...
      <li><img height='50' width='50' src='/budget/infotrack/icon_photos/cid_menu1.png' alt='cid menu icon' title='CID Menu'></img><font color='brown' size='4'><b></b></font>
         <ul>
			...
			echo "<li><a href='/budget/infotrack/position_reports.php?menu=1&purchasing_guidelines=y'>Purchasing Guidelines</a></li>";
