...
if(!empty($_POST))
	{
	$tempID=$_SESSION['program_share']['tempID'];
	extract($_POST);
...
<input type='radio' name='survey' value='Works OK' required>Work OK <input type='radio' name='survey' value='Need Improvement'>Need Improvement</td>
</tr>";
