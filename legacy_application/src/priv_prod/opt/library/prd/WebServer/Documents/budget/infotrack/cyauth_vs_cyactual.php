...
echo "<table><tr><th>
Fiscal Year $f_year Current Year Authorized versus Current Year Actual
</table>";
echo "<br /><br />";
echo"<table>";
echo "<form method='post' action='cyauth_vs_cyactual.php'>";
...
echo "<tr>";
echo "<th>NCAS <br />account</th><th>NCAS account description</th><th>cash type</th><th>NCAS <br />authorized</th><th>Actual Receipts and Expenditures<br />thru<br />$report_date2</th><th>Projected Receipts and Expenditures</th><th>Projected <br />Funds Avail<br />on<br />$projected_date2</th>
";
