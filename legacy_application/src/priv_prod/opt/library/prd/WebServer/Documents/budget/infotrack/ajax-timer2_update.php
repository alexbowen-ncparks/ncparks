...
//$query = "update infotrack_customformat set highlight_color='$color'where user_id='$tempid'	";
/*
$query1="insert into mission_bright_ideas_history(cid,gid,time_start,time_end,time_elapsed_sec)
         select cid,gid,time_start,time_end,time_elapsed_sec from mission_bright_ideas where cid='$cid'";
		 
$query1_result = mysqli_query($connection, $query1) or die(mysqli_error());	
*/
...
$query3="insert into mission_bright_ideas_history(cid,gid,time_start,time_end,time_elapsed_sec)
         select cid,gid,time_start,time_end,time_elapsed_sec from mission_bright_ideas
		 where cid='$cid'";
