...
<tr><th><br /><a href='/budget/admin/user_activity/user_activity_matrix.php?period=today&report=application&today_date=$previous_date' title='previous day'><<</a>$today_date_dow $today_date2<a href='/budget/admin/user_activity/user_activity_matrix.php?period=today&report=application&today_date=$next_date' title='next day'>>></a></th></tr>
<tr><td>$message</td></tr>
...
//$c=1;
echo "<th align='center'><font color=brown>Rank</font></th>";
echo "<th align='center'><font color=brown>Game</font></th>";
echo "<th align='center'><font color=brown>Team</font></th>";
//echo "<th align=left><font color=brown>UserLevel</font></th>"; 
echo "<th align='center'><font color=brown>Hits</font></th>"; 
echo "</tr>";
...
"<tr$t>"; 
	...
	echo "<td align='center'>$rank</td>
	      <td><a href='application_activity_today_history_filegroup_activity.php?application=$filegroup&today_date=$today_date'>$filegroup</a></td>
