	...
	echo "<hr><table border='1'>";
		...
		if(!empty($file_link))
				...
				foreach($files as $kf=>$kv)
					{
					$f=explode("/",$kv);
					@$links.="<td align='center'>[<font color='brown'>$f[2]</font>]<br /><a href='$kv' target='_blank'>View</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='dpr_pac_del_file?link=$kv&pass=$park&id=$id'  onClick='return confirmLink()'>Delete</a>";
					echo "</td>";
					}
				echo "<tr>$links</tr>";
				}
