...
"<tr$t>"; 
	...
	//echo "<td><a href='budget_group_three_yr_history_accounts.php?report=$report&section=$section&district=$district&accounts=$accounts&history=$history&period=$period&budget_group=$budget_group'>$account</a></td>";
	     ...
	     echo "<td><a href='budget_group_three_yr_history_account_centers.php?report=$report&section=$section&district=$district&history=$history&period=$period&budget_group=$budget_group&account=$account'>$account</a></td>
