...
echo "<th>\"Bright\" Ideas under Development (Not ready for use)</th></tr>
</table>";
echo "<br />";
//echo "<table>";
//echo "<tr>";
...
if (x==null || x=='')
  ...
  if (y==null || y=='')
  {
  alert('Please enter Incrementor');
  return false;
  }  
...
echo "<td><textarea name= 'player_note' rows='3' cols='100' placeholder='Bright Idea' id='input3' ></textarea>";
echo"<br />";   
if($position=='60032793'){echo "<input type='text' name='incrementor' placeholder='Incrementor' id='input4'>";}
...
if($playstation=='ADMI' and $position=='60032781')
{
$query4b="select * from mission_bright_ideas where 1 and gid='4' and player='$player'  order by cid desc ";
//echo "line 50 query4b=$query4b<br />";//exit;
}

if($playstation=='ADMI' and $position=='60032793')
{
$query4b="select * from mission_bright_ideas where 1 and gid='4' order by park asc ";
//echo "line 50 query4b=$query4b<br />";exit;
}
...
if($playstation!='ADMI')
{
$query4b="select * from mission_bright_ideas where 1 and gid='4' and park='$playstation' order by cid desc ";
