...
$query4="select mission_icon_photos.photo_location,mission_icon_photos.comments2
         from slideshow2
		 left join mission_icon_photos on slideshow2.name=mission_icon_photos.slideshow_name
         where 1
		 and slideshow2.headline='y'
		 and mission_icon_photos.headline_photo='y'
		 ";
...
while ($row4=mysqli_fetch_array($result4))
	...
	$Photo_location_v2[]=$row4['photo_location'];
	$Comments2_v2[]=$row4['comments2'];
	//$Gid[]=$row4['gid'];
...
$slideshow_records=count($Photo_location_v2);
...
*/
echo "<td align='center'><img src='$Photo_location_v2[$j]'  width='202' height='135' title='Home sweet home' /><br /><a href='slideshow2.php' target='_blank'><br />Play</a></td>";
