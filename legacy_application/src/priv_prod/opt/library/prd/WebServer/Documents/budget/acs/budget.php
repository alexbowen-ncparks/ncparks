...
//echo "$sql";exit;
/*
if($tempID!="Howard6319" AND $tempID!="Bass3278" AND $tempID!="Buck4707"){echo "The Budget database is offline.<br /><br />We are working on the move of the Budget database to zLinux. We will send out an email once the switch is complete. Sorry for the inconvenience but the new system will be more stable than the old.";exit;}
*/
...
if($_SESSION['budget']['tempID']=="Torres8431")
{
$_SESSION[$db]['tempID']="roy8431";
}
