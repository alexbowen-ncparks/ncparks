...
echo "<td><a href='small_purchases_report2.php?f_year=1415'><font  $shade_1415>1415</font></a></td>";
...
echo "<table border='1'>";
echo "<tr>";
echo "<td><a href='small_purchases_report2.php?calmonth=jul&month_number=07'><font  $shade_jul>Jul</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=aug&month_number=08'><font  $shade_aug>Aug</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=sep&month_number=09'><font  $shade_sep>Sep</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=oct&month_number=10'><font  $shade_oct>Oct</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=nov&month_number=11'><font  $shade_nov>Nov</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=dec&month_number=12'><font  $shade_dec>Dec</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=jan&month_number=01'><font  $shade_jan>Jan</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=feb&month_number=02'><font  $shade_feb>Feb</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=mar&month_number=03'><font  $shade_mar>Mar</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=apr&month_number=04'><font  $shade_apr>Apr</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=may&month_number=05'><font  $shade_may>May</td>";
echo "<td><a href='small_purchases_report2.php?calmonth=jun&month_number=06'><font  $shade_jun>Jun</td>";
echo "</table>";
