...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta9.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta9$ct`
SELECT *
FROM `budget`.`$ta9` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta9$ct` 
(
...
$query2a="select count(*) as 'record_count9' from `budget_daily_backup`.`$db$ta9$ct` ";
