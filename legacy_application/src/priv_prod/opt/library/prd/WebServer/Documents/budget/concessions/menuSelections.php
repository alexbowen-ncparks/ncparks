...
"Vendor Payments"=>"/budget/portal.php?dbTable=xtnd_vendor_payments","Loss Prevention"=>"/budget/loss_prevent/staff_form.php");
...
if(@$level==1){$menuArray0['Budget History-Matrix']="/budget/concessions/reports_all_centers_summary_by_division.php?report=cent&accounts=all&section=operations&history=10yr&period=fyear";}

if(@$level>1){$menuArray0['Budget History-Matrix']="/budget/concessions/reports_all_centers_summary_by_division.php?report=cent&accounts=all&section=all&history=10yr&period=fyear";}

if(@$level>0){$menuArray0['Cash Receipts Journal-ORMS']="/budget/concessions/bank_deposits_menu.php";}
...
if(@$m=="pcard"){
// ******** Invoices *************
$menuArray0=array("Reconcile Pcards"=>"/budget/acs/pcard_recon.php?m=pcard","View Pcard Holders"=>"/budget/acs/editPcardHolders.php?m=pcard","Lookup Transactions"=>"/budget/acs/pcard_trans_lookup.php?m=pcard","Cardholder Documents"=>"/budget/acs/cardholder_documents.php?submit=search");
...
if(@$forum=="blank")
	...
	if($_SESSION['budget']['level']<3){include("budget/concessions/gmp_revenues.php");}
	...
	<table border='1'><tr><th>message date</th><th>Email Budget Database comments to: <a href=\"mailto:database.support@ncparks.gov?subject=Comments to Budget Database Administrator\">Administrator</a><br /><font color='red'>Messages</font></th><th>further instructions</th></tr>";
