...
$query2="update pcard_unreconciled_xtnd_temp2,pcard_holders_dncr2
         set pcard_unreconciled_xtnd_temp2.admin_num=pcard_holders_dncr2.admin_num,
		     pcard_unreconciled_xtnd_temp2.location=pcard_holders_dncr2.location,
		     pcard_unreconciled_xtnd_temp2.center=pcard_holders_dncr2.center,
		     pcard_unreconciled_xtnd_temp2.last_name=pcard_holders_dncr2.last_name,
		     pcard_unreconciled_xtnd_temp2.first_name=pcard_holders_dncr2.first_name
			 where pcard_unreconciled_xtnd_temp2.card_number2=pcard_holders_dncr2.pcard_num  ";
		  
		  
mysql_query($query2) or die ("Couldn't execute query 2.  $query2");


$query2a="update pcard_unreconciled_xtnd_temp2,pcard_holders_dncr2
         set pcard_unreconciled_xtnd_temp2.admin_num=pcard_holders_dncr2.admin_num,
		     pcard_unreconciled_xtnd_temp2.location=pcard_holders_dncr2.location,
		     pcard_unreconciled_xtnd_temp2.center=pcard_holders_dncr2.center,
		     pcard_unreconciled_xtnd_temp2.last_name=pcard_holders_dncr2.last_name,
			 ...
			 and pcard_holders_dncr2.pcard_num='3090'
			 and pcard_holders_dncr2.employee like '%pippin%' ;	 ";
		  
		  
mysql_query($query2a) or die ("Couldn't execute query 2a.  $query2a");


$query2b="update pcard_unreconciled_xtnd_temp2,pcard_holders_dncr2
         set pcard_unreconciled_xtnd_temp2.admin_num=pcard_holders_dncr2.admin_num,
		     pcard_unreconciled_xtnd_temp2.location=pcard_holders_dncr2.location,
		     pcard_unreconciled_xtnd_temp2.center=pcard_holders_dncr2.center,
		     pcard_unreconciled_xtnd_temp2.last_name=pcard_holders_dncr2.last_name,
			 ...
			 and pcard_holders_dncr2.pcard_num='3090'
			 and pcard_holders_dncr2.employee like '%dowdy%' ;	 ";
		  
		  
mysql_query($query2b) or die ("Couldn't execute query 2b.  $query2b");


$query2c="update pcard_unreconciled_xtnd_temp2,pcard_holders_dncr2
         set pcard_unreconciled_xtnd_temp2.admin_num=pcard_holders_dncr2.admin_num,
		     pcard_unreconciled_xtnd_temp2.location=pcard_holders_dncr2.location,
		     pcard_unreconciled_xtnd_temp2.center=pcard_holders_dncr2.center,
		     pcard_unreconciled_xtnd_temp2.last_name=pcard_holders_dncr2.last_name,
			 ...
			 and pcard_holders_dncr2.pcard_num='5896'
			 and pcard_holders_dncr2.employee like '%crate%' ;	 ";
		  
		  
mysql_query($query2c) or die ("Couldn't execute query 2c.  $query2c");


$query2d="update pcard_unreconciled_xtnd_temp2,pcard_holders_dncr2
         set pcard_unreconciled_xtnd_temp2.admin_num=pcard_holders_dncr2.admin_num,
		     pcard_unreconciled_xtnd_temp2.location=pcard_holders_dncr2.location,
		     pcard_unreconciled_xtnd_temp2.center=pcard_holders_dncr2.center,
		     pcard_unreconciled_xtnd_temp2.last_name=pcard_holders_dncr2.last_name,
			 ...
			 and pcard_holders_dncr2.pcard_num='5896'
			 and pcard_holders_dncr2.employee like '%abbott%' ;	 ";
