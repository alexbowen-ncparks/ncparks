...
//echo "<br />filepath=$file_path";//exit;	
        ...
        mysqli_query($connection, "TRUNCATE TABLE `csv_import_template` ") or die(mysqli_error()); 
...
$sql="INSERT INTO csv_import_template 
...
header("location: import_csv_form_template?upload=y");
