...
echo  "<td><input type='text' size='5' readonly='readonly' name='location[]' value='$location'</td>";	   
echo  "<td><input type='text' size='20 readonly='readonly' name='pcard_num[]' value='$pcard_num'</td>";
echo  "<td><input type='text' size='5' readonly='readonly' name='admin_num[]' value='$admin_num'</td>";
echo  "<td><input type='text' size='25' readonly='readonly' name='cardholder[]' value='$cardholder'</td>";
echo  "<td><input type='text' size='5'  name='parkcode[]' value='$parkcode'</td>";
echo  "<td><input type='text' size='15'  name='center[]' value='$center'</td>";
echo  "<td><input type='text' size='15'  name='last_name[]' value='$last_name'</td>";
echo  "<td><input type='text' size='15'  name='first_name[]' value='$first_name'</td>";
