...
//	$file = $_REQUEST['form_name'].".".$ext;
	...
	$folder = "position_desc_files/ada";
	if (!file_exists($folder)) {mkdir ($folder, 0777);}
	
		
	$uploadfile = $folder."/ADA_".$file;
//	echo "$uploadfile";exit;
	...
	$sql = "REPLACE position_ada_forms set form_name='$form_name', beacon_title='$beacon_title', file_link='$uploadfile'";
	//  echo "$sql";exit;
