...
$sql="Select ci_num, id as file_id, link, title  From `attachment` where 1 AND ci_num='$ci_num' $limit_park";
...
if(($level==1 and empty($pasu_approve)) OR $level>1)
	{
	echo "<a href='delete_attachment.php?pass_id=$file_id&id=$id' onClick=\"return confirmFile()\">Delete</a>";
	}
echo "</td></tr>";
				$j++;
				}
