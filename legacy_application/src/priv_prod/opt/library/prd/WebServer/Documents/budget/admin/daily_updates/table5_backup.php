...
$db="$today_date";
$ta5="crs_tdrr_division_history_parks_adjustments";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta5.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta5$ct`
SELECT *
FROM `budget`.`$ta5` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta5$ct` 
(
...
$query2a="select count(*) as 'record_count5' from `budget_daily_backup`.`$db$ta5$ct` ";
