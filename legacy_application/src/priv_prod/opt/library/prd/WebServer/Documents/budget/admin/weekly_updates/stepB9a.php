...
(
`ncasnum` varchar( 16 ) NOT NULL default '',
`center` varchar( 12 ) NOT NULL default '',
`amount_py3` decimal( 12, 2 ) NOT NULL default '0.00',
`amount_py2` decimal( 12, 2 ) NOT NULL default '0.00',
`amount_py1` decimal( 12, 2 ) NOT NULL default '0.00',
`amount_cy` decimal( 12, 2 ) NOT NULL default '0.00',
`allocation_amount` decimal( 12, 2 ) NOT NULL default '0.00',
`authorized_budget_cy` decimal( 12, 2 ) NOT NULL default '0.00',
`f_year` varchar( 4 ) NOT NULL default '',
`amount_LYTT` decimal( 12, 2 ) NOT NULL default '0.00',
`oxtid` int( 10 ) unsigned NOT NULL AUTO_INCREMENT ,
PRIMARY KEY ( `oxtid` ) ,
KEY `ncas_num` ( `ncasnum` ) ,
KEY `center` ( `center` ) ,
KEY `f_year` ( `f_year` )
) ENGINE = MyISAM;
";
