...
echo "
<tr><td align='right'>Enter PO Number: <input name='po_number' type='text' value='$po_number' size='15'></td>";

echo "<td><input type='submit' value='Find This PO'></td></tr></form></table><hr>";
...
if($po_number){$result = mysqli_query($connection, $sql) or die ("Couldn't execute query. $sql".mysqli_error());}
//echo "$sql";exit;
$num=mysqli_num_rows($result);

//if($num>1){
echo "<table cellpadding='2' align='center'><tr><td align='center' colspan='4'>Purchase Order for $centerPass</td></tr>";
...
if($J==""){
echo "<tr><th colspan='2'>Vendor</td><th>PO_num</th></tr>";

echo "<tr><th colspan='2'><font color='purple'>$vendor_short_name</font></td><th><font color='purple'>$po_number</font></th></tr>";

if(!$submit){
echo "<tr><th>line_num</th><th>purch_descr</th><th></th><th>remaining<br>encumbrance</th>
<th>Pass Amount</th><th></th></tr>";}
$J++;}

// <a href='po.php?po_number=$po_number&id=$id&parkcode=$parkcode&center=$center&acs=1&pass=$pass'>select</a>

if(!$submit){
echo "<form><tr><td>$po_line_number</td><td>$first_line_item_description</td>
<td>$p</td>
<td>$PO_remaining_encumbrance</td>
<td align='center'>
<input type='hidden' name='po_number' value='$po_number'>
<input type='hidden' name='id' value='$id'>
<input type='hidden' name='parkcode' value='$parkcode'>
<input type='hidden' name='center' value='$center'>
<input type='hidden' name='acs' value='1'>
<input type='hidden' name='pass' value='$pass'>
<input type='checkbox' name='pass' value='x'></td>
