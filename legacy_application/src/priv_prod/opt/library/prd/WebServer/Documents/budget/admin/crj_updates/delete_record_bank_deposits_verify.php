...
echo "<font color='red' size='3'><b>CAUTION! Are you sure you want to PERMANENTLY Delete $parkU DepositID=$deposit_id Amount=$deposit_amount</b></font>";
...
echo "<form method=post action=bank_deposits.php?add_your_own=y>";
...
echo "<form method=post action=delete_record_bank_deposits.php>";

echo "<input type='hidden' name='id' value='$id' >";
echo "<input type='hidden' name='park' value='$park' >";
echo "<input type='hidden' name='vendor' value='$deposit_id' >";
