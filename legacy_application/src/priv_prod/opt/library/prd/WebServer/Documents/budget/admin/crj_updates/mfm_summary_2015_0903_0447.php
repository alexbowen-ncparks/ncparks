...
echo "<br /><br />";
 echo "<table align='center'>";
  echo "<tr><td></td><td></td><td><font color='brown' class='cartRow2'>Total Gallons</td><td>$total_gallons</td></tr>";
  echo "<tr><td></td><td></td><td><font color='brown' class='cartRow2'>Average Price per Gallon</td><td>$reimbursement_rate</td></tr>";
 echo "<tr><td></td><td></td><td><font color='brown' class='cartRow2'>Total Cost</td><td>$gas_cost</td></tr>";
 ...
 echo "<tr><td></td><td></td><td><font color='brown' class='cartRow2'>Total Refund</td><td>$refund_total</td></tr>";
 echo "</table>";
