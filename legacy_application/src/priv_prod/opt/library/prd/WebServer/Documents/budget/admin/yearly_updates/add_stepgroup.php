...
echo "<H1 ALIGN=center > <font color=brown><i>$project_name-Add StepGroup</i> </font></H1>";
...
echo "<form name='form1' method='post' action='add_stepgroup_update.php'>";
...
echo "<table border='1' align='center'>";
	   ...
	   echo "<tr><td><font color='red'>step_group(A-Z)</font></td><td><input type='text' name='step_group' value='$step_group'></td></tr>";
	   echo "<tr><td><font color='red'>step</td></font><td><input type='text' name='step' size='30' value='$step'></td></tr>";
	   echo "<tr><td></td><td><input type='submit' name='submit' value='Add_StepGroup'></td></tr>";
...
//echo "<input type='submit' name='submit' value='Add_StepGroup'>";
