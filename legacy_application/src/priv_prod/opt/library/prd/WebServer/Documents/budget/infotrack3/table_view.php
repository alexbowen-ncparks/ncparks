...
if($table=='')
{
$table="cash_handling_roles";
}
*/
$query="show keys from $table where key_name='primary' ";
		 
echo "43 query=$query<br />";		 
...
echo "<br />Column_name=$Column_name<br />";
...
$table_file='table_view.php';
//$autocomplete_file=$table.'_autocomplete.php';
$autocomplete_file='table_view_autocomplete.php';
...
echo "<br />table_file=$table_file<br />";
echo "<br />autocomplete_file=$autocomplete_file<br />";

//exit;

include("style1.html");
echo "<table class='center'><tr><td><a href='$table_file?database=$database&table=$table&add=y'>ADD Record</a></td><th><a href='$table_file?database=$database&table=$table&search=y'>SEARCH Records</a></th></tr></table>"; 
//$decimalFields=array("");
if($table=='pcard_unreconciled')
{
$skip_array=array("post_date","trans_date","address","trans_id","xtnd_rundate","parkcode","cardholder","employee_tempid","postdate_new","xtnd_rundate_new","old_center","park_recondate","budget2controllers","post2ncas","reclass2_1680","equipnum","budget_ok","reconciled","reconcilement_date","recon_complete","deadline_ok","ca","count_amount","ca_count_posted","ca_count_unposted","f_year","travel","transid_date_count","caa","charge_year","pce_match","pa_number","re_number","utility","code_1099","id1646","document_location_fa","fas_num","contract_num","center_dncr");
}

if($table=='concessions_pci_compliance')
{	
$skip_array=array("cashier_amount","reimbursement_gallons","reimbursement_rate");
}

if($table=='center')
{	
$skip_array=array("rcc","new_rcc","old_rcc");
}
...
if($order_by==''){$order_by=$primaryField;}
...
$query2=rtrim($query1,",");	
$query_search="select * from $table where 1".$query2." order by ".$primaryField." desc";	
//$result3 = mysqli_query($connection, $query3) or die ("Couldn't execute query3.  $query3");	
//echo "query1=$query1<br /><br />";	
//echo "query2=$query2<br /><br />";	
echo "query_search=$query_search<br /><br />";	
...
$count_fieldnames=count($fieldNames)-$count_skip;
//$skip_array=array("id");
//$color='red';
//$f1="<font color='$color'>"; $f2="</font>";
//include("park_inc_stmts_district_header.php"); // connection parameters
//if($district==''){exit;}
echo "<form method='post' action='$table_file'>";
echo "<table border='1' cellpadding='2'>";

echo "<tr><td colspan='2' ><font color='red'>$num</font> records</td><td>FieldNames: $count_fieldnames </tr>";
...
echo "<tr>";
echo "<td>$v</td><td><input type='text' name='$v'></input></td> ";
echo "</tr>";
}
echo "<tr>";
...
//$count=count($fieldNames);
$count_fieldnames=count($fieldNames)-$count_skip;
//$skip_array=array("post_date","trans_date","address","trans_id");
//$color='red';
//$f1="<font color='$color'>"; $f2="</font>";
//include("park_inc_stmts_district_header.php"); // connection parameters
//if($district==''){exit;}
...
$query="SELECT * from $table
        where 1 $order_by2 limit 100
         ";
 
 
if($query_search != ''){$query=$query_search;}
...
echo "<tr><td colspan='2' ><font color='red'>$num</font> records</td><td>Fieldnames: $count_fieldnames</td></tr>";
echo "<tr>";
foreach($fieldNames as $k=>$v){
//$v=str_replace("_"," ",$v);
if(in_array($v,$skip_array)){continue;}
...
//$table_file=$table.'.php';
//$autocomplete_file=$table.'_autocomplete.php';
echo "<th><a href='$table_file?database=$database&table=$table&order_by=$v&asc_desc=$asc_desc2'>$v</a><br />sorted $asc_desc <br />";include($autocomplete_file); echo"</th>";
}
else
{
echo "<th><a href='$table_file?database=$database&table=$table&order_by=$v'>$v</a></th>";
}
}
echo "</tr>";
...
foreach($ARRAY as $k=>$v)
	...
	echo "<tr$tr>";
		...
		foreach($v as $k1=>$v1){// each field, e.g., $tempID=$v[tempID];
			...
			if($k1==$primaryField){echo "<td>$v1 <a href='$table_file?database=$database&table=$table&edit=y&order_by=$order_by&keyword_chosen=$keyword_chosen&fs=$fs&pf=$v1'>Edit</a></td>";}
			else  {echo "<td>";
