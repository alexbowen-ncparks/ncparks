...
echo "<table><tr><th>\"Red Eraser\" under Development (Not ready for use)</th></tr>
</table>";
...
echo "<table border=1>";
echo "<tr>";
echo "<td bgcolor='darkseagreen'><a href='op_exp_transfer_park.php?f_year=1314&center=12802812&submit=Submit'><img height='50' width='50' src='/budget/infotrack/icon_photos/property_photos_51.png' alt='picture of red eraser'></img></a></td>";
...
echo "</tr>";
 ...
 echo "</table>";
// include("op_exp_transfer_park.php?f_year=1314&center=12802812&submit=Submit");
