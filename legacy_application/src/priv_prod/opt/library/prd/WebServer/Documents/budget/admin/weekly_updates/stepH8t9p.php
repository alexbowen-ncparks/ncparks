...
$query13="insert into crj_posted_1000_v2
(center,invoice,description,acct,amount,f_year,acctdate)
select center,invoice,description,acct,sum(credit-debit) as 'amount',f_year,acctdate
from exp_rev_down_fund1000
