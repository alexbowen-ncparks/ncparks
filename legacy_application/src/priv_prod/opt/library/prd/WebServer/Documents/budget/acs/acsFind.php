...
if(@$submit_acs=="Find")
	...
	<th>invoice total</th><th>posted</th><th></th><th>prepared by</th><th>approved by</th><th>received by</th></tr>";
	...
	while($row=mysqli_fetch_array($result))
		...
		<td align='center'>$post2ncas";
         //dodd//bass
		if($beacnum=='60032781' or $beacnum=='60032793'){echo "<br /><a href='acs_post_update.php?id=$id&post2ncas=$post2ncas&findCenter=$findCenter&ncas_invoice_amount=$ncas_invoice_amount'& target='_blank'>Change</a>";} echo "</td>";
		
		echo "<td><a href='acs.php?id=$id&m=invoices'>View</a></td><td>$prepared_by</td><td>$approved_by</td><td>$received_by</td></tr>";
		}
