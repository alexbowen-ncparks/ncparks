...
if($edit=='y'){echo "Code to Edit Table record=$id"; exit;}
...
foreach($ARRAY as $k=>$v)
	...
	echo "<tr>";
		...
		foreach($v as $k1=>$v1){// each field, e.g., $tempID=$v[tempID];
			...
			if(in_array($k1,$LinkFields)){echo "<td>$v1 <a href='pcard_holders_dncr6.php?edit=y&id=$v1'>Edit</a></td>";} else  {echo "<td>$v1</td>";}
