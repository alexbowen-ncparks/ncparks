...
SELECT fund_in as 'center', sum( amount ) AS 'CID_partf_fund_trans_Funds_In_Amount','','' frOM  `partf_fund_trans` WHERE 1 and fund_in != '' and datenew <= '$end_date' GROUP BY fund_in;
";
