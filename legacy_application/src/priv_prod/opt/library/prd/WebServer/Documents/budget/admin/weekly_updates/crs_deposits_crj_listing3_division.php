...
$row_count=mysqli_num_rows($result11a);

echo "row_count=$row_count<br /><br />";
...
echo "<table><tr><th><marquee loop='1' behavior='slide'>Undeposited Financial Sessions thru $header_message2</marquee></th></tr></table>";
...
"<tr> 
       ...
       <th align=left><font color=brown>Collection<br />Start<br />Date</font></th>
       <th align=left><font color=brown>Collection<br />End<br />Date</font></th>
	   <th align=left><font color=brown>Total<br />Undeposited<br />Amount</font></th>";
	   echo "<th align=left><font color=brown>Collection<br />Days</font></th>";
	   /*
...
"<tr$t>
			...
			<td align='center'><font color='$amount_color'><b>$amount</b></font></td>
			<td align='center'><font color='$days_color'><b>$days_elapsed</b></font></td>";
			/*
