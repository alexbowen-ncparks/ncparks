...
echo "<th><font color='brown'>Cash Handling</font><br /><img height='50' width='50' src='/budget/infotrack/icon_photos/money_safe_copper1.png  ' alt='picture of safe'></img></th>";
...
$header2="/budget/infotrack/procedures_crj.php?park=$index";	
...
if($value!='')
{		
echo "<td><a href='$value2'><img height='50' width='50' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of green check mark'></img></a></td>";
}

if($value=='')
{		
echo "<td><img height='50' width='50' src='/budget/infotrack/icon_photos/xmark1.png' alt='picture of green x mark'></img></td>";
}
