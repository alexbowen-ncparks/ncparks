...
$query="update flag set days_elapsed='0' where today_time=day0 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='1' where today_time=day1 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='2' where today_time=day2 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='3' where today_time=day3 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='4' where today_time=day4 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='5' where today_time=day5 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='6' where today_time=day6 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='7' where today_time=day7 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='8' where today_time=day8 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='9' where today_time=day9 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");

$query="update flag set days_elapsed='10' where today_time=day10 ";
$result=mysqli_query($connection,$query) or die ("Couldn't execute query. $query");
