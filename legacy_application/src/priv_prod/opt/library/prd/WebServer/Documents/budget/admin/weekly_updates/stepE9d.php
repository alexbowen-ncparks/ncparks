...
$query1="SELECT sum(pricexquantity) as 'charge_amount' FROM warehouse_billings_2
         where center != '12802802' and f_year='$fiscal_year' ; ";
...
$query2="SELECT sum(pricexquantity) as 'credit_amount' FROM warehouse_billings_2
         where center = '12802802' and f_year='$fiscal_year' ; ";
...
echo "<form method=post action=stepE9d.php>";
echo "<table border=1>";
echo "<tr>";
echo "<th>Park_Charges</th><th>Ware_Credits</th><th>Ware_Total</th><th>Status</th><th>Action</th>";
echo "</tr>";
if($ware_total_new=='0'){echo "<tr bgcolor='yellow'>";} else {echo "<tr bgcolor='red'>";}
echo "<td>$charge_amount</td><td>$credit_amount</td><td>$ware_total_new</td>";
