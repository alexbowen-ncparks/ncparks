...
// $sql="SELECT distinct t1.*, t2.form_name, t2.file_link as link 
...
if(mysqli_num_rows($result)>0)
	{
	$skip=array("ssn_last4","driver_license","e_verify","track");
	$c=count($ARRAY);
	echo "<table border='1' cellpadding='3'><tr><td>$c</td></tr>";
	foreach($ARRAY AS $index=>$array)
		...
		foreach($array as $fld=>$value)
			...
			if($fld=="link" and !empty($value))
				{$value="<a href='$value' target='_blank'>File</a>";}
			if($fld=="id")
