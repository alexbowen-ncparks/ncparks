...
$query3="
select 
center.parkcode,id,ncas_account,park_acct_desc,prepared_by,ncas_invoice_date,datesql,system_entry_date,ncas_invoice_number,ncas_invoice_amount,invoice_total,vendor_name,vendor_number,group_number,ncas_center,energy_group,energy_subgroup,cdcs_uom,energy_quantity,account_number,cvip_id,valid_account
from energy1
left join center on energy1.ncas_center=center.center
left join coa on energy1.ncas_account=coa.ncasnum
where 1 and valid_account='n'
order by ncas_account,center.parkcode,datesql;
";
...
// echo " <th><font color=blue>DENR Paid</font></th>";
 ...
 echo " <th><font color=blue>Vendor Name<br />Group<br />Quantity<br />UOM</font></th>";echo " <th><font color=blue>Invoice Number<br />Amount<br />Date<br />SED</font></th>";            
...
//echo  "<td>$parkcode</td>";
echo  "<td>$parkcode<br />$ncas_center<br />$prepared_by</td>"; 
...
echo  "<td>$ncas_invoice_number<br />$datesql2 $invoice_month$date_sql_year<br />$system_entry_date</td>";
...
echo  "<td><a href='/budget/energy/energy_reporting.php' onclick=\"return popitup('/budget/energy/energy_reporting.php?f_year=1314&egroup=$egroup&report=accounts')\">$account_number</a></td>";
...
echo  "<td><input type='text' size='10' name='valid_account_number[]' value='$valid_account_number'></td>";
