...
$query1b="select tempid as 'tempid_sharer'
          from ajax_users
		  where sharer='y' ";	 
...
$query = "select urlname as 'project_note_id2',urlname as 'comment_note' from activity_1314 where tempid='$tempid_sharer' order by id desc limit 1 ";		 
//echo "query=$query<br />";		 
...
//	$display_string .= "<td><font color='brown'>$row[project_note_id2]</font></td>";	
	...
	$display_string .= "<td><iframe width='900' height='700' src='$comment_note' frameborder='0' allowfullscreen></iframe></td>";
	$display_string .= "</tr>";
