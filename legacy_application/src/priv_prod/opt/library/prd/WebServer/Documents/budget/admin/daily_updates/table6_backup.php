...
$db="$today_date";
$ta6="crs_tdrr_division_deposits_checklist";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta6.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta6$ct`
SELECT *
FROM `budget`.`$ta6` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta6$ct` 
(
...
$query2a="select count(*) as 'record_count6' from `budget_daily_backup`.`$db$ta6$ct` ";
