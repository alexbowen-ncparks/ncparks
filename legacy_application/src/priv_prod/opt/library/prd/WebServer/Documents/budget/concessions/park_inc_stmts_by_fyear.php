...
echo "<table border='1' align='center'><tr><th>Park Receipts and Expenditures by Fiscal Year</th><th><a href='park_inc_stmts_by_fyear.php?fyear=$fyear&report_type=$report_type&scope=park'>Park<br />Centers</a><br />$check_park</th><th><a href='park_inc_stmts_by_fyear.php?fyear=$fyear&report_type=$report_type&scope=all'>All<br />Centers</a> <br />$check_all</th></tr></table>";
//echo "<br />";

echo "<br /><table border='1' align='center'><tr><th>Report Type</th><th><a href='park_inc_stmts_by_fyear.php?fyear=$fyear&scope=$scope&report_type=all'>ALL</a><br />$report_all</th><th><a href='park_inc_stmts_by_fyear.php?fyear=$fyear&scope=$scope&report_type=pfr'>PFR</a> <br />$report_pfr</th></tr></table>";
