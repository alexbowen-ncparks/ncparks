...
$query1="update ere_unmatched SET";
for($j=0;$j<$num3;$j++){
$query2=$query1;
	$query2.=" cvip_id='$cvip_id[$j]' ";
...
$query3="update cid_vendor_invoice_payments,ere_unmatched
        set cid_vendor_invoice_payments.temp_match2='y'
		where cid_vendor_invoice_payments.id=ere_unmatched.cvip_id
		and ere_unmatched.cvip_id != '' and ere_unmatched.cvip_id != 'nm' ";
