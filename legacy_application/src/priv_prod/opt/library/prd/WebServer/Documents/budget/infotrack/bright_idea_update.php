...
$query1="update mission_bright_ideas SET";
for($j=0;$j<$num4b;$j++){
$query2=$query1;
//$player_note2=addslashes($player_note[$j]);
  $player_note2=($player_note[$j]);
  $player_note3=htmlspecialchars_decode($player_note2);
	$query2.=" player_note='$player_note3',";
	$query2.=" status='$status[$j]',";
	$query2.=" complete='$complete[$j]',";
	$query2.=" total_points='$total_points[$j]'";
...
/*
$query3="update mission_bright_ideas 
         set total_points=complete
		 where status='fi' ";
