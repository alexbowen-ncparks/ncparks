...
echo "<html>";
echo "<head>";
echo "<title>Duplicate Record</title>";
echo "</head>";
...
echo "<br />project_category:<input name='project_category' type='text' id=project_category size=50 value=\"$project_category\">";
echo "<br />project_name:<input name='project_name' type='text' id=project_name size=50 value=\"$project_name\">";
echo "<br />project_note:<textarea name='project_note' cols='80' rows='2'></textarea>";
