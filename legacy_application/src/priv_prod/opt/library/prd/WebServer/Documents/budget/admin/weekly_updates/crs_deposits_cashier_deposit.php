...
{
echo "<textarea rows='11' cols='35' name='cashier_over_short_comment' placeholder='Enter Cashier Justification for Over/Short Amount'>$cashier_over_short_comment</textarea>";
}
