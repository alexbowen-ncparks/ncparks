...
{    newwindow=window.open(url,'name','resizable=1,scrollbars=1,height=800,
width=800,menubar=1,toolbar=1');
...
echo "<H2 ALIGN=left><font size=4><b><A href='popupex.html' onclick=\"return popitup('/budget/admin/weekly_updates/stepG8a1_matches.php')\">Possible Matches</A></font></H2>";
