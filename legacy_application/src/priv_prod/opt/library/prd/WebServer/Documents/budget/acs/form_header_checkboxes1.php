...
<select name='manager'>
  <option value=''></option>
  <option value='dwayne_parker'>dwayne_parker</option>
  <option value='jody_reavis'>jody_reavis</option>
  <option value='john_johnson'>john_johnson</option>
  <option value='patrick_noel'>patrick_noel</option>
  <option value='pete_mitchell'>pete_mitchell</option>
  <option value='randy_ayers'>randy_ayers</option>
</select>
