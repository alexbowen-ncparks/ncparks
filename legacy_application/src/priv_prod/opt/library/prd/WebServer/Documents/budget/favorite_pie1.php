...
function getVote(int) {
  ...
  xmlhttp.open("GET","favorite_pie3.php?vote="+int,true);
  xmlhttp.send();
}
</script>
...
<tr><td><input type="radio" name="vote" value="2" onclick="getVote(this.value)">Key Lime Pie</td></tr>
<tr><td><input type="radio" name="vote" value="3" onclick="getVote(this.value)">Pecan Pie</td></tr>
<tr><td><input type="radio" name="vote" value="4" onclick="getVote(this.value)">Pumpkin Pie</td></tr>
<tr><td><input type="radio" name="vote" value="5" onclick="getVote(this.value)">Sweet Potato Pie</td></tr>
</table>
</form>
</td>
