...
(  `tempid` varchar( 100  )  NOT  NULL default  '',
 `currpark` varchar( 4  )  NOT  NULL default  '',
 ...
 `pcard_admin` varchar( 10  )  NOT  NULL default  '',
 `active` char( 1  )  NOT  NULL default  '',
 `jobtitle` varchar( 45  )  NOT  NULL default  '',
 `posnum` varchar( 10  )  NOT  NULL default  '',
 `rcc` varchar( 10  )  NOT  NULL default  '',
 `postitle` varchar( 45  )  NOT  NULL default  '',
 `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `tempid` (  `tempid`  ) ,
 KEY  `currpark` (  `currpark`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
