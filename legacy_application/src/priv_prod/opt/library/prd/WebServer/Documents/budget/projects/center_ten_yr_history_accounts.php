...
$query3="select account,account_description,cash_type,gmp,center,
...
if($table=="report_budget_history_multiyear2"){$table2="report_budget_history_monthly_fyear2" ;}
if($table=="report_budget_history_multiyear_calyear3"){$table2="report_budget_history_monthly_cyear2" ;}
echo  "<td><a href='/budget/portal.php?dbTable=$table2&center=$center&account=$account&submit=Find' target='blank'>$account</a></td>";
