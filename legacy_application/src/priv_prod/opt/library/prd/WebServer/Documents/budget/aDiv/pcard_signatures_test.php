...
echo "<br />cashier:$cashier<br />cashier_date:$cashier_date<br />cashier_name:$cashier_name<br />cashier_sig_location:$cashier_sig_location<br />cashier_scale=$cashier_scale"; //exit;
echo "<br />manager:$manager<br />manager_date:$manager_date<br />manager_name:$manager_name<br />manager_sig_location:$manager_sig_location<br />manager_scale=$manager_scale"; 
exit;
