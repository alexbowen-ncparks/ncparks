...
echo "<table border=1>";
echo "<tr>";
echo "<td bgcolor='darkseagreen'><img height='50' width='50' src='/budget/infotrack/icon_photos/green_paint_bucket1.png' alt='picture of green paint'></img></td>";
