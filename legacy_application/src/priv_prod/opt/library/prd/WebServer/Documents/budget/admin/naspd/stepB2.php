...
$query0="delete from bd725_dpr_account_detail3_exp where f_year='$fiscal_year' ";
...
$query="insert into bd725_dpr_account_detail3_exp(center,cash_type,acct_transfer,ptd,ytd,f_year)
select center,cash_type,acct_transfer,sum(ptd),sum(ytd),f_year
from bd725_dpr_account_detail
where cash_type='disburse' and acct_transfer='n'
and f_year='$fiscal_year'
group by center,cash_type,acct_transfer";
...
$query1="delete from bd725_dpr_account_detail3_exp where ytd='0.00'
         and f_year='$fiscal_year' ";
...
$query2="update bd725_dpr_account_detail3_exp
         set ptd_ytd=ptd-ytd where f_year='$fiscal_year' ";
...
$query3="update bd725_dpr_account_detail3_exp
         set new_fund='y' where ptd_ytd='0.00' and  f_year='$fiscal_year' ";
