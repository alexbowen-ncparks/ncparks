...
$db="$today_date";
$ta13="crs_tdrr_division_deposits_checks";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta13.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta13$ct`
SELECT *
FROM `budget`.`$ta13` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta13$ct` 
(
...
$query2a="select count(*) as 'record_count13' from `budget_daily_backup`.`$db$ta13$ct` ";
