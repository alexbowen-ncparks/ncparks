...
$menuArray0=array("FY 1920 DNCR Request"=>"/dpr_system/dncr_request.php", "Print Park Profiles - pdf"=>"summary_print.php", "Print Park Profiles w/Work Load - pdf"=>"summary_print_work_load.php","Sys_Plan Comments Form"=>"https://10.35.152.9/summit/sys_plan_comment.php","Review Sys_Plan Comments"=>"https://10.35.152.9/summit/sys_plan.php","- - - - - - - - "=>"","Interpretive Themes - html"=>"ie_themes.php","Interpretive Themes - pdf"=>"ie_themes.php?rep=1"," - - - - - - - - "=>"","Facility Summary"=>"facility_form_system_plan.php","Designate Visitor Facility Type"=>"facility_form_visitor.php");
$menuArray0=array("FY 1920 DNCR Request"=>"/dpr_system/dncr_request.php", "Print Park Profiles - pdf"=>"summary_print.php", "Print Park Profiles w/Work Load - pdf"=>"summary_print_work_load.php","Sys_Plan Comments Form"=>"https://10.35.152.9/summit/sys_plan_comment.php","Review Sys_Plan Comments"=>"https://10.35.152.9/summit/sys_plan.php","- - - - - - - - "=>"","Interpretive Themes - html"=>"ie_themes.php","Interpretive Themes - pdf"=>"ie_themes.php?rep=1"," - - - - - - - - "=>"","Facility Summary"=>"facility_form_system_plan.php","Designate Visitor Facility Type"=>"facility_form_visitor.php");

$menuArray0['System Acreage']="acreage.php";

$skip=array("summary_print.php", "summary_print_work_load.php","/summit/sys_plan_comment.php", "https://10.35.152.9/summit/sys_plan_comment.php" ,"https://10.35.152.9/summit/sys_plan.php", "ie_themes.php?rep=1", "sys_acreage.php");
$skip=array("summary_print.php", "summary_print_work_load.php","/summit/sys_plan_comment.php", "https://10.35.152.9/summit/sys_plan_comment.php" ,"https://10.35.152.9/summit/sys_plan.php", "ie_themes.php?rep=1", "sys_acreage.php");
if($level>4)
	{
