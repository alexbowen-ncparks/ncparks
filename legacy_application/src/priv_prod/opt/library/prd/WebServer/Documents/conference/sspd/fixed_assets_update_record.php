...
//echo "Line 90 success"; exit;

define('PROJECTS_UPLOADPATH','fa_documents/');
$document=$_FILES['document']['name'];
if($document==""){echo "<font color='red' size='5'><b>Oops:No Document Found.</b></font>";
echo "$form_return";
exit;}
...
$query1="update fixed_assets
set park='$park',fas_num='$fas_num',fas_description='$fas_description',payment_source='$payment_source',source_id='$source_id',entered_by='$tempid',sed='$system_entry_date' where id='$id'  ";
...
header("location: fixed_assets1.php?menu_fa=fa1&type=edit&comp=yes&id=$id");
