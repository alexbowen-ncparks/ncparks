...
if($val > -1)
	...
	//	echo "<pre>"; print_r($_REQUEST); echo "</pre>";  //exit;
		...
		if(!empty($event_type))
			...
			{$var_et="";}
		$query = "INSERT INTO event (dateE, enterBy, title, park, content, dist, comment,start_time,start_location,event_type) VALUES ('$newdateBegin','$enterBy', '$title', '$park','$content', '$dist', '$comment1', '$start_time', '$start_location', '$var_et')";
//		echo "<br />$query";exit;
...
<th>Volunteer Project/Trail Work Day:<input type='checkbox' name='event_type[]' value='project'></th></tr>";
...
Please use the title of the celebration (for example, National Trails Day) in the description so it can be used as search criteria.  These statewide events should be posted for the <b>entire year by February 10th.</b>
