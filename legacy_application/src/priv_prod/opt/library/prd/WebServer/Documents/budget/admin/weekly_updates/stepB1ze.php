...
$ta="energy_532220_propane_meters";
$ct=date("His");
//echo $ct;exit;
...
(  `division` varchar( 50  )  NOT  NULL default  '',
 ...
 `meter_identification_number` varchar( 50  )  NOT  NULL default  '',
 `meter_location` varchar( 50  )  NOT  NULL default  '',
 `meter_owned_by_vendor_id` varchar( 50  )  NOT  NULL default  '',
 `rate_analysis_necessary` varchar( 50  )  NOT  NULL default  '',
