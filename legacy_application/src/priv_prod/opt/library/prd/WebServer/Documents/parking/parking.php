...
$sql = "SELECT $dbName as level,emplist.tempID,emplist.currPark,accessPark,t2.working_title, concat(t3.Fname,' ',t3.Mname,' ',t3.Lname) as full_name, IF(t3.Nname!='',t3.Nname,t3.Fname) as Fname, t3.Lname, t2.beacon_num, t2.code as position_code, t3.emid
FROM emplist 
...
$_SESSION['parking']['log_name']=$log_name;
