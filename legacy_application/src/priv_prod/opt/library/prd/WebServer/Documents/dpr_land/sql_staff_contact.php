...
$var="staff_contact";
	...
	$sql="SELECT t1.staff_contact_id
	from land_assets_staff_contact_jnc as t1
	...
	if(mysqli_num_rows($result)>0)
		...
		from $var as t1
		WHERE t1.staff_contact_id='$staff_contact_id'"; //ECHO "$sql"; //exit;
		...
		{	//$sql<br />
		$message= "No history of staff contact is on record for land_assets_id $land_assets_id.";
		}
