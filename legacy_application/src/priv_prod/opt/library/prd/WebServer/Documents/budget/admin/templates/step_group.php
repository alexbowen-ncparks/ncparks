...
echo "<H2 ALIGN=center><font size=4><b><A href=/budget/admin/templates/main.php?project_category=fms&project_name=templates>Templates-HOME </A></font></H2>";
...
"<tr$t>";	
	...
	echo "
 	...
 	echo "<td>
			  ...
			  <input type='submit' name='submit2' value='Edit-$cid'
			  </form>
