...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta12.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta12$ct`
SELECT *
FROM `budget`.`$ta12` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta12$ct` 
(
...
$query2a="select count(*) as 'record_count12' from `budget_daily_backup`.`$db$ta12$ct` ";
