...
if($statusPer=='FI'){$statusper_date=", statusper_fi_date='$system_entry_date' ";}
$query="UPDATE `partf_projects` set statusper='$statusPer' $statusper_date WHERE projnum='$projnum'";
//echo "$query";exit;
