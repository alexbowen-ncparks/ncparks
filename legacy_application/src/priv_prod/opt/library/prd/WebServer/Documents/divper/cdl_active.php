...
$sql = "SELECT 'DENR' as COMPANY, 'Parks and Rec' AS DIVISION, t1.beacon_num as BEACON_POSITION, t3.beaconID AS 'BEACON ID#', concat(t3.Lname, ', ', t3.Fname, ' ', t3.Mname) as NAME,  '10' as 'EMPLOYEEJOBCLASS', 'DOT' as 'EMPLOYEETYPE', t4.county as 'Work County', t2.currPark
...
if(empty($rep))
	...
	echo "<tr><td colspan='2'><a href='cdl_active.php?rep=1'>Excel export</a></td>
	<td colspan='2'>Active CDL</td></tr>";}
if(@$rep=="1")
	{
	$header_array[]=array_keys($ARRAY[0]);

	header("Content-Type: text/csv");
	header("Content-Disposition: attachment; filename=cdl_active.csv");
	// Disable caching
