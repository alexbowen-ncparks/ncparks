...
mysqli_query($connection, $query18a) or die ("Couldn't execute query 18a. $query18a");
*/
...
$query1="truncate table `pcard_transid_multiple_dates1` ";
mysqli_query($connection, $query1) or die ("Couldn't execute query 1. $query1");
...
$query3="truncate table `pcard_transid_multiple_dates2` ";
mysqli_query($connection, $query3) or die ("Couldn't execute query 3. $query3");
...
$query10="truncate table `pcu_unposted` ";
mysqli_query($connection, $query10) or die ("Couldn't execute query 10. $query10");
...
$query13="truncate table `pcu_posted` ";
mysqli_query($connection, $query13) or die ("Couldn't execute query 13. $query13");
