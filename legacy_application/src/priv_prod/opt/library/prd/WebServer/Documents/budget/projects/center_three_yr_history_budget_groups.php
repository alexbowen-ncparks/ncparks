...
$query3="select center,budget_group,cash_type,gmp,
...
echo "<td align='center'>Accounts<br /><font color=brown class=cartRow>$accounts</font></td>";
...
"<tr$t> 
		   ...
		   <td><a href='center_three_yr_history_accounts.php?report=$report&section=$section&district=$district&accounts=$accounts&history=$history&period=$period&parkcode=$parkcode&budget_group=$budget_group'>$budget_group</a></td> 
           <td>$cash_type</td> 	
           <td>$gmp</td> 	
           <td>$cy_amount</td> 
           <td>$py1_amount</td> 
