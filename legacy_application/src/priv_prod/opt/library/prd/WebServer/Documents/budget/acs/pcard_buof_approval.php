...
/* 2022-03-11: CCOOPER - R Gooding (60032997) existing, adding: H Rumble (60036015), A Boggus (60033242), Carmen Williams (65032827), and M Rouhani (65032850) */
...
if($fs_approver=='')
{
echo "<table align='center'><tr><td><font color='brown' class='cartRow2'>Budget Office: Final Authorized Form sent to DNCR</td></td></tr></table>";
echo "<table border='1' cellpadding='5' align='center' >";
//echo "<tr><th>Cardholder</th><th>Justification</th><th>Manager<br />Approval</th></tr>";
echo "<tr><th>Cardholder</th></th></tr>";
/*
...
*/
echo "<tr><td>$first_name $middle_initial $last_name $suffix<br />Emp# $employee_number<br />Pos# $position_number<br />Title: $job_title<br />Phone# $phone_number</td></tr>";
...
echo "<table border='3' align='center'>";
	  ...
	  // echo "<tr><td><font color='brown' class='cartRow2'>Enter Cost per gallon from last fuel invoice</font><input name='cost_per_gallon' type='text'  size='15'><br />(Example: 2.6530)</td></tr>";	   
	   ...
	   echo "</tr>";
	   echo "<tr><td><font color='brown' class='cartRow2'>$buof_first $buof_last Approval:<input type='checkbox' name='buof_approved' value='y'></font><input type='submit' name='submit' value='Submit'></th></tr>";
	   //echo "<tr><th></th></tr>";
...
echo "<input type='hidden' name='approval_number' value='1'>";
echo "<input type='hidden' name='id' value='$id'>";
//echo "<input type='hidden' name='record_count' value='$num12'>";
...
echo "<table align='center'><tr><td><font color='brown' class='cartRow2'>Budget Office: PCARD Received from DNCR and sent to Parks</td></td></tr></table>";
echo "<table border='1' cellpadding='5' align='center' >";
//echo "<tr><th>Cardholder</th><th>Justification</th><th>Manager<br />Approval</th></tr>";
echo "<tr><th>Cardholder</th></th></tr>";
/*
...
echo "<table border='3' align='center'>";
     /*
	   ...
	   echo "</tr>";
	   */
	   echo "<tr><th>PCARD# (Last 4 ONLY)<input type='text' size='5' name='card_number' value='$card_number'></th></tr>";
	   echo "<tr><td><font color='brown' class='cartRow2'>$buof_first $buof_last Approval:<input type='checkbox' name='buof_approved' value='y'></font><input type='submit' name='submit' value='Submit'></th></tr>";
	   //echo "<tr><th></th></tr>";
...
//echo "<input type='hidden' name='fyear' value='$fyear'>";
echo "<input type='hidden' name='MAX_FILE_SIZE' value='2000000'>";
echo "<input type='hidden' name='approval_number' value='2'>";
echo "<input type='hidden' name='id' value='$id'>";
//echo "<input type='hidden' name='record_count' value='$num12'>";
