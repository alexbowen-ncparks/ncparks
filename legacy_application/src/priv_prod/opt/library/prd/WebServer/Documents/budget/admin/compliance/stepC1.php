...
//echo $tempid;
extract($_REQUEST);
/* 2022-07-01: Cooper comment out for New FYEAR turnover
...
$query30="insert ignore into mission_scores(gid,playstation,percomp,fyear)
          select gid,playstation,percomp_default,'$compliance_fyear'
		  from mission_centers where 1 " ;
...
//echo "<table align='center'><tr><td><a href='step_group.php?report_type=yearly_reset&compliance_fyear=$compliance_fyear&compliance_month=$compliance_month'>Return to Monthly Compliance Tasks</a></td></tr></table>";
