...
echo "<tr>";
echo "<td><font size=5 color=brown>Concessions-$posTitle</font></H1></td>";
...
{echo "<td><font size=4 class=cartRow><b><A href='reports_menu.php' >Reports</A></b></font></td>";}

if($filegroup!='reports') 
{echo "<td><font size=4 ><b><A href='reports_menu.php' >Reports</A></b></font></td>";}
