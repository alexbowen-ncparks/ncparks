...
$query1="update sspd1
set menu='$menu',park='$user_location',document_description='$document_description',entered_by='$tempid',sed='$system_entry_date' where id='$id'  ";
...
header("location: sspd1.php?menu=$menu&menu_fa=fa1&type=edit&comp=yes&id=$id");
