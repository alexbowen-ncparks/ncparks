...
$query4="select pid,gid,procedure_name,procedure_document,file,status,park,district,cash_plan
         from blog_procedures
		 where 1
         order by blog_procedures.pid desc ";
...
while ($row4=mysqli_fetch_array($result4))
	...
	$description[]=$row4['procedure_name'];
	$pid[]=$row4['pid'];
	}	
