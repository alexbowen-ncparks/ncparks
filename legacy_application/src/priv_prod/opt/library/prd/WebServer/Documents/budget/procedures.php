...
echo "<table>";
echo "<tr>";
echo "<td><font color=brown class='cartRow'><a href='procedures.php?folder=community'>Procedures</a></font></td>";
...
if($level=='5')
{
echo "<td><a href='procedures.php?comment=y&add_comment=y&folder=community&pid=$pid&editP=y'>Edit</a></font></td>";
}
...
echo "<td><textarea name= 'procedure_document' rows='100' cols='120' >$procedure_document</textarea></td>";            
	  ...
	  echo "<td><input type=submit name=submit value=Update Procedure></td>";
...
echo "<table border='1'><td><a href='procedures.php?comment=y&add_comment=y&folder=community&pid=$pid><font color='brown' $shade_comment>Comments</font></a></td><td><font color='brown' $shade_game>Game</font></td></table>";
