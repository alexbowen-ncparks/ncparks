...
$query0="delete from bd725_dpr_account_detail3_rec where f_year='$fiscal_year' ";
...
$query="insert into bd725_dpr_account_detail3_rec
(center,account,account_description,cash_type,acct_transfer,ptd,f_year)
select center,account,account_description,cash_type,acct_transfer,sum(ptd),f_year
from bd725_dpr_account_detail
where cash_type='receipt'
and acct_transfer='n'
and f_year='$fiscal_year'
group by center,account,cash_type,acct_transfer ";
...
$query1="insert into bd725_dpr_account_detail3_rec
(center,account,account_description,cash_type,acct_transfer,ptd,f_year)
select new_center,'none','appropriation','receipt','n',sum(amount),'$fiscal_year'
...
$query2="delete from bd725_dpr_account_detail3_rec where ptd='0.00'
         and f_year='$fiscal_year' ";
