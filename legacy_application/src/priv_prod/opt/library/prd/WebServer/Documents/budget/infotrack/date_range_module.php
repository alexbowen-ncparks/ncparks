...
$spreadsheet_icon="<a href='date_range_module.php?rep=spreadsheet&admin_num=$admin_num&range_start=$range_start&range_end=$range_end' target='_blank'><img height='50' width='50' src='/budget/infotrack/icon_photos/csv1.png' alt='reports icon' title='spreadsheet download'></img></a>";
}
...
echo "<br />";
echo "<table align='center'><tr><td><font color='brown' size='5'>PCARD Transactions by Date Range</font></td></tr></table><br />";
...
echo "<table align='center'><tr><td><font color='brown'>Admin#</font><input type='text' size='10' name='admin_num' value='$admin_num' $readonly></td></tr></table>";
echo "<br />";
...
echo "</td>";
echo "<td>";
//include("slide_toggle_procedures_module2_pid65_messages.php");
echo "</td>";
echo "</tr>";
echo "</table>";
if($submit2!='Go'){exit;}
