...
$table2="project_articles_community";


////mysql_connect($host,$username,$password);
@mysql_select_db($database) or die( "Unable to select database");

$query="insert ignore into $table2(user,system_entry_date,project_category,project_name, 
project_note,weblink)
SELECT user,'$system_entry_date',project_category,project_name,project_note,weblink
FROM $table where 1 and project_note_id='$project_note_id' ";
