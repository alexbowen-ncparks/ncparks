...
$dc="UPDATE purchase_request_3 set ";
	foreach($fldArray as $key=>$value){
		$fld=mysqli_real_escape_string($_POST[$value][$v]);
		$dc.=" $value='$fld', ";		
	}// end fldArray
...
$headerArray=array("pa_number","center_code","purchase_type","ncas_account","account_description","requested_amount","purchase_description","justification","district_approved","disu_comments","section_approved","division_approved","bo_comments");
...
if($beacnum=='60033018')
{
echo "<td><font color='red'>adrian testing</font> <a href='park_purchase_request_view.php?view=all&report_date=$report_date&submit=Submit&section=$section&appall=y'>CHOP Approval All</all></td>"
}
echo "</tr>";
}
...
for($i=0;$i<count($b);$i++)
	...
	$var="<a href='park_purchase_request_view.php?center=$center&report_date=$report_date&edit=$var&submit=Submit'>$var</a> <a href='park_purchase_request_view.php?center=$center&del=$passPA_number&report_date=$report_date&submit=Submit$passDist$passCent' onClick='return confirmLink()'><img src='button_drop.png'></a>";}
