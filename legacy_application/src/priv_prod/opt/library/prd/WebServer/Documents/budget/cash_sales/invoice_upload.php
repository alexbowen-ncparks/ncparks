...
$query5="update fuel_tank_usage set document_location='$target',reimbursement_rate='$cost_per_gallon'
where id='$id'  ";
...
header("location: page2_form.php?parkcode=$parkcode&cash_month=$cash_month&fyear=$fyear&cash_month_calyear=$cash_month_calyear&step=3");
