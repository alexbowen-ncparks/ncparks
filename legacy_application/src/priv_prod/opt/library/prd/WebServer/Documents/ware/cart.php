...
foreach($ARRAY AS $index=>$array)
	...
	foreach($array as $fld=>$value)
		...
		if($fld=="id")
			...
			$temp="<a href='cart.php?del=x&id=$value$pp' onclick=\"return confirm('Are you sure you want to remove this Item?')\"><font size='-2'>Remove</font> &nbsp;&nbsp;<img src='delete.png'></a>";
...
// 			onchange=\"item_tot_id($price,$index);\">
			if(empty($rep)){$value=$temp;}
			}
		if($fld=="price")
			{
