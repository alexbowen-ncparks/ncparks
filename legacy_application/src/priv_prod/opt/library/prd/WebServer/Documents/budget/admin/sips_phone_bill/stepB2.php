...
//echo "line104 <br />"; exit;

$query11=" update sips_phone_bill3
set center=mid(a,5,7)
where 1 ; ";
...
$result13i=mysqli_query($connection, $query13i) or die ("Couldn't execute query 13i.  $query13i");
...
$result14e=mysqli_query($connection, $query14e) or die ("Couldn't execute query 14e.  $query14e");
...
$result14f=mysqli_query($connection, $query14f) or die ("Couldn't execute query 14f.  $query14f");
...
$result14g=mysqli_query($connection, $query14g) or die ("Couldn't execute query 14g.  $query14g");
...
$result14h=mysqli_query($connection, $query14h) or die ("Couldn't execute query 14h.  $query14h");
...
$result14i=mysqli_query($connection, $query14i) or die ("Couldn't execute query 14i.  $query14i");
...
$result14j=mysqli_query($connection, $query14j) or die ("Couldn't execute query 14j.  $query14j");
...
$ncas_invoice_calyear2=substr($ncas_invoice_calyear,2,2);
if($ncas_invoice_month=='01'){$ncas_invoice_number="06-8009/12-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='02'){$ncas_invoice_number="06-8009/01-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='03'){$ncas_invoice_number="06-8009/02-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='04'){$ncas_invoice_number="06-8009/03-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='05'){$ncas_invoice_number="06-8009/04-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='06'){$ncas_invoice_number="06-8009/05-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='07'){$ncas_invoice_number="06-8009/06-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='08'){$ncas_invoice_number="06-8009/07-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='09'){$ncas_invoice_number="06-8009/08-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='10'){$ncas_invoice_number="06-8009/09-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='11'){$ncas_invoice_number="06-8009/10-".$ncas_invoice_calyear2."/DCR" ;}
if($ncas_invoice_month=='12'){$ncas_invoice_number="06-8009/11-".$ncas_invoice_calyear2."/DCR" ;}
...
$query15="update sips_phone_bill4,center
		  ...
		  where sips_phone_bill4.center=center.new_center ";
...
$query16b="update sips_phone_bill4,center
           set sips_phone_bill4.ncas_company=center.new_company,
		   sips_phone_bill4.ncas_budget_code=center.new_budcode
		   where sips_phone_bill4.center=center.new_center  ";
