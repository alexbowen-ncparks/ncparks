...
$query13="insert into crj_posted8_v2
(park,center,f_year,month,deposit_id,day,acctdate,amount_park,amount_2751,amount_1000)
select
park,center,f_year,month,deposit_id,day,acctdate,sum(amount_park),sum(amount_2751),sum(amount_1000)
from crj_posted7_v2
where f_year='$fiscal_year' 
group by park,center,f_year,deposit_id,acctdate; ";
//echo "query13=$query13";echo "<br />";//exit;
$result13=mysqli_query($connection, $query13) or die ("Couldn't execute query 13. $query13");

$query14="update crj_posted8_v2
