...
"<tr> 
       ...
       <th align=left><font color=brown>Favorite Articles</font></th><th><font color=brown>ADD</font></th>

</tr>";
echo "</table>";

echo "<table border=1>";
echo "<tr bgcolor='$table_bg2'><td><A href='webpages_community_edit.php'>Download from Community</A></td></tr>";
//echo "<h2><align='center'>OR</h2>";
echo "<tr><td><A href='webpage_add.php?&add_your_own=y'>Add your own</A></td></tr>";
echo "</table>";


//echo "<h3><A href='webpages_community_edit.php'>Download from Community</A></h2>";
//echo "<h2><align='center'>OR</h2>";
//echo "<h3><A href='webpage_add.php?&add_your_own=y'>Add your own</A></h2>";
exit;
}
if($add_your_own =='y')
{
...
echo
"<form method=post action=webpage_add2.php>";



echo "<table border=1>";
       //echo "<form name='form1' method='post' action='duplicate_notes_insert.php'>";
	   //echo "<tr><th><font color='blue'>Category</font></th><td><input name='project_category' type='text' size='30' id='project_category'></td></tr>";
	   echo "<tr><th><font color='blue'>Title</th></font><td><input name='project_name' type='text' size='30' id='project_name'></td></tr>";
       echo "<tr><th><font color='blue'>Article Description</th></font><td><textarea name= 'project_note' rows='2' cols='20' ></textarea></td></tr>";
       echo "<tr><th><font color='blue'>Article Web Address</th></font><td><textarea name= 'web_address' rows='2' cols='20'></textarea></td><td><input type=submit value=ADD></td></tr>";
