...
$query9="select account_description as 'account_description1',budget_group as 'budget_group1',
         gmp from report_budget_history_multiyear
...
$query3="select parkcode,center,center_description,account,account_description,
		 ...
		 and account='$account'
         group by account,parkcode order by parkcode";
...
echo "<H1 ALIGN=left><font color=brown><i>Receipt Account $account-$account_description1</i></font></H1>";
echo "<table>";
echo "<tr><td><font color=brown>Budget Group: $budget_group1</font></td></tr>";
echo "<tr><td><font color=brown>GMP: $gmp</font></td></tr>";
echo "<tr><td><font color=brown>Centers-$num3</font></td></tr>";
echo "</table><br />";
...
echo "<th align=left><font color=brown>Center_Description</font></th>"; 
