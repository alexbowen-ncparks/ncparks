 ...
 */
 ...
 <br />";if($alert=='y'){echo "<table border='1' cellpadding='10'><tr><td>message read by park? </td><td><a href='/budget/menu.php?forum=blank'>Yes<br /><img height='25' width='25' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of green check mark'></img></a></button></td></tr></table>";}
 echo "</td> ";
...
echo "<td><input type='text' size='1' name='comment_id[]' value='$comment_id' readonly='readonly'><br /><a href='note_tracker_noteprint.php?comment_id=$comment_id'><img height='20' width='20' src='/budget/infotrack/icon_photos/magnify.png' alt='picture of home'></img></a>";

if($weblink != '' and $alert=='y')
{
echo "<br />
<a href='$weblink'>
<img height='35' width='35' src='/budget/infotrack/icon_photos/green_paint_1.png' alt='picture of green paint' title='paint'></img>	</a><br />alert date<br /> $original_entry_date<br />$days_elapsed days old";
}

if($weblink == '' and $alert=='y')
{
echo "<br />
alert date<br /> $original_entry_date<br />$days_elapsed days old";
}
