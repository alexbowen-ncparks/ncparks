...
(system_entry_date,project_group,project_category,project_note,report_level,weblink,display) 
values ('$date','$project_group','$project_category','$project_note',
'$report_level','$weblink','$display')";
