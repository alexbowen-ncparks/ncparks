...
if(isset($_FILES['file_upload']['tmp_name']))
	...
	$error=$_FILES['file_upload']['error'];
		if($error==0 and !empty($temp_name))
			...
			$uploaddir = "uploads/attachment_pio"; // make sure www has r/w permissions on this folder
			...
			$sql="INSERT attachment_pio SET title='$name',link='$uploadfile', ci_num='$ci_num'";
			//		echo "$sql";exit;
