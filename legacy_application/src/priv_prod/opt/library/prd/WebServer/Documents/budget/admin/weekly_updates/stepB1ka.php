...
(  `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 `ncas_account` varchar( 15  )  NOT  NULL ,
 `prepared_by` varchar( 75  )  NOT  NULL ,
 `ncas_invoice_date` varchar( 15  )  NOT  NULL ,
 `datesql` varchar( 15  )  NOT  NULL ,
 `system_entry_date` date NOT  NULL ,
 `ncas_invoice_number` varchar( 75  )  NOT  NULL ,
 `ncas_invoice_amount` decimal( 12, 2  )  NOT  NULL ,
 `invoice_total` decimal( 12, 2  )  NOT  NULL ,
 `vendor_name` varchar( 75  )  NOT  NULL ,
 `vendor_number` varchar( 40  )  NOT  NULL ,
 `group_number` varchar( 8  )  NOT  NULL ,
 `parkcode` varchar( 8  )  NOT  NULL ,
 `ncas_center` varchar( 15  )  NOT  NULL ,
 `energy_group` varchar( 50  )  NOT  NULL ,
 `energy_subgroup` varchar( 50  )  NOT  NULL ,
 `cdcs_uom` varchar( 20  )  NOT  NULL ,
 `energy_quantity` decimal( 12, 2  )  NOT  NULL ,
 `account_number` varchar( 75  )  NOT  NULL ,
 `cvip_id` int( 10  )  NOT  NULL ,
 `valid_account` char( 1  )  NOT  NULL default  'n',
 `center_code` varchar( 4  )  NOT  NULL ,
 `f_year` varchar( 4  )  NOT  NULL ,
 `calyear1` varchar( 4  )  NOT  NULL ,
 `month1` char( 2  )  NOT  NULL ,
 `day1` char( 2  )  NOT  NULL ,
 `valid_energy_group` char( 1  )  NOT  NULL default  'n',
