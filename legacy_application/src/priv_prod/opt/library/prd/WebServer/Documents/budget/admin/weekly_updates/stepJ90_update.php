...
echo "<H2 ALIGN=LEFT><font color=red>$section-$center</font></H2>";
$query1="select *
from partf_payments
where xtid='$xtid' ;";
...
echo "<tr>"; 
 ...
 echo " <th><font color=brown>ChargProjNum</font></th>";
...
echo  "<td>$datenew</td>";
echo  "<td>$proj_num</td>";
echo "<form method='post' action='stepJ90_match.php'>"; 
echo  "<td><input type='text' name='charg_proj_num' size='3' ></td>";
...
echo "<table>";
echo "<tr>";
echo "<td><form method=post='post' action='stepJ90_update.php'>
     ...
     <input type='hidden' name='step' value='$step'>
     <input type='hidden' name='step_num' value='$step_num'>	 
     <input type='submit' name='submit' value='ca_match'></form></td>";
