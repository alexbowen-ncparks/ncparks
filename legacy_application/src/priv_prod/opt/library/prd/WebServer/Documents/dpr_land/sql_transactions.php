...
$var="transactions";
	...
	$sql="SELECT t1.transactions_id
	from land_assets_transactions_jnc as t1
	...
	if(mysqli_num_rows($result)>0)
		...
		from $var as t1
		WHERE t1.transactions_id='$transactions_id'"; //ECHO "$sql"; //exit;
		...
		{	
		$message= "$sql<br />No transaction history is on record for land_assets_id $land_assets_id.";
		}
