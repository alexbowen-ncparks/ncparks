...
(  `park` varchar( 4  )  NOT  NULL ,
 ...
 `transdate_min` date NOT  NULL ,
 `transdate_max` date NOT  NULL ,
 `deposit_id` varchar( 20  )  NOT  NULL ,
 `amount_park` decimal( 12, 2  )  NOT  NULL ,
 `amount_2751` decimal( 12, 2  )  NOT  NULL ,
 `amount_1000` decimal( 12, 2  )  NOT  NULL ,
