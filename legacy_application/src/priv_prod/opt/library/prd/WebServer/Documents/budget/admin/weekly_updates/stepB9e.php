...
(
`rcc` varchar( 15 ) NOT NULL default '',
`ncasnum` varchar( 15 ) NOT NULL default '',
`ncasnum_description` varchar( 40 ) NOT NULL default '',
`certified` decimal( 13, 2 ) NOT NULL default '0.00',
`authorized` decimal( 13, 2 ) NOT NULL default '0.00',
`current_month` decimal( 13, 2 ) NOT NULL default '0.00',
`ytd` decimal( 13, 2 ) NOT NULL default '0.00',
