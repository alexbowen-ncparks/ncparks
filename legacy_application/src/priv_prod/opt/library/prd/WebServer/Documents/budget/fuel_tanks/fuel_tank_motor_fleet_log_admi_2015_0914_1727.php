...
$result12c = mysql_query($query12c) or die ("Couldn't execute query 12c.  $query12c");

$row12c=mysql_fetch_array($result12c);
...
$row11c=mysql_fetch_array($result11c);
...
$row11d=mysql_fetch_array($result11d);
