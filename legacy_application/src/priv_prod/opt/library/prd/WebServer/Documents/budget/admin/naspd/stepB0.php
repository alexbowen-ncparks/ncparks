...
$query0="update table_menu2 set backup='n'
         where project_category='fms' and project_name='naspd_annual' and project_group='A' ";
...
$query="SELECT table_name,backup,id FROM `table_menu2`
        WHERE  project_category='fms' and project_name='naspd_annual' and project_group='A' and backup='n' 
...
echo "<tr><td colspan='3'><a href='stepB0.php?mark_complete=y&project_category=$project_category&project_name=$project_name&step_group=$step_group&step_num=$step_num&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date'>Mark Complete</a></td></tr>";
echo "</table>";
...
{header("location: naspd_annual.php?report_type=form");}
