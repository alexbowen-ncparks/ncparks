...
(  `fiscal_year` varchar( 4  )  NOT  NULL default  '',
 ...
 `step_group` char( 2  )  NOT  NULL default  '',
 `step` varchar( 100  )  NOT  NULL default  '',
 `link` varchar( 100  )  NOT  NULL default  '',
 `weblink` varchar( 200  )  NOT  NULL default  '',
 `status` varchar( 20  )  NOT  NULL default  'pending',
 `time_complete` varchar( 30  )  NOT  NULL default  '',
 `time_elapsed_sec` varchar( 30  )  NOT  NULL ,
 `time_elapsed_min` decimal( 10, 2  )  NOT  NULL ,
 `status_previous` varchar( 20  )  NOT  NULL ,
 `cid` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `cid`  ) ,
 UNIQUE  KEY  `project_category` (  `project_category` ,  `project_name` ,  `step_group`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
 ";
