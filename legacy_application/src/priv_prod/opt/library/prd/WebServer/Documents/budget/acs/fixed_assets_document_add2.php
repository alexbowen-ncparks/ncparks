...
if($source=="pcard"){$source_table="pcard_unreconciled";}
...
echo "<H3 ALIGN=left><A href=fixed_assets_doc_lookup.php?location=$location&center=$center&account=$account&calyear=$calyear&submit=search>Return HOME</A></H3>";
