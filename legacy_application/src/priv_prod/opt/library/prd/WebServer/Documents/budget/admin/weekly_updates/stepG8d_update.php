...
echo "<tr>"; 
 ...
 echo " <th><font color=brown>pcu id</font></th>";
...
echo "</tr>";
echo  "<form method='post' autocomplete='off' action='stepG8d_update2.php'>";
...
echo  "<td><input type='text' size='5' name=pcu_id </td>";
...
echo   "</form>";	 
echo "</table>";
echo "<H2 ALIGN=LEFT><font color=blue>SECTION 2-Possible Matches: Paste correct pcu_id to Section 1 and Click Update</font></H2>";
$query2="select 
center,ncasnum,amount,trans_date,transid_new,transid_date_count,id 
from pcard_unreconciled
where transid_new='$pcard_trans_id'
order by id desc
";
