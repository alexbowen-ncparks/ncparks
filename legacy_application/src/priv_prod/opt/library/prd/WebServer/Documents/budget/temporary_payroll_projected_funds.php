...
$report_date=date("F j, Y", strtotime($report_date));

echo "<table><tr><th>
Fiscal Year $f_year-Temporary Payroll as of $report_date</th></tr></table>";
...
echo "<tr>";
echo "<th>account</th><th>account_description</th><th>cash_type</th><th>authorized</th><th>cy_earned_spent</th><th>available_funds</th>
";
