...
//echo $db_backup;
//exit;
//echo "budget.exp_rev$end_date";exit;
...
$query1="create table budget.exp_rev_$end_date
(
...
$query2="update budget.project_steps_detail set status='complete' 
