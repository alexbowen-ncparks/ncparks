...
*/	
	...
	echo "<td><table class='flip'><tr$t><td>$filegroup ($countid)</td></tr></table></td>";
	echo "<td><table class='panel'><tr$t>";
	$query1="select distinct cash_type as 'cash_type' from coa where 1";
    $result1 = mysqli_query($connection, $query1) or die ("Couldn't execute query 1.  $query1");     
    $row1=mysqli_fetch_array($result1);
    extract($row1);
	echo "<td><table><tr><td>$cash_type</td></tr></table></td>";
	echo"</tr></table></td>";
