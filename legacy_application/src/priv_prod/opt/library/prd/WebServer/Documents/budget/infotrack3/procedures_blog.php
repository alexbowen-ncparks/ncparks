...
if($level=='5')
{
echo "<td><font color=brown class='cartRow'>(pid $pid)</font></td>";
//echo "<td><a href='procedures_crj.php?comment=y&add_comment=y&folder=community&pid=$pid&editP=y'>Edit</a></font></td>";
echo "<td><a href='procedures_blog.php?comment=y&add_comment=y&folder=community&pid=$pid&editP=y'>Edit</a></font></td>";
/*
if($pid=='12'){
echo "pid=$pid";
...
//echo "<form method='post' action='procedures_blog.php'>";
echo "<table align='center'>";
echo "<form method='post' action='procedures_edit_info3.php'>";
echo "<tr><td><input type='submit' name='submit' value='Update_Procedure'></td></tr>";
echo "<tr>";
...
echo "<td><textarea name= 'procedure_document' rows='100' cols='120' >$procedure_document</textarea></td>";            
     ...
     echo "<input type='hidden' name='editU' value='y'>";	   
	 echo "</form>";
echo "</tr>";
