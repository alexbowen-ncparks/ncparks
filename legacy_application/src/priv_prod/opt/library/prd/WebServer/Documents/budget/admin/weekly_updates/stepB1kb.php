...
(  `ncas_account` varchar( 15  )  NOT  NULL default  '',
 `ncas_account_description` varchar( 50  )  NOT  NULL default  '',
 ...
 `denr_ss` char( 1  )  NOT  NULL default  'n',
 `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `energy_group` (  `energy_group` ,  `energy_subgroup`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
";
