...
echo "<br />";
/*
echo "<table><tr><th><font color='brown' size='5' class='cartRow'>Please answer all Survey Questions.<br /> If there are no comments for question 4, please enter: No Comments </th></tr></table>";
*/
echo "<table border='1'>";
echo "<tr>";	   
//echo "<th>ID</th>";
