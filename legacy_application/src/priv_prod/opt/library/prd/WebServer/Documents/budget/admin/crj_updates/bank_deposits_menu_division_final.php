 ...
 */
 ...
 // (60032793 Accountant Tony Bass) (60036015 Accounting Clerk  Rod Bridges)   (60032781 Budget Officer Tammy Dodd)   (60096024 Seasonal Maria Cucurullo)  (60032997 Accounting Clerk Rachel Gooding)  (60033242 Budget Office Rebecca Owen)
/* 
if($beacnum=='60032793')
{ 
if($beacnum=='60032793' or $beacnum=='60036015' or $beacnum=='60032781' or $beacnum=='60096024' or $tempid=='debragga1235' or $beacnum=='60032997' or $beacnum='60033242')
{
...
{
echo "<hr>";
echo "<table><tr><th><font color='brown'>$header_message</font></th></tr><tr><th><font> Upload CRS CSV File-(a)Browse for File (b)click: Upload CSV File</th></tr></table><br /></font>";}
}
 


 // (60032793 Accountant Tony Bass) (60036015 Accounting Clerk  Rod Bridges)   (60032781 Budget Officer Tammy Dodd)    (60032997 Accounting Clerk Rachel Gooding)
  
 if($beacnum=='60032793' or $beacnum=='60036015' or $beacnum=='60032781' or $beacnum=='60032997')
 {
