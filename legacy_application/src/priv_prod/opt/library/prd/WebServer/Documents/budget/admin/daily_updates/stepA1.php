...
$db_backup="budget_daily_$today_date";
//echo $db_backup;
//exit;
...
$query1a="update project_steps set status='pending' where project_name='daily_updates' ";
$result1a = mysqli_query($connection, $query1a) or die ("Couldn't execute query 1a.  $query1a");


$query1b="update project_steps_detail set status='pending' where project_name='daily_updates' ";
...
$query30="update budget.project_steps_detail set status='complete' 
          where step_group='$step_group' and step_num='$step_num' ";
