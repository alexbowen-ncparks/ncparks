...
if($id==$idS)
{
echo "<td><font class='cartRow'><font color='red'>Delete Record?</font><br /><br /><table align='center' cellpadding='10'><tr$t><th><a href='sspd1.php?menu_fa_fa1&type=search&menu=$menu&parkS=$parkS&del=yes&conf=y&idS=$id'>Yes</a></th><th><a href='sspd1.php?menu_fa_fa1&type=search&menu=$menu&parkS=$parkS&fas_numS=$fas_numS'>No</a></th></tr></table></font></td>";
...
echo "<table ALIGN='center' ><tr><th><font color=brown></th><td><font $shade_add><a href='sspd1.php?menu=$menu&menu_fa=fa1&type=add'>Add</a></font></td><td><font $shade_search><a href='sspd1.php?menu=$menu&menu_fa=fa1&type=search'>Search</a></font></td><td><font class='cartRow'>Edit</font></td></tr></table>";
echo "<br />";	
