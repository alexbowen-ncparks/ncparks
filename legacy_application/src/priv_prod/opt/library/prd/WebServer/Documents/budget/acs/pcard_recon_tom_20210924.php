...
if($_SESSION['budget']['level']<1)
	{
	echo "You do not have access privileges for this database [budget] report at level . Contact <a href="mailto:database.support@ncparks.gov">database.support@ncparks.gov</a>, if you wish to gain access.";
	exit;
	}
	else
	{
...
if($level==2)
	...
	if(in_array($parkList,$da))
		...
		{
		echo "<br><br>Line 269: You do not have access privileges for this database [$db] report at $level $posTitle. Contact <a href="mailto:database.support@ncparks.gov">database.support@ncparks.gov</a>, if you wish to gain access.<br>park_project_balances.php<br>budget.php<br>dist=$parkList $distPark";exit;
		}
...
if($WHERE=="")
	...
	echo "You do not have access privileges for this database [$db] report $rep at level $level $posTitle. Contact <a href="mailto:database.support@ncparks.gov">database.support@ncparks.gov</a>, if you wish to gain access.<br><br>budget.php<br>";
