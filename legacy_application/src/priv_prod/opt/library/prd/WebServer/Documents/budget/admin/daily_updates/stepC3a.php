...
header("location: crs_deposit_username_update.php?project_category=$project_category&project_name=$project_name&step_group=$step_group&step=$step&step_num=$step_num");
