...
{
$query3g="select 
admin,last_name,first_name,position_number,job_title,affirmation_abundance,photo_location,location,act_id,card_number,comments,justification,document_location,document_location_final,id
from pcard_users 
