...
if($center_change != '')
{
$center_query="update sips_phone_bill4  set ncas_center='$center_change',center_change='y'  where id='$center_change_id' ";

$result_disu_comment_query=mysql_query($disu_comment_query) or die ("Couldn't execute query disu comment query. $disu_comment_query");
...
$reportQ2="SELECT playstation as 'park',center,account,service,invoice_num,ncas_center,amount,id
          from sips_phone_bill4
		  where 1  
          order by center,account,service  ";
...
echo "<table align='center' border='1'>";
echo "<tr><td align='center'><font color='brown'>line#</font></td><td align='center'><font color='brown'>park</font></td><td align='center'><font color='brown'>center</font></td><td align='center'><font color='brown'>account</font></td><td align='center'><font color='brown'>service/<br />invoice#</font></td><td align='center'><font color='brown'>amount</font></td></tr>";
...
$rank=@$rank+1;
$amount=number_format($amount,2);
if($account=='532814' and $center_change != 'y'){$t=" bgcolor='yellow' ";}else{$t=" bgcolor='lightcyan' ";}

echo "<tr$t>";
echo "<td>$rank</td>";
echo "<td>$park</td>";

if($account=='532814' and $center_change != 'y' )
{
echo "<td>$center<br />";
...
echo "<input type='submit' value='Submit'>";
echo "</form>";
echo "<br />$ncas_center $center_charged";
