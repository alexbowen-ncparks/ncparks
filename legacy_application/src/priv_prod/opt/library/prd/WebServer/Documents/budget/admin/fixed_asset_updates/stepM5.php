...
$query2="SELECT xtnd_day from pcard_report_days where id='1' ";
...
echo "<H2 ALIGN=center><font size=4><b><A href=/budget/admin/fixed_asset_updates/step_group.php?project_category=$project_category&project_name=$project_name&step_group=$step_group> Return Fixed Asset Updates-HOME </A></font></H2>";
