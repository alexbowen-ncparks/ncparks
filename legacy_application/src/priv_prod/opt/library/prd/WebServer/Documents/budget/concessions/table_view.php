...
include("style1.html");
echo "<table class='center'><tr><td><a href='$table_file?table=$table&add=y'>ADD Record</a></td><th><a href='$table_file?table=$table&search=y'>SEARCH Records</a></th></tr></table>"; 
//$decimalFields=array("");
...
//$table_file=$table.'.php';
//$autocomplete_file=$table.'_autocomplete.php';
echo "<th><a href='$table_file?table=$table&order_by=$v&asc_desc=$asc_desc2'>$v</a><br />sorted $asc_desc <br />";include($autocomplete_file); echo"</th>";
}
else
{
echo "<th><a href='$table_file?table=$table&order_by=$v'>$v</a></th>";
}
}
echo "</tr>";
...
foreach($ARRAY as $k=>$v)
	...
	echo "<tr$tr>";
		...
		foreach($v as $k1=>$v1){// each field, e.g., $tempID=$v[tempID];
			...
			if($k1==$primaryField){echo "<td>$v1 <a href='$table_file?table=$table&edit=y&order_by=$order_by&keyword_chosen=$keyword_chosen&fs=$fs&pf=$v1'>Edit</a></td>";}
			else  {echo "<td>";
