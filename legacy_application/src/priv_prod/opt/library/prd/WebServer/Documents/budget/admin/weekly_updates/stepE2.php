...
$query1="insert into xtnd_po_encumbrances(
         center,buying_entity,po_number,blanket_release_number,po_line_number,vendor_short_name,
		 first_line_item_description,po_remaining_encumbrance,po_line_entered_date)
		 select
		 center,buying_entity,po_number,blanket_release_number,po_line_number,vendor_short_name,
		 first_line_item_description,po_remaining_encumbrance,po_line_entered_date
		 from xtnd_po_encumbrances_temp where 1; ";
...
$query1a="update budget.xtnd_po_encumbrances set center=trim(center),
