...
{
echo "<hr>";
echo "<table><tr><th><font color='brown'>$today Parks Financial Services Group:</font><font> Upload CRS CSV File-(a)Browse for File (b)click: Upload CSV File</th></tr></table><br /></font>";}
}
