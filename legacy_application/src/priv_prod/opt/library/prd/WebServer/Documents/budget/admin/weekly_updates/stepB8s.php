...
(  `f_year` varchar( 5  )  NOT  NULL default  '',
 ...
 `bank_deposit_date` varchar( 15  )  NOT  NULL default  '',
 `deposit_date2` date NOT  NULL default  '0000-00-00',
 `internal_deposit_num` varchar( 15  )  NOT  NULL default  '',
 `deposit_amount` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `fee_amount` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `other_amount` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `vendor_ck_num` varchar( 15  )  NOT  NULL default  '',
 `fee_period` varchar( 100  )  NOT  NULL default  '',
 ...
 `ncas_post_date` date NOT  NULL default  '0000-00-00',
 `ncas_invoice_num` varchar( 30  )  NOT  NULL default  '',
 `posting_verify_date` varchar( 15  )  NOT  NULL default  '',
 `verified_by` varchar( 40  )  NOT  NULL default  '',
 `budget_group` varchar( 20  )  NOT  NULL default  '',
 `system_entry_date` date NOT  NULL default  '0000-00-00',
 `entered_by` varchar( 30  )  NOT  NULL default  '',
 ...
 KEY  `ncas_center` (  `ncas_center`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
