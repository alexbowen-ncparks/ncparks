...
if(!empty($bo_not_completed))
	...
	<table border='1'><tr><td>From source to destination</td><td>Asset #</td>
	...
	foreach($bo_not_completed as $k=>$array)
		{
		extract($array);    //$bnc 
		echo "<tr><td>$code_from to $code_to</td><td>$an</td><td>$desc</td><td>$sn</td><td>$from_date</td><td>$to_date</td></tr>";
		}
	echo "</table>
         </div>";
	}
