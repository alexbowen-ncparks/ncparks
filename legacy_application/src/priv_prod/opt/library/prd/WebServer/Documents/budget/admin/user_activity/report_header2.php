...
if($report=="file_group"){$shade_file_group="class=cartRow";}
...
//echo "<td><font size=4 color=brown >Scores</font></td>";

echo "<td><a href='user_activity_matrix.php?report=user&section=$section&user_level=$user_level&history=$history&period=$period&range_year_start=$range_year_start&range_month_start=$range_month_start&range_day_start=$range_day_start&range_year_end=$range_year_end&range_month_end=$range_month_end&range_day_end=$range_day_end'><font  $shade_user>Players</font></a></td>";



echo "<td><a href='user_activity_matrix.php?report=file_group&summary=y&section=$section&user_level=$user_level&history=$history&period=$period&range_year_start=$range_year_start&range_month_start=$range_month_start&range_day_start=$range_day_start&range_year_end=$range_year_end&range_month_end=$range_month_end&range_day_end=$range_day_end'><font  $shade_file_group>Games</font></a></td>";
...
/*
echo "<td>";
include("../../../budget/player_view_menu.php");
echo "</td>";
*/
echo "</tr>";
