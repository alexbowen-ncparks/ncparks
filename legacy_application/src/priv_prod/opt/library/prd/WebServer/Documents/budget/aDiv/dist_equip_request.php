...
$search_array=array();
// used to bypass the whereFilter just looking for $center_code == 'SODI'
IF(in_array($center_code, $dist_array))
	{
	$search_array[]=$center_code;
	}
