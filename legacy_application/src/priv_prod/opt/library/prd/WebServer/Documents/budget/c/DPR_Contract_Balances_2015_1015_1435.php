...
//echo "$sql0";
$result0 = mysql_query($sql0) or die ("Couldn't execute query. $sql0");
...
$result0 = mysql_query($sql0) or die ("Couldn't execute query. $sql0");
$row=mysql_fetch_array($result0);extract($row);
...
";
$result2 = mysql_query($sql2) or die ("Couldn't execute query. $sql2");
...
$result2a = mysql_query($sql2a) or die ("Couldn't execute query. $sql2a");
*/
...
$result3 = mysql_query($sql3) or die ("Couldn't execute query. $sql3");
...
$result3a = mysql_query($sql3a) or die ("Couldn't execute query. $sql3a");
...
$WHERE $whereMan
GROUP  BY contract_num";
$result4 = mysql_query($sql4) or die ("Couldn't execute query. $sql4");
