...
//echo "<br />"; //exit;
mysql_query($query_center_change) or die ("Couldn't execute query center change. $query_center_change") ;
...
mysql_query($query_center_change2) or die ("Couldn't execute query center change2. $query_center_change2") ; 
...
mysql_query($query_center_change3) or die ("Couldn't execute query center change3. $query_center_change3") ; 	
