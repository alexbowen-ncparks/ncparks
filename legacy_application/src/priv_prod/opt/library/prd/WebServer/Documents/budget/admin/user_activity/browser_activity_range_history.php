...
$query3="SELECT tempid1,tempid,user_level,location,postitle,user_browser,count(id) as 'countid' 
FROM `report_user_activity` 
WHERE 1 AND user_browser != 'Trend Micro Web Protection Add-On 1.2.1029'
$where_daterange
$where_userlevel
GROUP BY tempid1,user_browser
ORDER BY `tempid1`,`user_browser` ASC";
...
echo "<th align=left><font color=brown>UserBrowser</font></th>"; 
