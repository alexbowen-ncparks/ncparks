...
$db="$today_date";
$ta="pcard_unreconciled_xtnd_temp2_perm_unique";
//$ct=date("His");
//echo $ct;exit;
...
(  `cardholder` varchar( 50  )  NOT  NULL ,
 ...
 `card_number2` varchar( 20  )  NOT  NULL ,
 `dpr` char( 1  )  NOT  NULL default  'n',
 `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `cardholder` (  `cardholder` ,  `division` ,  `card_number2` ,  `dpr`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
