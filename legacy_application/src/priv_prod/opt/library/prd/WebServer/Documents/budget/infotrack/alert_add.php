...
//if($submit=='Add_Alert' and $folder=='community')
if($submit=='Add_Project')

{
$alert_note=addslashes($alert_note);

$query2=" insert into infotrack_projects_community set
location='$location',
user='$tempID',system_entry_date='$system_entry_date',
project_note='$alert_note' ";

mysqli_query($connection, $query2) or die ("Couldn't execute query 2.  $query2");


$query3=" select max(project_note_id) as 'project_note_id'
from infotrack_projects_community
where
location='$location' and user='$tempID'
";
...
header("location: project1_menu_web.php?comment=y&location=$location&folder=community&category_selected=y&name_selected=y&project_note_id=$project_note_id&add_comment=y");
