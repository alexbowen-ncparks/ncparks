...
echo "<td>$rank2</td>";  
 ...
 echo "<td><a href='project1_menu4.php?comment=y&add_comment=y&folder=$folder&project_category=$project_category&category_selected=y&project_name=$project_name&name_selected=y&note_group=$note_group&project_note_id=$project_note_id' >
...
function ajaxFunction(){
	...
	ajaxRequest.open("GET", "ajax_example_output4.php" + queryString1 , true);
...
<?php
if($im==''){$im='y';}
if($im=='y'){echo "setInterval(ajaxFunction,30000);";}
?>
