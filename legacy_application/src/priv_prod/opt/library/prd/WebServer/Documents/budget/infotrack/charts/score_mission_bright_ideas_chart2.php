...
$query4="select complete/total_points*100 as 'percomp'
...
if($position=='60032793'){echo "<a href='bright_idea_steps2_v2.php?cid=$cid&blog=n'><img height='50' width='50' src='/budget/infotrack/icon_photos/green_paint_bucket1.png' alt='picture of green paint'></img></a>";}
if($position!='60032793'){echo "<img height='50' width='50' src='/budget/infotrack/icon_photos/green_paint_bucket1.png' alt='picture of green paint'></img>";}
echo "</td>";
