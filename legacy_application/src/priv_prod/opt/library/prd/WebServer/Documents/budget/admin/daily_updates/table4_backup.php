...
$db="$today_date";
$ta4="crs_tdrr_division_history_parks";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta4.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta4$ct`
SELECT *
FROM `budget`.`$ta4` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta4$ct` 
(
...
$query2a="select count(*) as 'record_count4' from `budget_daily_backup`.`$db$ta4$ct` ";
