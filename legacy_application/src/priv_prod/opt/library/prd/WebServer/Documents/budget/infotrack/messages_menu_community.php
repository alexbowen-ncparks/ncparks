...
echo "<form method=post action=messages_community_search.php>";
...
echo "<tr ><th align=left><A href='messages_menu.php'>Personal</A></th></tr>";
echo "<tr bgcolor='yellow'><th align=left><A href='messages_menu_community.php'>Community</A></th>
...
echo "<form method=post action=messages_menu_community.php>";
...
"<tr$t> 
           ...
           <td><a href='messages_community_edit.php?&project_category=$project_category&category_selected=y'>$project_category</a></td> 
...
//echo "<th align=left><A href='articles_community_edit.php'>Download from Community</A></th><th><A href='article_add.php?&add_your_own=y'>Add your own</A></th>";
echo "<tr><th align=left><A href='messages_community_edit.php'>Community</A></th></tr>";
echo "<tr><th><A href='message_add.php?&project_category=$project_category&add_your_own=y'>Add your own</A></th></tr>";	

 	  
echo "</table>";
echo "<h2 ALIGN=left><font color=brown>$project_category messages:$num5</font></h2>";
...
"<tr$t>
		   ...
		   <td><a href='rename_message.php?&project_note_id=$project_note_id' target='_blank'>rename</a></td>
