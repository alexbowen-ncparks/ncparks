...
$document=$source_table."_".$source_id."_final"; //echo $document; //exit;
//echo "<br />";
//echo "<br />";
//echo $document;
$ext=explode(".",$doc_mod);
...
$query="update $source_table set document_location_final='$target'
where id='$source_id' ";
mysqli_query($connection, $query) or die ("Error updating Database $query");

echo "<font color='red' size='5'>update successful</font>";
echo "<H3 ALIGN=left><A href=cardholder_documents.php?admin=$header_var_admin&submit=search>Return HOME</A></H3>";
