...
if($testAccount==43){
$query="SELECT  mid(acctdate,5,2) as 'month', mid(acctdate,1,4) as 'year' ,exp_rev.description as 'vendor',  -sum(debit-credit) as 'amount'  FROM exp_rev LEFT JOIN coa ON exp_rev.acct = coa.ncasnum where 1 and center='12802903' and ncasnum='434410' and exp_rev.f_year='0708'
group by
mid(acctdate,1,4),
mid(acctdate,5,2),
exp_rev.description
...
{$query="SELECT  mid(acctdate,5,2) as 'month', mid(acctdate,1,4) as 'year' ,exp_rev.description as 'vendor',  sum(debit-credit) as 'amount'  FROM exp_rev LEFT JOIN coa ON exp_rev.acct = coa.ncasnum where 1 and center='12802903' and ncasnum='533310' and exp_rev.f_year='0708'
group by
mid(acctdate,1,4),
mid(acctdate,5,2),
exp_rev.description
