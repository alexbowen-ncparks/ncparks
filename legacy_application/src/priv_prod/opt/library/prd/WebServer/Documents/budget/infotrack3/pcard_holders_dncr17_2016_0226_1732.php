...
include("style1.html");
echo "<table><tr><td><a href='pcard_holders_dncr17.php?add=y'>ADD Record</a></td></tr></table>"; 
//$skip_array=array("");
//$decimalFields=array("");
$LinkFields=array("id");
...
//if($district==''){exit;}
echo "<form method='post' action='pcard_holders_dncr17.php'>";
...
foreach($ARRAY as $k=>$v)
	...
	echo "<tr>";
		...
		foreach($v as $k1=>$v1){// each field, e.g., $tempID=$v[tempID];
			...
			if(in_array($k1,$LinkFields)){echo "<td>$v1 <a href='pcard_holders_dncr17.php?edit=y&id=$v1'>Edit</a></td>";} else  {echo "<td>$v1</td>";}
