...
$query2="SELECT * from wex_detail where 1 and wex_fyear='$wex_fyear' and month='$wex_month' 
         order by center_code,driver_last_name,transaction_date2,transaction_time      ";
...
echo "<td>$driver_first_name(<font color='red'><b>$driver_last_name</b></font>)<br />$vin</td>";		
...
echo "<td><font color='red'>$transaction_date2</font><br />$transaction_time</td>";	
