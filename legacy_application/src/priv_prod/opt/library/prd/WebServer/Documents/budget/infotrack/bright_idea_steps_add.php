...
if($player_note==""){echo "<font color='brown' size='5'>Oops:We did not receive all the Values from your Form<br /><br /> Click the BACK button on your Browser to complete Form</font><br />";exit;}
...
player_note='$player_note',status='ip' ";
...
header("location: bright_idea.php");
