...
and $pcode != 'WEWO' 
and $pcode != 'MOJE' 
and $beacnum != '60036015'   // (Accounting Clerk Rod Bridges)
and $beacnum != '60032781'   // (Budget Officer Tammy Dodd)
and $beacnum != '60096024'   // (Seasonal OA Maria Cucurullo)
and $beacnum != '60032997'   // (Accounting Clerk Rachel Gooding)
and $beacnum != '60033242'   // (Budget Office Angela Boggus, NOT Rebecca Owen)
and $beacnum != '60532827'   // (Budget Office Carmen Williams) ** 04-08-22: added CCOOPER
and $tempid != 'debragga1235')
{
...
// (60032997 Accounting Clerk Rachel Gooding) (60033242 Budget Office Angela Boggus NOT Rebecca Owen)
/* 04/08/2022 CCOOPER - adding Angela Boggus' name above for (60033242)
   * fixing a code bug in the conditional: $beacnum='60033242' changed = to ==
   * adding Carmen Williams beacon ID (65032827) below  */
...
if($beacnum=='60036015' or 
   ...
   else
   {
       ...
       echo "<br />";
       include("bank_deposits_fyear_header2_v2.php");
	echo "<br />";
...
if($level>'3'){echo "<table border='3'><tr><td><a href='bank_deposits.php?add_your_own=y&sortA=y&alt_view=$alt_view&f_year=$f_year'>Sort by Park</td><td><a href='bank_deposits.php?add_your_own=y&alt_view=$switch&f_year=$f_year'>Alternate View</td> </tr></table>";}
