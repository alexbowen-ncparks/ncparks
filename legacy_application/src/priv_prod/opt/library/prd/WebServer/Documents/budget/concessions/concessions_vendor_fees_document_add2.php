...
//echo $document;//exit;
$document="concessions_vendor_fees_".$source_id;
//echo "<br />";
//echo $document;
$ext=explode(".",$doc_mod);
$num=count($ext)-1;
...
$query="update $table set document_location='$target'
where id='$source_id' ";
...
<tr>
<th>
<i>Thanks for Updating Concessions Info !
</i>
</th>
</tr>
</table>
...
<table>
<tr>
<td>Return to MoneyCounts Concessions
<a href='vendor_fees_drilldown1.php?vendor_name=$vendor_name&f_year=$f_year&park=$park&ncas_center=$ncas_center'>
<img width='20%' height='80%' src='/budget/infotrack/icon_photos/mission_icon_photos_249.png' alt='home icon' title='Home' />
</a>
</td>
</tr>
...
//{header("location: ../../budget/vendor_fees_drilldown1.php?vendor_name=$vendor_name&f_year=$f_year&park=$park&ncas_center=$ncas_center");}
?>