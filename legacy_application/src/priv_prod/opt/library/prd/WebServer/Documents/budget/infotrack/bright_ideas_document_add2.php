...
//echo $document;//exit;
$document="mission_bright_ideas2_".$source_id;
//echo "<br />";
//echo $document;
$ext=explode(".",$doc_mod);
$num=count($ext)-1;
...
$table="mission_bright_ideas2";


$query="update $table set document_location='$target'
where cid2='$source_id' ";
...
<tr>
<td>
<a href='bright_idea_steps2_v2.php?cid=$cid'>
<img width='20%' height='20%' src='light_bulb1.png' alt='roaring gap photos' title='Home' />
</a>
</td>
</tr>
