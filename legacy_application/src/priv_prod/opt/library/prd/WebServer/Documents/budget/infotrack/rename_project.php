...
echo "<H1 ALIGN=left > <font color=red><i>Rename Notebook </i></font></H1>";
...
echo "</form>";
*/
echo "<form method='post' action='rename_project2.php'>";
...
echo "<table border=1>";
	   ...
	   echo "<tr><th><font color='blue'>Notebook</font></th><th><font color='blue'>Category</font></th><th><font color='blue'>Topic</font></th></tr>";
	   echo "<tr><td>Current</td><td><font color='blue'><input name='project_category' type='text' readonly='readonly' id='project_category' value='$project_category'></font></td><td><input name='project_name' type='text' readonly='readonly' id='project_name' value='$project_name'></td></tr>";
       echo "<tr><td>New</td><td><font color='blue'><input name='project_category_new' type='text' id='project_category_new'></font></td><td><input name='project_name_new' type='text' id='project_name_new'></td><td><input type='submit' value='UPDATE'></td></tr>";
