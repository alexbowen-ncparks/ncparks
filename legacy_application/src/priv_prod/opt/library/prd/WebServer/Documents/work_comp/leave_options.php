...
if(!empty($_FILES))
	...
	if(@$_POST['reupload']=="reupload")
		...
		echo "<font size='+1'>Go to Step 7 <a href='release_info.php?wc_id=$wc_id'>Form</a></font>";
		}
	exit;
	}
...
if(empty($show_wc_leave_options_upload) and empty($_POST['submit']))
	...
	<form method='POST' action='leave_options.php' enctype='multipart/form-data'>
...
echo "<page2>";
echo "<form action='leave_options.php' method='POST'><table cellpadding='3'><tr>";
foreach($ARRAY AS $index=>$fld)
	{
