...
and mission_scores.fyear='$f_year'
...
echo "<table border=1>";
echo "<tr>";
echo "<td bgcolor='darkseagreen'><img height='50' width='50' src='/budget/infotrack/icon_photos/honeybee1.png' alt='picture of green paint'></img></td>";
...
<script language="javascript">drawPercentBar(<?php echo $width ?>, <?php echo round($percomp,0) ?>, 'gold','lightgreen'); </script> 
<?php
echo "<img height='50' width='50' src='/budget/infotrack/icon_photos/honeypot1.jpg' alt='picture of green paint'></img>";
echo "</td>";	          
echo "</tr>";
