...
echo  "<td>$ncas_invoice_number<br />$datesql2 ($invoice_month$date_sql_year)<br />$system_entry_date<br />$account_number<br /><a href='/budget/energy/energy_reporting.php' onclick=\"return popitup('/budget/energy/energy_reporting.php?f_year=$f_year&center_code=$center_code&egroup=$egroup&report=accounts')\">view</a></td>";
