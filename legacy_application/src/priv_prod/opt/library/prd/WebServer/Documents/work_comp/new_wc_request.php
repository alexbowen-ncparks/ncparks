...
$rename6=array("date_hired"=>"Date hired","began_work_date"=>"Time employee began work on <br />date of incident","name_of_facility"=>"Name of facility","facility_address"=>"Facility address and telephone","er_visit"=>"ER visit?","overnight_stay"=>"Overnight stay?","employee_sig"=>"Employee's Signature","employee_sig_date"=>"Date Employee Signed Form 19/Injury Data");
...
if(!empty($_FILES))
	...
	echo "<p><font size='+1'>You have successfully uploaded the <b>Form 19/Injury Data</b>.</font></p>";
...
echo "<instructions><a onclick=\"toggleDisplay('instruction');\" href=\"javascript:void('')\">
    ...
    You are in Step 1: Form 19/Injury Data - <font color='red'>Click for Instructions</font></a>
...
// 	<img src='Form19_p2.jpg' width='700'>
	echo "
	<img src='forms_marked_up/step_1_new.jpg' width='700'>
	</form19>";
	}
	else
	{
