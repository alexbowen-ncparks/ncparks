...
$query1="insert into exp_rev_dncr_temp
         select * from exp_rev_dncr_temp1 ";
...
$query2="insert into exp_rev_dncr_temp
         select * from exp_rev_dncr_temp2 ";
...
$query3="insert into exp_rev_dncr_temp
         select * from exp_rev_dncr_temp3 ";
...
$query4="insert into exp_rev_dncr_temp
         select * from exp_rev_dncr_temp4 ";
