...
echo "<form enctype='multipart/form-data' method='post' autocomplete='off' action='preapproval_tracking_add_record.php'>";
echo "<table border=1>";
...
if($level>'3'){echo "<table border='3'><tr><td><a href='preapproval_tracking.php?add_your_own=y&sortA=y&alt_view=$alt_view&f_year=$f_year'>Sort by Park</td><td><a href='preapproval_tracking.php?add_your_own=y&alt_view=$switch&f_year=$f_year'>Alternate View</td> </tr></table>";}
...
if($level>3)
{
echo"<td><a href='delete_preapproval_tracking_verify.php?&id=$id'>delete</a></td>";
	  
echo "<td><a href='preapproval_tracking.php?&edit_record=y&park=$park&deposit_id=$deposit_id&deposit_amount=$deposit_amount&bank_deposit_date=$bank_deposit_date&collection_start_date=$collection_start_date&collection_end_date=$collection_end_date&bo_receipt_date=$bo_receipt_date&id=$id'>edit</a></td>";
}
/*	   
...
echo "<form enctype='multipart/form-data' method='post' autocomplete='off' action='edit_record_preapproval_tracking.php'>";
echo "<table border=1>";
       //echo "<form name='form1' method='post' action='duplicate_notes_insert.php'>";
	  echo "<tr>";
echo "<th><font color='brown'>Park</font></th>";
...
echo "<form  method='post'  autocomplete='off' action='verify_record_preapproval_tracking.php'>";
echo "<table border=1>";
       //echo "<form name='form1' method='post' action='duplicate_notes_insert.php'>";
	   echo "<tr>
