...
$query2="SELECT xtnd_day from pcard_report_days where id='2' ";
...
echo "<H1 ALIGN=LEFT > <font color=brown><i>StepName $step_name</font></i></H1>";
echo "<H2 ALIGN=center><font size=4><b><A href=/budget/admin/pcard_updates/main.php?project_category=fms&project_name=pcard_updates> Return Pcard Updates-HOME </A></font></H2>";
...
"<tr$t>	
	   ...
	   <td>$substep_name</td>
	   <td>
	   <form method='post' action='step$step_group_$step_num_$substep_num.php'>
	   ...
	   <input type='hidden' name='substep_name' value='$subset_name'>	   
	   <input type='hidden' name='substep_num' value='$subset_num'>	   
