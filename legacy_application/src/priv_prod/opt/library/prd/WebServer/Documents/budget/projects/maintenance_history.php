...
if(!empty($ARRAY))
	{
	$c=count($ARRAY);
	echo "<br /><br /><table><tr><td colspan='3'>$c invoices for SPO#  <font color='red'>$spo_number</font></td></tr>";
	foreach($ARRAY AS $index=>$array)
		...
		foreach($array as $fld=>$value)
			...
			if($fld=="partf_proj_number")
				{$value="<a href='/budget/partf.php?projNum=$value&Submit=Find' target='_blank'>$value</a>";}
			echo "<td>$value</td>";
			}
		echo "</tr>";
		}
	$tot_amt=number_format($tot_amt,2);
	echo "<tr><td colspan='3' align='right'><br />Total $tot_amt</td></tr></table>";
	}
echo "</html>";
