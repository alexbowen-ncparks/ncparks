...
echo "<H1 ALIGN=LEFT > <font color=brown><i>$project_name-Add StepGroup</i> </font></H1>";
//echo "<H1 ALIGN=LEFT > <font color='red'><i>Add Record</i></font></H1>";
echo "<H3 ALIGN=CENTER > <A href=main.php?project_category=$project_category&project_name=$project_name> Return HOME </A></H3>";
