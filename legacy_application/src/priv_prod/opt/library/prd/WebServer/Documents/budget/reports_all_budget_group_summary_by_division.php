...
$cy=$f_year;echo "cy=$cy";echo "<br />";
$py1a=substr($cy,0,2);echo "py1a=$py1a";echo "<br />";
...
if($history=='10yr'){include("ten_yr_history.php");}
if($history=='5yr'){include("five_yr_history.php");}
if($history=='3yr'){include("three_yr_history.php");}
if($history=='1yr'){include("one_yr_history.php");}
//exit;
