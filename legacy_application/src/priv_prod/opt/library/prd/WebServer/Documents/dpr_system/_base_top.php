...
// 	echo "l=$level Access has not been granted for $database."; exit;
	echo "Access has not been granted to this database application. d=$database"; exit;
	}
...
<?php
$wide_array=array("jeopardy","fixed_assets","facilities","dpr_system");
$calendar_array=array("summit","training");
$jquery_array=array("training","hr","ware","rema","dpr_proj","work_comp","lo_fo","climb","dpr_it","fire","annual_pass","public_contact");
$ajax_array=array("ware");
// $skip_menu=array("pac","dpr_system","fixed_assets");
$skip_menu=array("pac","fixed_assets");
...
<?php
    echo "<a href='https://ncparks.gov' target='_blank'><img src=\"/inc/css/images/dpr_1.jpg\"></a>";
?>
    </td>
  </tr>
...
if($database=="facilities")
	...
	{
	if($database=="dpr_system")
		{
		include("time_track_menu.php");
		}
		else
		{
