...
$query_tagN="
SELECT DISTINCT product_name AS  'account_description2'
FROM crs_products_park_exp
WHERE 1 
...
while ($row_tagN=mysqli_fetch_array($result_tagN))
	{
	$product2Array[]=$row_tagN['account_description2'];
	}
...
//echo "<pre>"; print_r($product2Array); echo "</pre>";//exit;	
