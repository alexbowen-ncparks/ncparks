...
"<tr> 
	   ...
	   <th align=center><font color=brown>Date<br />Entered</font></th>	   
...
*/
	   ...
	   echo "<tr bgcolor='$table_bg2'>
             ...
             <td><input name='fee_amount' type='text' size='10' id='fee_amount' value='$fee_amount' readonly='readonly'></td> 
             <td><input name='check_num' type='text' size='10' id='check_num' value='$vendor_ck_num' readonly='readonly'></td> 
             <td><input name='internal_deposit_num' type='text' size='10' id='$internal_deposit_num' value='$internal_deposit_num' readonly='readonly'></td> 
             <td><input name='ncas_center' type='text' size='10' id='ncas_center' value='$ncas_center' readonly='readonly'></td> 			 
             <td><input name='ncas_account' type='text' size='10' id='ncas_account' value='$ncas_account' readonly='readonly'></td>";
/*			 
if($level=='5')	
