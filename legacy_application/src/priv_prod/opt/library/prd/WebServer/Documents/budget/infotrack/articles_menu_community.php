...
$table="project_articles_community";
//echo "<pre>";print_r($_REQUEST);"</pre>";//exit;
...
echo "<form method=post action=articles_community_search.php>";
...
echo "<tr ><th align=left><A href='articles_menu.php'>Personal</A></th></tr>";
echo "<tr bgcolor='yellow'><th align=left><A href='articles_menu_community.php'>Community</A></th>
...
echo "<form method=post action=articles_menu_community.php>";
...
"<tr$t> 
           ...
           <td><a href='articles_community_edit.php?&project_category=$project_category&category_selected=y'>$project_category</a></td> 
