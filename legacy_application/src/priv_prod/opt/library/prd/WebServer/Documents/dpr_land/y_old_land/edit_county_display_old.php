...
$sql="SELECT t1.qc_spo, t3.park_abbreviation as park_code, t2.CountyName, t1.`land_assets_id` , t1.`acreage`, t1.`consideration`, t2.deedacres, t1.spo_closed_number, t2.spo_number, t2.spo_landAsset_id_number, group_concat(t4.notes separator '*') as notes_2 
...
group by t1.land_assets_id order by park_code";
// echo "<pre>"; print_r($_POST); echo "</pre>"; // exit;
//     ECHO "$sql<br /><br />";  //exit;
$result = @mysqli_query($connection,$sql) or die("$sql Error 1#". mysqli_errno($connection) . ": " . mysqli_error($connection));
while($row=mysqli_fetch_assoc($result))
