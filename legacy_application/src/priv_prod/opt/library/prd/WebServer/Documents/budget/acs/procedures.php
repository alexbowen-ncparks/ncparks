...
if($cash_plan=='y')
{
$query_chp_docs="select document_location as 'doc_location1' from cash_handling_plan_docs where chp_id='$pid' and doc_id='1' ";
...
$query_chp_docs2="select document_location as 'doc_location2' from cash_handling_plan_docs where chp_id='$pid' and doc_id='2' ";
...
echo "<td align='center'><font color='brown'>Park Sales Locations<br />(ALL)</font><br /><a href='$doc_location2' target='_blank'>Download</a><br /><a href='cardholder_document_add.php?source_id=$id' target='_blank'>Upload</a></td><td align='center'><font color='brown'>Daily Sales Reports<br />(Non-CRS Locations)</font><br /><a href='$doc_location1' target='_blank'>Download</a></td>";
}
echo "</tr>";
echo "</table>";
