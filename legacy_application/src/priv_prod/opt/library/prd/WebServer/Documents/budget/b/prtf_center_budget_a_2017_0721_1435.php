...
echo "</tr><tr>
<td>$center_desc</td><td align='center'>$funds_allocated</td><td align='center'>$payments</td><td align='center'>$balance</td><td align='center'>$total_proj_balF</td><td align='center'>$available_funds</td>";
if($beacnum=$_SESSION['budget']['beacon_num']=='60032781')
{
