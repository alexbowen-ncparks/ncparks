...
$query1="insert into fixed_assets_unreconciled(lvl1,lvl2,temp_an,perm_an,asset_descript,
budget_code,buy_entity,center,pay_entity,po_number,invoice,check_num,account,
std_descript,control_date,vendor_num,control_group,acq_date,cost,vendor_name,report_date,center_name,center_mgr)
select lvl1,lvl2,temp_an,perm_an,asset_descript,
budget_code,buy_entity,center,pay_entity,po_number,invoice,check_num,account,
std_descript,control_date,vendor_num,control_group,acq_date,cost,vendor_name,report_date,center_name,center_mgr
from fixed_assets4
where valid_dpr='y' ; ";
...
/*
$query2="update fixed_assets_unreconciled
set report_date='$start_date'
where report_date='0000-00-00' ; ";
