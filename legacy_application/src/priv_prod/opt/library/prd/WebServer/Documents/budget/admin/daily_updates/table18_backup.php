...
$db="$today_date";
$ta18="cash_imprest_count_detail";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta18.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta18$ct`
SELECT *
FROM `budget`.`$ta18` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta18$ct` 
(
...
$query2a="select count(*) as 'record_count18' from `budget_daily_backup`.`$db$ta18$ct` ";
