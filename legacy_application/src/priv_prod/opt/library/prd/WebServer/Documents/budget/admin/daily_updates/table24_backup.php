...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta24.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta24$ct`
SELECT *
FROM `budget`.`$ta24` ;";
...
$query2a="select count(*) as 'record_count24' from `budget_daily_backup`.`$db$ta24$ct` ";
