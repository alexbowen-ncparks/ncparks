<?php
 ...
 echo "Hasn't been tested yet.<pre>"; print_r($_POST); echo "</pre>";  //exit;
$skip=array("submit_form","select_table","allow_admin");
FOREACH($_POST as $fld=>$value)
	{
	if(in_array($fld,$skip)){continue;}
	if($fld=="date_added"){$value=date("Y-m-d");}
	$temp[]=$fld."='".$value."'";
	}
$clause=implode(",",$temp);
$sql="INSERT INTO $select_table SET $clause"; echo "$sql"; exit;
