...
if(empty($submit))
	...
	<body>";
$file_array=array("bd725_dpr_temp.txt", "beacon_payments_temp.txt", "cab_dpr_center_temp.txt", "cab_dpr_temp.txt", "exp_rev_down_temp.txt", "pcard_utility_xtnd_1646_ws_temp.txt", "warehouse_billings_2_temp.txt", "xtnd_po_encumbrances_temp.txt","xtnd_vendor_payments_temp.txt");
