...
echo "<tr>";
echo "<td>";
echo "<a href='$filename3' target='_blank'>$filename3</a>";
echo "</td>";
echo "</tr>";
echo "</table>";
echo "<br />";
...
echo "<table>";
echo "<tr><td><font color=brown class=cartRow>Program_File:$filename3</font></td></tr>";
...
echo "<th align=left><font color=brown>User</font></th>"; 
echo "<th align=left><font color=brown>Level</font></th>"; 
