...
(  `park` varchar( 4  )  NOT  NULL ,
 ...
 `cy_amount` decimal( 12, 2  )  NOT  NULL ,
 `py1_amount` decimal( 12, 2  )  NOT  NULL ,
 `py2_amount` decimal( 12, 2  )  NOT  NULL ,
 `py3_amount` decimal( 12, 2  )  NOT  NULL ,
 `py4_amount` decimal( 12, 2  )  NOT  NULL ,
 `py5_amount` decimal( 12, 2  )  NOT  NULL ,
 `py6_amount` decimal( 12, 2  )  NOT  NULL ,
 `py7_amount` decimal( 12, 2  )  NOT  NULL ,
 `py8_amount` decimal( 12, 2  )  NOT  NULL ,
 `py9_amount` decimal( 12, 2  )  NOT  NULL ,
 `py10_amount` decimal( 12, 2  )  NOT  NULL ,
 `py11_amount` decimal( 12, 2  )  NOT  NULL ,
 `py12_amount` decimal( 12, 2  )  NOT  NULL ,
