...
echo "<html><body>";
echo "<h2>TABLE: pcard_holders_dncr2</h2>";

include("style1.html");
echo "<table><tr><td><a href='pcard_holders_dncr16.php?add=y'>ADD Record</a></td></tr></table>"; 
//$skip_array=array("");
//$decimalFields=array("");
$LinkFields=array("id");
...
//if($district==''){exit;}
echo "<form method='post' action='pcard_holders_dncr16.php'>";
...
$query="SELECT * from pcard_holders_dncr2
        where 1 and id='$id'
         ";
