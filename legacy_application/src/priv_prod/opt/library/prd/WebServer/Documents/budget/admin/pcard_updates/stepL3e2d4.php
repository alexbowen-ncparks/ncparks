...
$query1="insert into pcard_unreconciled(location,admin_num,post_date,trans_date,amount,vendor_name,trans_id,pcard_num,cardholder_xtnd,xtnd_rundate,transdate_new,cardholder,transid_new,postdate_new,xtnd_rundate_new,center,company,last_name,first_name,report_date)
...
where xtnd_report_date='$end_date' and dpr='y' ; ";
...
$query1a="update pcard_unreconciled,pcard_users
...
and pcard_unreconciled.report_date='$end_date' "; 

$result1a = mysqli_query($connection, $query1a) or die ("Couldn't execute query 1a.  $query1a");

$query1b="update pcard_unreconciled
          set admin_num='eadi'
...
$query1c="update pcard_unreconciled
          set admin_num='sodi'
...
$query1d="update pcard_unreconciled
          set admin_num='wedi'
...
$query2="update pcard_report_dates
         set active='y',active_date='$today_date' where report_date='$end_date' "; 

$result2 = mysqli_query($connection, $query2) or die ("Couldn't execute query 2.  $query2");


$query3="insert into pcard_report_dates_compliance(report_date,admin_num,record_count)
