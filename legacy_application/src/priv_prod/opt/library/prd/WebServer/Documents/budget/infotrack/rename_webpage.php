...
echo "<html>";
echo "<head>";
echo "<title> WebPage Rename </title>";
echo "</head>";
...
echo "</form>";
*/
echo "<form method='post' action='rename_webpage2.php'>";
...
echo "<table border=1>";
	   ...
	   echo "<tr><th><font color='blue'>WebPage</font></th><th><font color='blue'>Category</font></th><th><font color='blue'>Title</font></th><th><font color='blue'>Description</font></th><th><font color='blue'>WebAddress</font></th></tr>";
