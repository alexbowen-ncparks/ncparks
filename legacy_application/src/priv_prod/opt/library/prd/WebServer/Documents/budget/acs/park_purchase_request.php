...
unset($menuArray);}// end Pull-downs
			...
			if($level<2)
				{
				$textlink="<br /><a href='vehicle_info.php?park=$park4vehicles' target='_blank'>View Vehicles</a><br />$purchase_description_Edit";}
...
$footer="<tr><td colspan='7'> Email Tony Bass with any problems you encounter. Email comments to <a href='mailto:database.support@ncparks.gov?subject=Comments to Administrator-Equipment Budget Tool'>Administrator</a></td></tr>";
