...
echo "<H1 ALIGN=center > <font color=brown><i>$project_name-Add Step</i> </font></H1>";
...
echo "<form name='form1' method='post' action='add_step_update.php'>";
...
echo "<table border='1' align='center'>";
	   ...
	   echo "<tr><td><font color='blue'>step_group(A-Z)</font></td><td><input type='text' readonly='readonly' name='step_group' value='$step_group'></td></tr>";
	   echo "<tr><td><font color='blue'>step_group_name</td></font><td><input type='text' readonly='readonly' name='step' size='30' value='$step'></td></tr>";
	echo "<tr><td><font color='red'>step_num(1A-9Z)</td></font><td><input type='text' name='step_num' value='$step_num'></td></tr>";
...
echo "<tr><td></td><td><input type='submit' name='submit' value='Add_Step'></td></tr>";
