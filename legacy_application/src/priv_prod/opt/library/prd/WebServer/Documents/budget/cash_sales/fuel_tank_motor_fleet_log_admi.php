...
WHERE park = '$concession_location' and trans_table='y'
 ";
...
$query14="SELECT transdate_new as 'transaction_date',payment_type,product_name,amount,account_name,ncas_account,center,sed,sales_location,comment,id
from crs_tdrr_division_history_parks_manual
where concession_location='$concession_location'
and deposit_transaction='n' 
and transdate_new='$today_date'
