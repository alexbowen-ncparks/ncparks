...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta14.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta14$ct`
SELECT *
FROM `budget`.`$ta14` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta14$ct` 
(
...
$query2a="select count(*) as 'record_count14' from `budget_daily_backup`.`$db$ta14$ct` ";
