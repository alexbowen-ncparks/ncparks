...
// 		echo "$db_form_name $upload_form_name"; exit;
		...
		$uploaddir = "hr_perm_new_employee_forms"; // make sure www has r/w permissions on this folder
		...
		move_uploaded_file($temp_name, $form_link);// create file on server
			...
			$sql="REPLACE INTO employee_forms 
...
$_POST['v']="new_applicant";
$_POST['var_menu_item']="new_applicant";
