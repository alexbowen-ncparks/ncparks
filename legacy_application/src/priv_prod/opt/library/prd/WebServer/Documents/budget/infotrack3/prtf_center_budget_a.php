...
echo "</tr>";
// Jerry Howerton //tony bass
if($beacnum=$_SESSION['budget']['beacon_num']=='60032793' or $beacnum=$_SESSION['budget']['tempID']=='Howerton3639')
{
$query1a="SELECT * FROM `partf_projects` WHERE `reportDisplay` LIKE 'y' AND `new_center` = '4a27' ";
echo "<br />query1a=$query1a<br />";

$result1a = mysqli_query($connection, $query1a) or die ("Couldn't execute query 1a.  $query1a");

$rowcount1a=mysqli_num_rows($result1a);
