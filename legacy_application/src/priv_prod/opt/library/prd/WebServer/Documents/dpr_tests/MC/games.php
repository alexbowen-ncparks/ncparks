...
$_SESSION["testing"]["tempID"]="Howeard6319";

$level=5;
$posTitle="Park Ranger";
$tempID="Howard6319";
$beacnum="12345678";
$concession_location="CABE";
$concession_center=="1234";
$player=$_SESSION['testing']['tempID'];

if(!$_SESSION["testing"]["tempID"])
	{
	echo "access denied";exit;
	}
$active_file=$_SERVER['SCRIPT_NAME'];

$level=$_SESSION['testing']['level'];
$posTitle=$_SESSION['testing']['position'];
$tempID=$_SESSION['testing']['tempID'];
$beacnum=$_SESSION['testing']['beacon_num'];
$concession_location=$_SESSION['testing']['select'];
$concession_center=$_SESSION['testing']['centerSess'];
$player=$_SESSION['testing']['tempID'];
...
/*
if($level>'2')
{echo "<a href='/testing/home.php'>";}
else
{echo "<a href='/testing/menu.php?forum=blank'>";}
echo "<img width='50%' height='15%' src='/testing/nrid_logo.jpg' alt='roaring gap photos'></img>
		</a>";

echo "<br />";
*/
//echo "filegroup=$filegroup";exit;
//include("/testing/menus1314_test.php");
//include("../../../testing/menu1314.php");
include ("../../../testing/menu1415_v1.php");
...
echo "<br />";
echo "<table align='center'><tr><th><img height='35' width='35' src='/testing/infotrack/icon_photos/checkers_board1.png' alt='games icon'><font color='blue'>$center_location</font></img><br /><font color='brown' size='5'><b>Training Games</b></font></th></tr></table>";
echo "<br />";
if($game_overview=='y')
{
...
$(document).ready(function(){
	$(\"button\").click(function()	{
		$('#note_tracker').load('/testing/infotrack/note_tracker.php?folder=community&project_note_id=692');	
...
//{include("/testing/infotrack/note_tracker.php?folder=community&project_note_id=692'");}
//load('/testing/infotrack/note_tracker.php?folder=community&project_note_id=692');	
//echo "<div id=\"note_tracker\">
//<button>NoteTracker</button>
//</div>";
//if($notes=='y'){include("note_tracker.php");}
//if($notes=='y'){include("../../../testing/infotrack/note_tracker.php");}
