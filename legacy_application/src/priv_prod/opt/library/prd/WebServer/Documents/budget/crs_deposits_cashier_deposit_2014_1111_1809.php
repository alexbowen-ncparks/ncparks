...
//include("widget1.php");
//cara hadfield or sherry quinn or adrian oneal or julie bunn  or sean mcelhone
if($beacnum=='60033148' or $beacnum=='60032892' or $beacnum=='60032912' or $beacnum=='60032931' or $beacnum=='60033093' or $beacnum=='60032913')
{
...
$result_ck = mysql_query($query_ck) or die ("Couldn't execute query ck.  $query_ck");
...
$result12b = mysql_query($query12b) or die ("Couldn't execute query 12b.  $query12b");
...
$result1e = mysql_query($query1e) or die ("Couldn't execute query 1e.  $query1e");
...
while ($row12=mysql_fetch_array($result12))
	...
	if($amount != '0.00')
		...
		{
		echo "<td><font color='red'>Over/Short exceeds $10. Please Review Cashier Comment below. Thanks</font></td>";
		}
		/*
...
$result_rcf = mysql_query($query_rcf) or die ("Couldn't execute query query_rcf.  $query_rcf");
		  
$row_rcf=mysql_fetch_array($result_rcf);
...
$result12_a = mysql_query($query12_a) or die ("Couldn't execute query 12_a.  $query12_a");

$row12_a=mysql_fetch_array($result12_a);
extract($row12_a);
...
$result1f = mysql_query($query1f) or die ("Couldn't execute query 1f.  $query1f");
...
$result12_b = mysql_query($query12_b) or die ("Couldn't execute query 12_b.  $query12_b");

$row12_b=mysql_fetch_array($result12_b);
extract($row12_b);
//if($over_short_amount==''){$over_short_amount='0';}
//echo "over_short_amount=$over_short_amount<br />";
...
echo "<tr>";
echo "<td width='300'>";
echo "<font color='red'>Cashier Comment</font><font color='green'>&nbsp;&nbsp;($cashier)</font><br /><br />$cashier_overshort_comment";
echo "</td>";
echo "<td width='300'>";
echo "<font color='red'>Accountant Comment</font><font color='green'>&nbsp;&nbsp;($accountant_comment_name)</font><br /><br />$accountant_comment";
echo "</td>";
echo "</tr>";
echo "</table>";
echo "<br />";
