...
$query4a= "insert into xtnd_cardholder_count(admin_num,location,xtnd_cardholder,pcard_num)
select distinct admin_num,location,xtnd_cardholder,pcard_num
from pcard_unreconciled_xtnd
where 1
and complete_record='y'
order by admin_num,location,xtnd_cardholder,pcard_num; ";
...
$query5a= "insert into xtnd_cardholder_count2(admin_num,location,xtnd_cardholder,cards)
select admin_num,location,xtnd_cardholder,count(id)
from xtnd_cardholder_count
where 1
group by admin_num,location,xtnd_cardholder
order by admin_num,location,xtnd_cardholder; ";

$result5a = mysqli_query($connection, $query5a) or die ("Couldn't execute query 5a.  $query5a");



$query6= "select admin_num,location,xtnd_cardholder,cards
...
echo  "<td>$cards</td>";
echo "<form method='post' action='stepL3e6a.php'>"; 
echo "<td><input type='submit' name='submit' value='complete'></td>";
