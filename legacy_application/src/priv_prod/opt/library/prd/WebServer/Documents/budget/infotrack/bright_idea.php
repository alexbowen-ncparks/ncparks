...
where mission_games.gid='4'
and playstation='$playstation' 
...
echo "<table border=1>";
echo "<tr>";
echo "<td bgcolor='darkseagreen'><img height='50' width='50' src='/budget/infotrack/icon_photos/green_paint_bucket1.png' alt='picture of green paint bucket'></img></td>";
...
<script language="javascript">drawPercentBar(<?php echo $width ?>, <?php echo $percomp ?>, 'lightgreen','#dfe687'); </script> 
<?php
echo "</td>";	          
echo "</tr>";
