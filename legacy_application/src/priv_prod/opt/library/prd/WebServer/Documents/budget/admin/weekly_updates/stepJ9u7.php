...
$query0="update partf_projects set funding_source='',funding_source_tab='' where 1 ";
...
/*
$query1="update partf_projects as t1,bd725_dpr_funding_sources2 as t2
         set t1.funding_source='other',t1.funding_source_tab='exp_rev' where (t2.funding_source='other' or t2.funding_source='multiple')
...
$query2="update partf_projects as t1,bd725_dpr_funding_sources2 as t2
         set t1.funding_source=t2.funding_source,t1.funding_source_tab='exp_rev'
