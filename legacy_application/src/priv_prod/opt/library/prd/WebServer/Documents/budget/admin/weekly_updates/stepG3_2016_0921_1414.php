...
mysql_query($query19m1) or die ("Couldn't execute query 19m1.  $query19m1");

$query19m2="DROP TABLE pcew_credits; ";
			 
mysql_query($query19m2) or die ("Couldn't execute query 19m2.  $query19m2");

$query19m3="DROP TABLE pcew_debits; ";
			 
mysql_query($query19m3) or die ("Couldn't execute query 19m3.  $query19m3");

$query19m4="DROP TABLE pcew_debits_count; ";
			 
mysql_query($query19m4) or die ("Couldn't execute query 19m4.  $query19m4");


$query19m5="DROP TABLE pcew_credits_count; ";
			 
mysql_query($query19m5) or die ("Couldn't execute query 19m5.  $query19m5");
