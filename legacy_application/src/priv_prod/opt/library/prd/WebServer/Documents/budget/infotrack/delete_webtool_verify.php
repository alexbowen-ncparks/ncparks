...
$query="SELECT * FROM $table where 1 and category='$category' and topic='$topic'  and username='$myusername'  ";
...
echo "<font color='red' size='3'><b>CAUTION! Are you sure you want to PERMANENTLY Delete WebTool named: $category $topic </b></font>";
echo "<br /><br />";
...
echo "<form method=post action=webtool_delete.php>";
