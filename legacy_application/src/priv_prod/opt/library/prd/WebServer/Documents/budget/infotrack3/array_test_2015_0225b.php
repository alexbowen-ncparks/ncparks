...
/*
echo "input[type='text'] {width: 100px;
                          border-style: solid;
						  border-width: 1px;
						  } ";
...
echo "<tr><td colspan='8' align='center'><font color='red'>$num records<br />manager=dwayne_parker,pete_mitchell,etc <br />fullname=STONE MOUNTAIN,LAKE NORMAN etc.<br />dist=EAST,NORTH,etc.<br />county=moore,nash,etc.<br />section=construction,operations,natural_resources<br />park=CABE,CACR,etc.<br />proj_man=JH(jerry),EL(erin),etc. </font></td></tr>";
echo "<tr>";
