...
//echo "ncas_invoice_number=$ncas_invoice_number[1]";exit;
$query0="SELECT (max(sheet)+1) as 'sheet'
from contract_payments where 1
";
...
//echo "sheet=$sheet";exit;




$query1="insert into contract_payments SET";
for($j=1;$j<6;$j++)
	{	
	if($ncas_invoice_number[$j] ==""){continue;}
	$query2=$query1;
		$query2.=" contract='y',";
		$query2.=" con_reportperiod='$con_reportperiod',";
		$query2.=" con_fy='$con_fy',";
		$query2.=" con_location='$con_location',";
		$query2.=" con_num='$con_num',";
		$query2.=" vendor_name='$vendor_name',";
		$query2.=" con_purpose='$con_purpose',";
		$query2.=" ncas_po_number='$ncas_po_number',";
		$query2.=" po_line1='$po_line1',";
		$query2.=" con_original='$con_original',";
		$query2.=" con_payments='$con_payments',";
		$query2.=" ncas_invoice_number='$ncas_invoice_number[$j]',";
		$query2.=" ncas_invoice_date='$ncas_invoice_date[$j]',";
		$query2.=" ncas_company='$ncas_company[$j]',";
		$query2.=" ncas_account='$ncas_account[$j]',";
		$query2.=" code_1099='$code_1099[$j]',";
		$query2.=" ncas_center='$ncas_center[$j]',";
		$query2.=" ncas_invoice_amount='$ncas_invoice_amount[$j]', ";
		$query2.=" sheet='$sheet' ";
		//echo $query2;exit;
...
//echo "ncas_invoice_number=$ncas_invoice_number";echo "<br />";
//echo "ncas_invoice_date=$ncas_invoice_date";echo "<br />";
//echo "ncas_po_number=$ncas_po_number";echo "<br />";
//echo "po_line1=$po_line1";echo "<br />";exit;


{header("location: view_record.php?sheet=$sheet");}
