...
if($level>3)
	{$change="Change <a href='change_category?id=$edit'>Category</a> from $cat to something else.";}
	else
	{$change="";}
...
$source_array=array("DPR Sign Shop"=>"DPR Sign Shop");
...
$skip_1=array("id","SR","category", "district", "justification","register","response","other_file_1","other_file_2","other_file_3","other_file_4","cr_form","outside_vendor_details","pio_comment","approv_DISU","approv_PIO","approv_CHOP_DIR");
		...
		foreach($row as $fld=>$value)
			{
				...
				if($fld=="purpose")
					...
					$item="<h2><font size='2' color='red'>".$category."</font></h2>";
//***********************					
					include("uploads.php");
