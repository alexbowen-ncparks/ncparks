...
$db="$today_date";
$ta19="cash_imprest_location_counts";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta19.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta19$ct`
SELECT *
FROM `budget`.`$ta19` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta19$ct` 
(
...
$query2a="select count(*) as 'record_count19' from `budget_daily_backup`.`$db$ta19$ct` ";
