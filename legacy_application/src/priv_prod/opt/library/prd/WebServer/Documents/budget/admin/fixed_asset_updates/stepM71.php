...
$query1="truncate table budget.fixed_assets1;
";
mysqli_query($connection, $query1) or die ("Couldn't execute query 1. $query1");

$query2="truncate table budget.fixed_assets2;
";
mysqli_query($connection, $query2) or die ("Couldn't execute query 2. $query2");

$query3="truncate table budget.fixed_assets3;
";
mysqli_query($connection, $query3) or die ("Couldn't execute query 3. $query3");

$query4="truncate table budget.fixed_assets4;
";
...
{header("location: step$step_group$step_num.php?project_category=$project_category&project_name=$project_name&step_group=$step_group&step_num=$step_num&start_date=$start_date&end_date=$end_date ");}
