...
$query0="update bd725_dpr_account_detail3_rec,coa
set bd725_dpr_account_detail3_rec.funding_type=coa.naspd_ci_funding_source
where bd725_dpr_account_detail3_rec.account=coa.ncasnum
and bd725_dpr_account_detail3_rec.account != 'none'
and coa.naspd_ci_funding_source != 'na'
...
$query1="update bd725_dpr_account_detail3_rec
set funding_type='appropriation'
where account_description='appropriation'
