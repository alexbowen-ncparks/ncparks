...
$var="fas_data";
	...
	$sql="SELECT t1.fas_data_id
	from land_assets_fas_junction as t1
	...
	if(mysqli_num_rows($result)>0)
		...
		from $var as t1
		WHERE t1.fas_data_id='$fas_data_id'"; //ECHO "$sql"; //exit;
		...
		{	
		$message= "$sql<br />No FAS data is on record for land_assets_id $land_assets_id.";
		}
