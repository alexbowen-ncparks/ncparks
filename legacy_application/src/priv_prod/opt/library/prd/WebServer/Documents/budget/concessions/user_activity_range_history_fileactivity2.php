...
$query2="select count(id) as 'user_total'
...
//echo "tempid1=$tempid1";
$query2a="select count(id) as 'dpr_total'
from report_user_activity 
where 1 and tempid1 !='' ; ";
...
extract($row2a);
$user_total=number_format($user_total,2);
$dpr_total=number_format($dpr_total,2);
echo "<table border='1'>
      <tr><th>Total Usage since 8/8/2010</th></tr>
	  </table>
	  <table border='1'>
      <tr><th>User</th><th>DPR-All</th></tr>
	  <tr><td>$user_total</td><td>$dpr_total</td></tr>
	  </table>";
echo "<br />";
