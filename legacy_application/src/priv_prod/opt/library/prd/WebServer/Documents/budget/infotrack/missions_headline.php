...
//include("../../budget/~f_year.php");
//echo "missions_headline.php";exit;
$database="budget";
$db="budget";
...
foreach($header_array AS $index=>$header)
	...
	{echo "<br /><a href='missions_1.php?park=$index'>view</a>";}
	*/
	echo "</th>";
	}
	echo "<th>Total</th>";
...
echo "<td>";
?>
	<script language="javascript">drawPercentBar(<?php echo $width ?>, <?php echo round($value,0) ?>, 'lightgreen','red'); </script> 
<?php
...
echo "<td>";		
?>
<script language="javascript">drawPercentBar(<?php echo $width ?>, <?php echo round($gt,0) ?>, 'lightgreen','red'); </script> 
<?php
echo "</td>";		
echo "</tr>";
$j++;
