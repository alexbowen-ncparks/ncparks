...
if($edit_record != ''){echo "Please Save Me on line 320";}
...
if($table_bg2==''){$table_bg2='burlywood';}
	...
	$display_string .= "<form><td><input type='text' name='comment_note' value='$comment_note'><input type='hidden' name='comment' value='y'><input type='hidden' name='project_note_id' value='$project_note_id'><input type='hidden' name='add_comment' value='y'><input type='hidden' name='folder' value='community'><input type='hidden' name='project_category' value='$project_category'><input type='hidden' name='category_selected' value='y'><input type='hidden' name='project_name' value='$project_name'><input type='hidden' name='name_selected' value='y'><input type='hidden' name='note_group' value='$note_group'><input type='hidden' name='im' value='n'><input type='hidden' name='edit' value='y'></td>";
