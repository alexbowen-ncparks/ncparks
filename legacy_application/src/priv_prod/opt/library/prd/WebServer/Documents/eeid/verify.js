...
//   returns true for period 2006-6-1 to 2007-6-30	 
// allows entries for May,June of previous FY
			result = (allDigits(elems[2]) && (day > 0) && (day < 32)) &&
			 		(allDigits(elems[1]) && (month > 4) && (month < 13) && (year == 2006) || allDigits(elems[1]) && (month > 0) && (month < 7) && (year == 2007))
