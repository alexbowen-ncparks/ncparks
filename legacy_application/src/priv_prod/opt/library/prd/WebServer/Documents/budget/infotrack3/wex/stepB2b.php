...
//echo "<td>$tagnum</td>";
//echo "<td>$make</td>";
echo "<td><input type='text' size='4' name='center_code[]' autocomplete='off' ></td>";
...
echo "<table>";
echo "<tr>";
echo "<td>Invoice#</td><td>Invoice Date</td><td>Rebate Amount</td><td>Comments</td>";
echo "</tr>";
echo "<tr>";
echo "<td><input type='text' name='invoice_number' autocomplete='off'></td><td><input type='text' name='invoice_date' id='datepicker' size='15'></td>
      <td><input type='text' name='rebate_amount' autocomplete='off'><td><input type='text' name='comments' autocomplete='off'></td>";
echo "</tr>";
...
$query5="insert ignore into wex_detail_adjust2(vin,center_code)
select vin,center_code
from wex_detail
where manual_adjust='y' ";
