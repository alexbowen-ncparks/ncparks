...
if($folder=='community')
{
$query4="select project_note,weblink,embed_address,note_group,project_note_id from infotrack_projects_community3
         where 1 
...
$query4a="select project_note,weblink,embed_address from infotrack_projects_community3 where project_note_id='$project_note_id' ";
...
if($embed_address=='')
{echo "<br /><br /><font color='brown'> $project_note</font> <br /><iframe width='700' height='700' src='$weblink' frameborder='0' allowfullscreen></iframe>";
}
...
if($im=='n')
{
$query = "select user,project_note,comment_note,weblink,note_group,project_note_id as 'project_note_id2' from infotrack_projects_community3 where 1 and project_category='$project_category' and project_name='$project_name' and note_group='$note_group' and comment_id='$project_note_id' order by project_note_id asc ";	
