...
// 	echo "l=$level Access has not been granted for $database."; exit;
	echo "Access has not been granted this database application."; exit;
	}
...
<?php
$wide_array=array("jeopardy","fixed_assets");
...
$menu_bottom_shadow_width=143;
	...
	if(in_array($database,$jquery_array))
		...
		maxDate: \"+1yy\"";
				break;
			case "public_contact":
				echo "yearRange: \"-2yy:+0yy\",
		maxDate: \"+0yy\"";
				break;
			default:
				echo "yearRange: \"-30yy:+0yy\",
		maxDate: \"+0yy\"";
				break;
			}
		echo " });
...
if($title=="DPR IT Inventory")
	{$bgcolor="beige";}
if($title=="DPR Project Tracking Application")
	{
