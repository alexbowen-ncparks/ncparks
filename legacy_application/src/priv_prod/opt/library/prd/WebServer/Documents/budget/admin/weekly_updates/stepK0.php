...
$query0="update table_menu2 set backup='n'
         where project_category='fms' and project_name='weekly_updates' and project_group='E' ";
...
$query="SELECT table_name,backup,id FROM `table_menu2`
        WHERE  project_category='fms' and project_name='weekly_updates' and project_group='E' and backup='n' 
