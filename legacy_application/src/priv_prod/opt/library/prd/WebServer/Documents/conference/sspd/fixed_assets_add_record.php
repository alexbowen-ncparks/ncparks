...
set menu='$menu',park='$park',fas_num='$fas_num',fas_description='$fas_description',payment_source='$payment_source',source_id='$source_id',entered_by='$tempid',sed='$system_entry_date'  ";
