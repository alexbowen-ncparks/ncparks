...
include("/infotrack/scrolling_headlines.php");
echo "<table><tr><th>
   ...
   <ul>
      <li>District
         <ul>
            ...
            <li><a href='/budget/a/current_year_budget_div.php?budget_group_menu=operating_expenses&submit=Submit' target='_blank'>Budgets by Center</a></li>
