...
$result2 = mysqli_query($connection, $query1) or die ("Couldn't execute query 1.  $query1");

$query3="delete from crs_tdrr where revenue_location_name='revenue location name' ";

$result3 = mysqli_query($connection, $query1) or die ("Couldn't execute query 1.  $query1");

$query4="update crs_tdrr set ncas_account=mid(account_id,11,9) where 1";

$result4 = mysqli_query($connection, $query1) or die ("Couldn't execute query 1.  $query1");
