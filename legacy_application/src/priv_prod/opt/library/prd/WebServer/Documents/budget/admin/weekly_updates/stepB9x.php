...
`account_description` varchar( 50 ) NOT NULL default '',
`account_category` char( 3 ) NOT NULL default '',
`series` char( 3 ) NOT NULL default '',
`account_series` varchar( 30 ) NOT NULL default '',
`valid_cdcs` char( 1 ) NOT NULL default '',
`valid_div` char( 1 ) NOT NULL default '',
`cash_type` varchar( 10 ) NOT NULL default '',
`budget_group` varchar( 30 ) NOT NULL default '',
`id` int( 10 ) unsigned NOT NULL AUTO_INCREMENT ,
PRIMARY KEY ( `id` ) ,
UNIQUE KEY `fund` ( `fund` , `account` )
) ENGINE = MyISAM;
