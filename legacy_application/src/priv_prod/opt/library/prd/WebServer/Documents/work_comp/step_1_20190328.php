...
if((empty($show_form19_upload) and empty($_POST['submit'])) OR !empty($error_message))
	...
	echo "<img src='forms_marked_up/step_1.jpg' width='700'>";
// 	echo "<br /><img src='Form19_p2.jpg' width='700'>";
	echo "</form19>";
	}
	else
	{
//	echo "s=$show_form19_upload <pre>"; print_r($_POST); echo "</pre>"; // exit;
	...
	<form method='POST' action='step_1.php' enctype='multipart/form-data'>
	<input type='hidden' name='wc_id' value='$wc_id'>
...
$skip[]="body_part";
$skip[]="osha";
echo "<form action='step_1.php' method='POST'>
<br />
