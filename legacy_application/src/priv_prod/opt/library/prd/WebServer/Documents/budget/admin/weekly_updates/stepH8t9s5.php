...
$query13="insert into crj_posted3_v2 (center,amount,f_year)
select center,sum(amount) as 'amount',f_year
...
$query14="update crj_posted3_v2,center
set crj_posted3_v2.park=center.parkcode
where crj_posted3_v2.center=center.center; ";
