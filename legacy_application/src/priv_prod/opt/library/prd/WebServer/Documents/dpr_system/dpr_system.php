...
$sql = "SELECT $dbName as level,emplist.tempID,emplist.currPark,accessPark,t2.working_title, concat(t3.Fname,' ',t3.Mname,' ',t3.Lname) as full_name
FROM emplist 
...
if($level < 1)
	{echo "The Site Survey has been closed. Contact Tom Howard if you need access."; exit;}
	
$_SESSION['system_plan']['level'] = $level;
...
header("Location: menu_dpr_system.php");
?>
