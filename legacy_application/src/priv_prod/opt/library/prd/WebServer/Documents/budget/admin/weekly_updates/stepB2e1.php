...
(  `vendor_name` text NOT  NULL ,
 ...
 `cdcs_match` char( 1  )  NOT  NULL default  'n',
 `vendor_address` text NOT  NULL ,
 `group_number` varchar( 6  )  NOT  NULL default  '',
 `pay_entity` varchar( 6  )  NOT  NULL default  '',
 `parkcode` varchar( 8  )  NOT  NULL default  '',
 `remit_code` text NOT  NULL ,
 `account_vendor` text NOT  NULL ,
 `comments` text NOT  NULL ,
 `account_optional` text NOT  NULL ,
 `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `id`  ) ,
 KEY  `vendor_number` (  `vendor_number`  ) ,
 KEY  `parkcode` (  `parkcode`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
