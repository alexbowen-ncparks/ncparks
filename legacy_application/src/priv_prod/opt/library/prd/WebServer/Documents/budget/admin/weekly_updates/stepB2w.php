...
(  `projNum` varchar( 4  )  NOT  NULL default  '',
 ...
 `error_display` char( 1  )  NOT  NULL default  'n',
 `error_display2` char( 1  )  NOT  NULL default  'n',
 `projCat` char( 2  )  NOT  NULL default  '',
 `connect_bond` char( 1  )  NOT  NULL default  'n',
 `proj_verified` char( 1  )  NOT  NULL default  'n',
 `projSCnum` varchar( 10  )  NOT  NULL default  '',
 `projDENRnum` varchar( 11  )  NOT  NULL default  '',
 `denr_center` char( 1  )  NOT  NULL default  'n',
 `new_center_valid` char( 1  )  NOT  NULL default  'n',
 `old_center_valid` char( 1  )  NOT  NULL default  'n',
 `Center` varchar( 10  )  NOT  NULL default  '',
 `denr_center2` char( 1  )  NOT  NULL default  'n',
 `new_center` varchar( 10  )  NOT  NULL ,
 `new_center2` varchar( 15  )  NOT  NULL ,
 `old_center` varchar( 10  )  NOT  NULL ,
 `budgCode` varchar( 5  )  NOT  NULL default  '',
 `new_budgCode` varchar( 5  )  NOT  NULL ,
 `old_budgCode` varchar( 5  )  NOT  NULL ,
 `comp` varchar( 4  )  NOT  NULL default  '',
 `new_comp` varchar( 4  )  NOT  NULL ,
 `old_comp` varchar( 4  )  NOT  NULL ,
 ...
 `new_project_center_year_type` varchar( 60  )  NOT  NULL ,
 `old_project_center_year_type` varchar( 60  )  NOT  NULL ,
 `center_year_type` varchar( 30  )  NOT  NULL default  '',
 `new_center_year_type` varchar( 30  )  NOT  NULL ,
 `old_center_year_type` varchar( 30  )  NOT  NULL ,
 ...
 KEY  `Center` (  `Center`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
