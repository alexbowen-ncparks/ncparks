...
if(empty($submit))
	...
	<body>";
$file_array=array("exp_rev_dncr_temp1.csv","exp_rev_dncr_temp2.csv","exp_rev_dncr_temp3.csv","exp_rev_dncr_temp4.csv","exp_rev_dncr_osc.csv","exp_rev_dncr_osc2.csv");
