...
echo "<table border=1>";
	   ...
	   echo "<tr><td><font color='blue'>Reporting Period <br />(example: August 2010)</font></td><td><input type='text' name='con_reportperiod' autocomplete='off' value='$con_reportperiod' ></td><td><font color='blue'>Purchase Order Number</font></td><td><input type='text' name='ncas_po_number' size='10' autocomplete='off' value='$ncas_po_number' ></td></tr>";
...
echo "<tr><td><font color='blue'>Division/Section/Prog</font></td><td><input type='text' name='con_location' size='70' autocomplete='off' value='Parks & Recreation-$center_desc2' ></td><td><font color='blue'>PO Line-Original Amount</font><td><input type='text' name='con_original' size='10' autocomplete='off' value='$con_original' ></td></tr>";
	   echo "<tr><td><font color='blue'>Division/Section/Prog</font></td><td><textarea name='con_location' rows='2' cols='30'  value='Parks & Recreation-$center_desc2'></textarea></td><td><font color='blue'>PO Line-Original Amount</font><td><input type='text' name='con_original' size='10' autocomplete='off' value='$con_original' ></td></tr>";
	   echo "<tr><td><font color='blue'>Contract Number<br /> (if applicable)</font></td><td><input type='text' name='con_num' size='20' autocomplete='off' value='$con_num' ></td><td><font color='blue'>PO Line-Total Payments <br />(excludes current payment)</font><td><input type='text' name='con_payments' size='10' autocomplete='off' value='$con_payments' ></td></tr>";
	   echo "<tr><td><font color='blue'>Contractor</font></td><td><input type='text' name='vendor_name' size='30' autocomplete='off' value='$vendor_name' ></td></tr>";
	   //echo "<tr><td><font color='blue'>Purpose</font></td><td><input type='text' name='con_purpose' size='120' autocomplete='off' value='$con_purpose' ></td></tr>";
	   echo "<tr><td><font color='blue'>Purpose</font></td><td><textarea name='con_purpose' rows='2' cols='30'  value='$con_purpose'></textarea></td></tr>";
