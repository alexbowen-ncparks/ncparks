...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta15.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta15$ct`
SELECT *
FROM `budget`.`$ta15` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta15$ct` 
(
...
$query2a="select count(*) as 'record_count15' from `budget_daily_backup`.`$db$ta15$ct` ";
