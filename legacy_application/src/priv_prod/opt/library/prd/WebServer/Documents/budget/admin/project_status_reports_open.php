...
$query="SELECT project_category,project_name,project_status,project_id 
FROM $table
WHERE 1 and user_id='$myusername' and project_status='open'
...
echo "<H1 ALIGN=center>  <font color=red><i>Open Projects-$num</i> </font></H1>";
echo "<br />";
//echo "<A href=project_status_reports_closed.php><i>View Closed Projects</i> </A>";
