...
(  `location` varchar( 15  )  NOT  NULL default  '',
 ...
 `pay_center_new` varchar( 15  )  NOT  NULL ,
 `pay_center_old` varchar( 15  )  NOT  NULL ,
 ...
 `section_comments` text NOT  NULL ,
 ...
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `pa_number` (  `pa_number`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
