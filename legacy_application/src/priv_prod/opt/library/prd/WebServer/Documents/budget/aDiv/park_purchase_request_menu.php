...
//if($level>4)
//{
include("park_purchase_request_reset.php");
//}
...
if(
$beacnum=='60033012' //jerry howerton (level 4)    OK
or $beacnum=='60033018' //adrian o'neal (level 4)  OK
or $beacnum=='60032780' //sean higgins (level 4)   OK
or $beacnum=='65020598' //dwayne parker (level 4)  OK
or $beacnum=='65020599' //jody reavis (level 4)    OK
or $beacnum=='60032956' //pete mitchell (level 2)  OK
or $beacnum=='60032977' //patrick noel (level 2)   OK
or $beacnum=='60032957' //johnny johnson (level 2)  OK
or $beacnum=='60032958' //randy ayers (level 2)     OK
or $beacnum=='60032852' //william davis (level 1)   OK
or $beacnum=='60032877' //amy sawyer    (level 3)   OK
or $beacnum=='60092637' //tim rayworth  (level 3)   OK
or $beacnum=='60032875' //sharon bischoff (level 2) OK
or $beacnum=='60032907' //britney hurtado (level 2) OK
or $beacnum=='60033135' //brian bockhahn  (level 2) OK
...
//echo "<table><tr><th>Hello Line 264</th></tr></table>";
/*
...
//if(!@$report_date AND !@$pa_number AND !@$re_number)
/*
{echo "<table><tr><td bgcolor='white'><font color='red'>All Budget Contacts: (Updated 4/11/14) 
<br><br>
...
if($level<3){
	if($report_date)
		{
		echo "<table border='2' align='center'><tr><td><a href='park_purchase_request_view.php?view=approved&report_date=$report_date&submit=Submit$passDist$passSect$passCent$passPurc'>View Approved</a></td>
...
echo "<table align='center'><tr><th><a href='/budget/aDiv/preapproval_yearly.php?menu_new=MAppr' ><font color='red'>Pre-approval for Purchases (New Module-testing)</font></a></th></tr></table>";
*/
