...
$query1="insert into pcard_unreconciled_xtnd
         (xtnd_rundate,location,xtnd_cardholder,admin_num,post_date,trans_date,amount,
		  vendor_name,address,trans_id,pcard_num)
		 select 
		 xtnd_rundate,location,xtnd_cardholder,admin_num,post_date,trans_date,amount,
		 vendor_name,address,trans_id,pcard_num
