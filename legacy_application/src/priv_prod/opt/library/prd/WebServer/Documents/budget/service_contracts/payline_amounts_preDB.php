...
echo "<table align='center'><tr><th>Line#</th><th>Beginning<br />Balance</th><th>Pre-DB<br />Paid</th></tr>";
$begin_balance_total='';
$payments_total='';
...
echo "<td>$po_line_num_beg_bal</td>";
echo "<td><input name='preDB_amount[]' type='text' size='5' value='$ytd_payments'></td>";
