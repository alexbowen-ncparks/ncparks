...
$db="$today_date";
$ta26="crs_tdrr_deposits_daily_summary2";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta26.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta26$ct`
SELECT *
FROM `budget`.`$ta26` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta23$ct` 
(
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta23$ct`
SELECT *
FROM `budget`.`$ta23` ;";
...
$query2a="select count(*) as 'record_count26' from `budget_daily_backup`.`$db$ta26$ct` ";
