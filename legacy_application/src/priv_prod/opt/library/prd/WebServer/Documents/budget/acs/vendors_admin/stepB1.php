...
$query0="update table_menu2 set backup='n'
         where project_category='fms' and project_name='vendors_admin' and project_group='A' ";
...
$query="SELECT table_name,backup,id FROM `table_menu2`
        WHERE  project_category='fms' and project_name='vendors_admin' and project_group='A' and backup='n' 
...
echo "<table align='center'><tr><td>$photo_location2</td><td><font size='10' color='green'><i>$ta1 table</i></font><font color='limegreen' size='7'> backup successful ($record_count Records). Thanks!</font></td></tr></table>";
...
echo "<tr><td colspan='3'><a href='stepB1.php?mark_complete=y&project_category=$project_category&project_name=$project_name&step_group=$step_group&step_num=$step_num'>Mark Complete</a></td></tr>";
echo "</table>";
*/
//echo "<br />Line 142<br />";
exit;
