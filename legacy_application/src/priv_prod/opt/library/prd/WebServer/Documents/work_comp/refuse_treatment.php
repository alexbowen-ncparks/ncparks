...
$rename1=array("form_date"=>"Date Form Completed","employee_name"=>"Employee's Name","agency"=>"Agency","employee_sig"=>"Employee's Signature","supervisor_sig"=>"Supervisor's Signature","employee_sig_date"=>"Employee's Signature Date", "supervisor_sig_date"=>"Supervisor's Signature Date","provider"=>"Provider's Name","address"=>"Provider's Address","phone"=>"Provider's Phone","sought_treatment"=>"Was treatment sought?","physician_name_address"=>"Treating Physician's Name/Address","date_of_injury"=>"Date of Injury","describe_injury"=>"Description of Injury","report_injury"=>"Was Injury Reported?","report_injury_date"=>"Date Injury Was  Reported");
...
if(!empty($_FILES))
	...
	if(@$_POST['reupload']=="reupload")
		...
		{
		echo "<p><font color='red'>Treatment was refused. However, you will still need to complete Step 3 (CCSMI WC Authorization).</font>
