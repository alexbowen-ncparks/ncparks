...
$datesql_1=substr($ncas_invoice_date,6,4).substr($ncas_invoice_date,0,2).substr($ncas_invoice_date,3,2);
//.mid($ncas_invoice_date,1,2).mid($ncas_invoice_date,4,2);
$due_date_calc1=strtotime("$datesql_1");
...
echo "datesql_1=$datesql_1<br />";  //exit;
echo "due_date_calc3=$due_date_calc3<br />";  exit;
