...
$ta="energy_report_electricity_usage";
$ct=date("His");
//echo $ct;exit;
...
(  `f_year` varchar( 4  )  NOT  NULL ,
 ...
 `electricity_account_number` varchar( 50  )  NOT  NULL default  '',
 ...
 `total_usage_kwh` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `total_cost_dollars` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `average_rate` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `park` (  `park` ,  `electricity_account_number` ,  `f_year`  ) ,
 KEY  `centerpark` (  `park`  ) ,
 KEY  `utility_account_number` (  `electricity_account_number`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
