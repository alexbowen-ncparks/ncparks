...
echo "<link rel='stylesheet' type='text/css' href='cdcd2.css' />";
...
echo "<div class='column2of4'>";
echo "<table>";
 echo "<th><font color='red'>Deposit# $controllers_deposit_id</font><br /><font color='red'>Revenue Collection Period $revenue_collection_period</font><br /><font color='red'>Deposit Date $bank_deposit_date</font><br /><font color='blue'>Deposit Slip Amount must equal $bank_deposit_total</font></th>";  
echo "<tr><td>";
 echo "<img height='500' width='600' src='$document_location'></img>";
 echo "</td>";
 echo "</tr>";
 echo "</table>";
 echo "</div>";
