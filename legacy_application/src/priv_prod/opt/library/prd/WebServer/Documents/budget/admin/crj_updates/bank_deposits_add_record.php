...
$query1="insert into bank_deposits
...
$query2="update bank_deposits,center
...
//echo $target;//exit;
$query="update bank_deposits set document_location='$target'
where id='$maxid' ";
...
header("location: bank_deposits.php?add_your_own=y&message=update_successful");
