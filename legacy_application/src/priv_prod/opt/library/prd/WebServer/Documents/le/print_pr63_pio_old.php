...
$times = PDF_load_font ($pdf, $PATH."Times_New_Roman", "winansi","");
$verdanaItalic = PDF_load_font ($pdf, $PATH."Verdana_Italic", "winansi","");
$text="This is the PIO page.";
pdf_setfont ($pdf, $arial, 14);
pdf_show_xy ($pdf, $text,50,$y-18);
...
// `time_pio_incident`, `time_pio_date`, `time_pio_location`, `nature_of_incident`, `text_arrest`, `resistance`, `text_resistance`, `weapon_possession`, `text_weapon_possession`, `weapon_use`, `text_weapon_use`, `pursuit`, `text_pursuit`, `text_items`
$textx=50;
$texty=PDF_get_value($pdf,"texty",0);
$fld="Nature of Incident:";
	pdf_show_xy ($pdf,$fld,$textx,$texty-24);
$text=$nature_of_incident;
$textx=PDF_get_value($pdf,"textx",0);
	pdf_show_xy ($pdf,$text,$textx+3,$texty-24);

$texty=PDF_get_value($pdf,"texty",0);
$textx=50;
$fld="Circumstances surrounding arrest:";
	pdf_show_xy ($pdf,$fld,$textx,$texty-24);
$text=$text_arrest;
$textx=PDF_get_value($pdf,"textx",0);
	pdf_show_xy ($pdf,$text,$textx+3,$texty-24);
...
$textx=PDF_get_value($pdf,"textx",0);
$fld="Resistance Text:";
	pdf_show_xy ($pdf,$fld,$textx+10,$texty-24);
$text=$text_resistance;
$textx=PDF_get_value($pdf,"textx",0);
	pdf_show_xy ($pdf,$text,$textx+3,$texty-24);
...
$texty=PDF_get_value($pdf,"texty",0);
$textx=50;
$fld="Weapon Possession:";
	pdf_show_xy ($pdf,$fld,$textx,$texty-24);
$text=$weapon_possession;
if(empty($text)){$text="No";}
$textx=PDF_get_value($pdf,"textx",0);
	pdf_show_xy ($pdf,$text,$textx+3,$texty-24);
$textx=PDF_get_value($pdf,"textx",0);
$fld="Weapon Possession Text:";
	pdf_show_xy ($pdf,$fld,$textx+10,$texty-24);
$text=$text_weapon_possession;
$textx=PDF_get_value($pdf,"textx",0);
	pdf_show_xy ($pdf,$text,$textx+3,$texty-24);
...
$texty=PDF_get_value($pdf,"texty",0);
$textx=50;
$fld="Description of any items seized in connection with the arrest.:";
	pdf_show_xy ($pdf,$fld,$textx,$texty-24);
$text=$text_items;
