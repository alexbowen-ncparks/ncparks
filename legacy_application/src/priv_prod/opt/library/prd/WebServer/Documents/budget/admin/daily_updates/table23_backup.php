...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta23.$ct."`"." ";
...
$query2a="select count(*) as 'record_count23' from `budget_daily_backup`.`$db$ta23$ct` ";
