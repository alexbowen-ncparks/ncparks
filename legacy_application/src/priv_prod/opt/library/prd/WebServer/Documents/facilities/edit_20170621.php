...
//t1.salary, 
$housing_fields="t4.gis_id, t4.doi_id,  t4.park_abbr, t4.spo_assid, t4.status, t4.fac_name, t1.dist, t1.region, t1.tempID, t1.occupant, t1.position, t1.occupant_num, t1.location,  t1.year, t1.bedrms, t1.bathrms, t1.ac, t1.rent_code, t1.rent_fee, t1.fas_num, t1.rent_comment,t1.comment, t5.comment as spo_comment";	
...
// 	$sql="SELECT $housing_fields, t3.current_salary as salary, t8.annual_salary, t1.gis_id as housing_gis_id, group_concat(t7.link) as agree_link
// 	from spo_dpr as t4
...
// 	left join facilities.housing_attachment as t7 on t1.gis_id=t7.gis_id
...
include("upload_form.php");
	...
	if(!empty($housing_gis_id))
		{
		echo "<td colspan='1' align='center'><form action='/photos/store.php' method='POST'>
