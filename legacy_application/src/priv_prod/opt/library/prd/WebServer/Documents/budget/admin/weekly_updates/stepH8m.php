...
if($num24!=0)
{
echo "<table align='center'><tr><td><font size='5'>TABLE=exp_rev OUT of Balance</font><a href='/budget/b/reconcile.php?fy=$fiscal_year&fromTable=exp_rev&submit=Submit' target='_blank'>VIEW</a></td></tr></table>";
exit;	
