...
$query1="insert into xtnd_vendor_payments_tax(
         company,fund,rcc,account,date,checknum,invoice,amount,vendor_num,group_num,
		 vendor_name,po_number)
		 select
		 company,fund,rcc,account,date,checknum,invoice,amount,vendor_num,group_num,
		 vendor_name,po_number
		 from xtnd_vendor_payments_tax_temp
		 where 1; ";

mysqli_query($connection, $query1) or die ("Couldn't execute query 1.  $query1");

$query1a="update xtnd_vendor_payments_tax set company=trim(company),
fund=trim(fund),
rcc=trim(rcc),
...
$query2="delete from budget.xtnd_vendor_payments_tax
where f_year=''
and account not like '211%';
";
			 
mysqli_query($connection, $query2) or die ("Couldn't execute query 2.  $query2");

$query3="update budget.xtnd_vendor_payments_tax
set f_year=
'$fiscal_year'
where f_year='';
";
...
$query4="update budget.xtnd_vendor_payments_tax
set xtnd_date=
'$end_date'
where f_year=
'$fiscal_year';";
...
$query5="update xtnd_vendor_payments_tax
...
$query6="update xtnd_vendor_payments_tax
