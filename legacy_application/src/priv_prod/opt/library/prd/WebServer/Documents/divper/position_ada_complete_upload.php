...
//	echo "$remove_file<pre>";print_r($_FILES); print_r($_REQUEST);echo "</pre>"; //exit;
	...
	$folder = "position_desc_files/ada_word";
	if (!file_exists($folder)) {mkdir ($folder, 0777);}
...
//	echo "$uploadfile";exit;
	...
	$sql = "REPLACE position_ada_word set beacon_num='$beacon_num', form_name='$form_name', beacon_title='$beacon_title', file_link='$uploadfile'";
	//  echo "$sql";exit;
