...
echo "</style>";
echo "<table><tr><td><font color='brown' size='5'>PCARD Transaction Lookup</font></td></tr></table><br />";
...
echo "<table><tr><td><font color='brown'>Location</font><input type='text' size='10' name='admin_num' value='$admin_num' $readonly></td></tr></table>";
echo "<br />";
echo "<table border='1'>";
