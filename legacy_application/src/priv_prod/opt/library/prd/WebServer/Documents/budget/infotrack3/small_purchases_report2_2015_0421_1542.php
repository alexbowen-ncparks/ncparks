...
$query14="
select f_year,month_name as 'month',ncas_center as 'center',park,ncas_account as 'account',ncas_invoice_date as 'invoice_date',ncas_invoice_number as 'invoice_trans_id',vendor_name,comments,ncas_invoice_amount as 'invoice_amount',account_category,source,id from cvip_small_purchases
		 where 1
		 and f_year='$f_year'
		 and month_number='$month_number'
		 and valid = 'y'
