...
echo "<br />";
include("menu_add_icons_success.php"); // connection parameters

if($id2 != '')
{

$query0="select photo_location as 'photo_location2',label as 'label2',comments2
         from mission_icon_success
		 where id='$id2'
         ";
...
$query1="update infotrack_customformat
          set home_photo='$photo_location2',home_photo_link='$comments2',home_label='$label2'
...
$query4="select *
         from mission_icon_success
		 where 1
         order by mission_icon_success.id desc ";
...
//creating the row of <span class="IL_AD" id="IL_AD8">picture</span> thumbnails
 ...
 //Creating Row for Picture Description
       ...
       echo "<tr bgcolor=''>";
        ...
        {
            echo "<td>";
            echo "{$description[$b]}";echo "&nbsp;&nbsp;$id[$b]<br />";echo "<a href='icons_success.php?id2=$id[$b]'>$thumb[$b]</a>";
            echo "</td>";
            $b++;
        }
        echo "</tr>";
