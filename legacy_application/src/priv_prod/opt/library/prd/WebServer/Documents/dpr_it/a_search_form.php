...
while($row=mysqli_fetch_assoc($result))
	{
	if($row['Field']=="district_section"){continue;}
...
$search_computers_dropdown=array( "region_section", "location","type","os","make","model", "site_id", "computer_status");
$search_printers_dropdown=array("site_id","printer", "region_section", "location", "printer_status");
$search_subnets_dropdown=array("district_section","region_section","site_name", "location", "current_service_provider", "type", "site_id", "vlan");
...
$search_skip=array("division","district_section");
...
// 	echo "<pre>"; print_r($_SESSION); echo "</pre>"; // exit;
	...
	if(array_key_exists($_SESSION[$database]['select'], $mod_region_office))
		{
		$_SESSION[$database]['select']=$mod_region_office[$_SESSION[$database]['select']];
		}
