...
$menu=4;
if($menu==4){$shade_menu3="class=cartRow";$calmonth='april';$month_number='04';$calyear='2018';$round=2;}
...
echo "<table align='center'><tr><th><i><a href='infotrack/mq_votes.php?calyear=$calyear&calmonth=$calmonth&round=$round'  target='_blank'><img height='30' width='30' src='/budget/infotrack/icon_photos/mission_icon_photos_264.png' alt='picture of green check mark'><a href='/budget/infotrack/mq_votes.php?calyear=2018&calmonth=march&round=3' target='_blank'>Leaderboard</a></img></i></th></tr></table>";
...
//{
//if($id==$favorite_qid2)	
echo "<td><a href='infotrack/money_quotes_scores.php?score=y&favorite=$id&calmonth=$calmonth&calyear=$calyear&month_number=$month_number&round=$round&menu=$menu' target='_blank'>$vote_yes</a></td>"; 
