...
`DPR_contractor_name` varchar( 50 ) NOT NULL default '',
`DPR_contract_transaction_type` varchar( 20 ) NOT NULL default '',
`DPR_change_order_number` varchar( 10 ) NOT NULL default '',
`DPR_table_entry_date` varchar( 15 ) NOT NULL default '',
`DPR_contract_transaction_amount` decimal( 12, 2 ) NOT NULL default '0.00',
`DPR_contract_comments` varchar( 100 ) NOT NULL default '',
`Contract_Documents_Sent` varchar( 15 ) NOT NULL default '',
`Contract_Documents_Received` varchar( 15 ) NOT NULL default '',
`Forms6000_6100_Sent` varchar( 15 ) NOT NULL default '',
`Forms6000_6100_Received` varchar( 15 ) NOT NULL default '',
`user_id` varchar( 40 ) NOT NULL default '',
`record_creation_date` datetime NOT NULL default '0000-00-00 00:00:00',
`record_revision_date` timestamp NOT NULL ,
