...
$query4="select park,photoname,link,width,height,pid
         from images
         where park='haro'
...
echo "<th align='center'><img src='$photo_src'  width='750' height='500' title='$Comments2[$j]' /><br />$Photo_location[$j]<br />$Comments[$j]<br />$Width[$j]X$Height[$j] $wxh</th>";
...
echo "<td>
<form method='post' action='slideshow_20150321d_haro.php'>";
