...
$query1=" SELECT contract_num, sum( contract_amt )  AS  'contract_amt', sum( noncon_amt )  AS  'noncontract_amt', sum( amount )  AS  'invoice_amt', 
 sum(contract_amt+noncon_amt) as 'con_plus_noncon_amt', 
 sum(contract_amt+noncon_amt-amount) as 'oob' 
 FROM  `partf_payments`  
...
echo "<tr>"; 
 ...
 echo " <th><font color=blue>contract_amt</font></th>";
 echo " <th><font color=blue>noncontract_amt</font></th>";
 echo " <th><font color=blue>invoice_amt</font></th>";
 echo " <th><font color=blue>con_plus_noncon_amt</font></th>";
...
echo "</tr>";
echo  "<form method='post' action='stepJ9r1.php'>";
//exit;
...
echo  "<td>$contract_amt</td>";
echo  "<td>$noncontract_amt</td>";
echo  "<td>$invoice_amt</td>";
echo  "<td>$con_plus_noncon_amt</td>";
echo  "<td>$oob</td>";
