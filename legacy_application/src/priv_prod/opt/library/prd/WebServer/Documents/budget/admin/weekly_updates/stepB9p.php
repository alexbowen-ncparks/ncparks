...
$ta="report_project_expenditures_detail";
$ct=date("His");
...
(
`center_number` varchar( 15 ) NOT NULL default '',
`project_number` varchar( 10 ) NOT NULL default '',
`ncas_account_number` varchar( 15 ) NOT NULL default '',
`ncas_account_name` varchar( 75 ) NOT NULL default '',
`ncas_vendor_number` varchar( 25 ) NOT NULL default '',
