...
// Letter
$sql="SELECT agenda_body as var_agenda_body from pac_letter";
...
$agenda_body=$var_agenda_body;  //echo "$agenda_body"; exit;
...
if($passOption)
	...
	$agenda_body=str_replace("*optional_paragraph*",$passOption,$agenda_body);
		...
		{
		$agenda_body=str_replace("*optional_paragraph*","\r\r",$agenda_body);
...
$agenda_body="A meeting of the Park Advisory Committee for *park* has been scheduled for *date* at *time* at *location*.  If you are unable to attend, or have an item you would like added to the agenda, please give me a call at *parkphone* or email *super_email*.\n\n*optional_paragraph*\n\nThe tentative agenda includes the following:\n*agenda_items*\n\n\nAs always, thank you for your continued support of *park*.  I look forward to seeing you at the meeting.\n\nSincerely,\n\n\n\n*super*\n*address*\n*citystatezip*";

$agenda_body="A meeting of the Park Advisory Committee for *park* has been scheduled for *date* at *time* at *location*.  If you are unable to attend, or have an item you would like added to the agenda, please give me a call at *parkphone* or email *super_email*.\n\n*optional_paragraph*\n\nThe tentative agenda includes the following:";

$text = $agenda_body;
$lines = explode("\n",$text);   //echo "<pre>"; print_r($lines); echo "</pre>";  exit;
pdf_set_text_pos($pdf,50 ,550);
...
//PDF_continue_text($pdf, $agenda_body);
