...
echo "</tr>";
echo "<tr>";
echo "<td><a href='cash_summary_update.php?cs_update=y&upload_date=$upload_date&project_category=$project_category&project_name=$project_name&step_group=$step_group&step=$step&step_num=$step_num'>Cash Summary Update thru: $yesterday </a></td>";
echo "</tr>";
echo "</table>";
...
echo "line 521<br /><br />";
if($num24==0)
echo "<table align='center'><tr><th><a href='main.php?project_category=$project_category&project_name=$project_name'>Return to Menu</a></th></tr></table>";
...
echo "<table align='center'><tr><th><img height='75' width='75' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of bank'></img>Update Successful</th></tr></table>";
echo "<br /><br />";


echo "<table align='center'><tr><th><a href='step_group.php?project_category=$project_category&project_name=$project_name&step_group=$step_group&step=$step'>Return to Menu</a></th></tr></table>";
