...
(  `report_date` date NOT  NULL default  '0000-00-00',
 ...
 `f_year` char( 4  )  NOT  NULL default  '',
 `pcard_message` text NOT  NULL ,
 `active` char( 1  )  NOT  NULL default  'n',
 `active_date` date NOT  NULL ,
 `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `report_date_2` (  `report_date`  ) ,
 KEY  `report_date` (  `report_date`  ) ,
 KEY  `xtnd_start` (  `xtnd_start`  ) ,
 KEY  `xtnd_end` (  `xtnd_end`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
";
