...
$dbName="second_employ";
include("../../include/auth.inc");
include("../../include/iConnect.inc");
extract($_REQUEST);

mysqli_select_db($connection,"divper");
$sql = "SELECT $dbName as level,emplist.tempID,emplist.currPark,accessPark,t2.working_title, concat(t3.Fname,' ',t3.Mname,' ',t3.Lname) as full_name, t2.beacon_num, t2.code as position_code
FROM emplist 
...
$_SESSION[$dbName]['position_code'] = $position_code;
