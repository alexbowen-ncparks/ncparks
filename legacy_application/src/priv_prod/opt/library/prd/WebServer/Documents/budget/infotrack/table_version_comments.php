...
echo "<form method='post' autocomplete='off' action='table_version_comments_update.php'>";
echo "<table border=1>";
	   ...
	   echo "<th><font color='brown'>table name</font></th>";
	   echo "<th><font color='brown'>version</font></th>";
	   echo "<th><font color='brown'>comment note</font></th>";
...
//if($park==$con){$s="selected";}else{$s="value";}
   ...
   echo "</select></td>"; 
	   ...
	   echo "<td><input name='table_name' type='text' size='15' id='table_name'></td>";
	   echo "<td><input name='version' type='text' size='15' id='version'></td>";	   
