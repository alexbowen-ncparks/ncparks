...
if(!empty($submit_admin))
	{
	echo "<h2>To view previously scored tests click <a href='completed_tests.php'>here</a>.</h2><br /><br />";
	}
...
// echo "<pre>"; print_r($list_of_tests); echo "</pre>"; // exit;
	...
	$skip=array("test_id");
echo "<table cellpadding='10'><tr><td><h2>Here are tests not scored.</h2></td></tr>";
