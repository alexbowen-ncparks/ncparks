...
include("../../budget/menu1314_tony.html");
 ...
 {
 $pid='74';
 include("../../budget/infotrack/slide_toggle_procedures_module2_abstract_pcard.php");
 }
...
if($report_type=='form' and $cashier_count==1)
{
...
echo "<table align='center'><tr><th>Employee PCARD Request</th></tr></table>";
echo "<br />";
echo "<table align='center' border='1'>";
...
echo "<tr><th>admin</th><td><input type='text' name='admin' value='$concession_location' size='5' readonly='readonly' autocomplete='off'></tr>";
	...
	*/
	echo "<tr><th>employee number</th><td><input type='text' name='employee_number' value='$employee_number' size='10 autocomplete='off'></td></tr>";
	
	echo "<tr><th>position number</th><td><input type='text' name='position_number' value='$position_number' size='10' autocomplete='off'></td></tr>";
 ...
 echo "<tr><th>Upload *Completed* DNCR Form (PDF Only)</th><td><input type='file' id='document' name='document'><input type='hidden' name='content_mode' value='$content_mode' /><input type='hidden' name='MAX_FILE_SIZE' value='2000000'>
...
if(($report_type=='reports') and ($cashier_count==1 or $manager_count==1 or $beacnum=='60032997'))
{

//include("pcard_request3.php");
//include ("pcard_request_fyear_module.php");
include ("pcard_request_menu.php");
//$score='10';
