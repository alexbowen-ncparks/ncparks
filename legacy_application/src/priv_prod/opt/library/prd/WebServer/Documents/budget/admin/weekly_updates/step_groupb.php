...
echo "<H1 ALIGN=LEFT > <font color=brown><i>Weekly Updates-StepGroup B</font></i></H1>";
...
$query3="SELECT * FROM weekly_updates_steps_detail where 1 and step_group='b' order by step_num asc";
...
"<tr$t>	
	   ...
	   <td>$step_name</td>
	   <td>
	   <form method='post' action='step_groupb$step_num.php'>
