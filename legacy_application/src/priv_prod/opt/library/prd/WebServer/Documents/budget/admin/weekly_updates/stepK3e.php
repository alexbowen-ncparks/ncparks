...
$query1="truncate table energy_532220_propane_meters;
";

$result1=mysqli_query($connection, $query1) or die ("Couldn't execute query 1.  $query1");


$query2="insert into energy_532220_propane_meters(division,ncas_center,centerpark,utility_account_number,building_name,address,city,vendor_name,energy_group,cdcs_uom)
...
$query2a="insert into energy_532220_propane_meters(division,ncas_center,centerpark,utility_account_number,building_name,address,city,vendor_name,energy_group,cdcs_uom)
select 'parks & recreation',ncas_center,centerpark,ncas_invoice_number2,'none','none','none','none',energy_group,cdcs_uom
from energy_controllers_3
...
$query3="update energy_532220_propane_meters
