...
function setForm() {
    opener.document.f1.lat.value = document.setLatLonForm.lat.value;
    opener.document.f1.lon.value = document.setLatLonForm.lon.value;
    self.close();
    return false;
}
...
<tr>
	...
	var baseLink = "http://www.dpr.ncparks.gov/photo_point/lat_long.php";
