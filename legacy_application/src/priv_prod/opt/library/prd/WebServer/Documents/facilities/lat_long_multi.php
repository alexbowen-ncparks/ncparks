...
<html><head>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDEQtuoWMbScKMQHnBTM9ZFxfdVczrpEC0&callback=initMap"
...
function setForm() {
    opener.document.editForm.lat[].value = document.setLatLonForm.lat[].value;
    opener.document.editForm.lon[].value = document.setLatLonForm.lon[].value;
    self.close();
    return false;
}
...
<tr>
	...
	var baseLink = "https://10.35.152.9/facilities/lat_long_multi.php";
	var baseLink = "https://10.35.152.9/facilities/lat_long_multi.php";
