...
$query11="SELECT park,center,fyear,cash_month,cash_month_number,cash_month_calyear,cashier,cashier_amount,cashier_date,manager,manager_date,score,valid,id,sum(reimbursement_gallons*reimbursement_rate*1.12) as 'refund_total' 
from fuel_tank_usage
WHERE 1
and park='$parkcode'
and fyear='$fyear'
...
"<tr$t>
		   ...
		   */
		   ...
		   if($cashier != '')
		   {
		   echo "<td bgcolor='lightgreen'>Refund Amount=$refund_total<br /><img height='25' width='25' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of green check mark'></img>";
		  ...
		  if($manager_count==1)
		   {
		   echo "<a href='page2_form.php?parkcode=$parkcode&cash_month=$cash_month&fyear=$fyear&cash_month_calyear=$cash_month_calyear&step=4'><img height='25' width='25' src='/budget/infotrack/icon_photos/magnify.png' alt='picture of green check mark'></img></a>";
		   }
