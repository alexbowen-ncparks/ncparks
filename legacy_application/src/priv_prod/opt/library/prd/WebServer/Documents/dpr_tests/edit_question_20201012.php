...
// 	echo "58 edit_question<pre>"; print_r($edit_question[0]); echo "</pre>"; // exit;
		if(!empty($edit_question))
			...
			$test_name=$edit_question[0]['test_name'];
			}
			else
			{
			$test_id=$test_number;
...
// Top row
		...
		<table><tr><td colspan='2'><h3>Question for <font color='#8cd9b3'>". $test_name."</font></h3></td>
		<td>
