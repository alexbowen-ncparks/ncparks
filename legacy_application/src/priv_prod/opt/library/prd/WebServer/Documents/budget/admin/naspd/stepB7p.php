...
$query0="delete from bd725_dpr_account_detail3_rec_summary_funding_types
...
$query1="insert into bd725_dpr_account_detail3_rec_summary_funding_types(center,funding_types,f_year)
SELECT center,count(id),f_year FROM `bd725_dpr_account_detail3_rec_summary` WHERE 1 and f_year='$fiscal_year' group by center";
