...
// Changed 5/18/21
//  If pcard_report_dates.fund_ci="n", the Online Reconcilement Form will no longer allow Parks to use CI Funds
//  Budget Officer (Dodd) and PCARD Administrator (Gooding) have "front-end" access to Change this Value in MoneyCounts as follows:
//  Go to MoneyCounts Home Page, Click PCARD Link at top of page, Click Weekly Reports LINK, Select Report Date, 3rd blue section (CI Funds Permitted): allows toggle between Field=fund_ci (Y or N) 
...
<td><input type='text' name='projnum[$pc_id]' value='$projnum' size='7' READONLY></td>";}
	...
	//echo "<td$colorTD>$vendor_name</td>";
	...
	*/
	...
	//lines 74 (echo "<td align='center'>) thru 78 (echo "$error</td>";) commented out on 5/20/11-TB
	/*
...
if(!$loc and $rep=="" and $report_date)
	...
	echo "<tr>";
	echo "<td align='center' colspan='19'>For <font color='blue'>Security Reasons</font> the server will log you out after 30 minutes of inactivity. <input type='submit' name='submit' value='Update'> Please <font color='red'>UPDATE</font> your work every 15-20 minutes.<input type='hidden' name='varQueryPass' value='$varQuery'>
	...
	</form></td><td>L1.php</td><tr>";
	//echo "<tr>";
	//echo "<td align='right' colspan='10'>";
	//echo " </td>";
	//echo "<td align='center' colspan='15'>cashier_count=$cashier_count</td>";
...
echo "Line 173: query1=$query1<br />";		 
...
if($cashier=='')
{	
//echo "<font color='red'>Recon Form Complete</font>";
}
