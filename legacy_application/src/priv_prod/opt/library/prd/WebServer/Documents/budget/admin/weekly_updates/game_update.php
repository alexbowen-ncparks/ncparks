...
$del_blank_recs="delete from questions where gid='$gid' and answer='' ";


//echo "del_blank_recs=$del_blank_recs<br />";

$res_del_blank_recs=mysqli_query($connection, $del_blank_recs) or die ("Couldn't execute del_blank_recs. $del_blank_recs");
