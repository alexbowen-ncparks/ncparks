...
echo "<td><font size=4 color=brown >Game Scores</font></td>";

echo "<td><a href='user_activity_matrix.php?report=user&section=$section&user_level=$user_level&history=$history&period=$period&range_year_start=$range_year_start&range_month_start=$range_month_start&range_day_start=$range_day_start&range_year_end=$range_year_end&range_month_end=$range_month_end&range_day_end=$range_day_end'><font  $shade_user>Player</font></a></td>";
/*
