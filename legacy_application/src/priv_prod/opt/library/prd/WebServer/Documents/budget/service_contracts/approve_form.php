...
echo "<table align='center'><tr><th><font color='brown' size='10'>Step4-Approve Form Under Development</font></th></tr></table>";
exit;
...
echo "<tr><th align='center'><font color='brown'>Park</font></th><td><input type='text' name='park' value='$park'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Purpose</font></th><td><textarea rows='4' cols='50' name='purpose'>$purpose</textarea></td></tr>";
echo "<tr><th align='center'><font color='brown'>Contract Administrator</font></th><td><input type='text' name='contract_administrator' value='$contract_administrator'></td></tr>";  
echo "<tr><th align='center'><font color='brown'>Contractor</font></th><td><input type='text' size='50' name='vendor' value='$vendor'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Contract#</font></th><td><input type='text' name='contract_num' value='$contract_num'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Purchase Order#</font></th><td><input type='text' name='po_num' value='$po_num'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Purchase Order Line#</font></th><td><input type='text' name='line_num' value='$line_num'></td></tr>";
...
echo "<tr><th align='center'><font color='brown'>Purchase Order Line (Company)</font></th><td><input type='text' name='company' value='$company'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Purchase Order Line (Account)</font></th><td><input type='text' name='ncas_account' value='$ncas_account'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Purchase Order Line (Center)</font></th><td><input type='text' name='center' value='$center'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Purchase Order Line (Begin Balance)</font></th><td><input type='text' name='line_num_beg_bal' value='$line_num_beg_bal'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Buy Entity</font></th><td><input type='text' name='buy_entity' value='$buy_entity'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Remit to Address</font></th><td><input type='text' size='50' name='remit_address' value='$remit_address'></td></tr>";
echo "<tr><th align='center'><font color='brown'>FID#</font></th><td><input type='text' name='fid_num' value='$fid_num'></td></tr>";
echo "<tr><th align='center'><font color='brown'>Group#</font></th><td><input type='text' name='group_num' value='$group_num'></td></tr>";
