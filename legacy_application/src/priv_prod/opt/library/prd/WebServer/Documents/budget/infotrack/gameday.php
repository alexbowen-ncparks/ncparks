...
echo "<td><textarea name= 'alert_note' rows='1' cols='30' placeholder='Game Name' id='input2'></textarea></td>";            
      
	  echo "<td><input type=submit name=submit value=Add_Procedure></td>";
