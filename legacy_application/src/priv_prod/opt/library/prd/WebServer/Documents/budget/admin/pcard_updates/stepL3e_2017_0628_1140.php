...
// The variable $result is a PHP resource containing the results of the MySQL query. Its contents can only be used by PHP.
$result2a1 = mysql_query($query2a1) or die ("Couldn't execute query 2a1.  $query2a1");

$row2a1=mysql_fetch_array($result2a1);
extract($row2a1);
...
// The variable $result is a PHP resource containing the results of the MySQL query. Its contents can only be used by PHP.
$result2a2 = mysql_query($query2a2) or die ("Couldn't execute query 2a2.  $query2a2");

$row2a2=mysql_fetch_array($result2a2);
extract($row2a2);
...
mysql_close();
echo "<table align='center'><tr><td><a href='pcard_lookup.php' target='_blank'>Missing PCARD Lookup</a></td></tr></table>";
