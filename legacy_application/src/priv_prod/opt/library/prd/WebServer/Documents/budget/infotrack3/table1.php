...
include("style1.html");
echo "<table class='center'><tr><td><a href='table1.php?add=y'>ADD Record</a></td></tr></table>"; 
//$skip_array=array("");
//$decimalFields=array("");
...
//if($district==''){exit;}
echo "<form method='post' action='table1.php'>";
...
if($v==$order_by)
{
echo "<th><a href='table1.php?order_by=$v'>$v</a><br />sorted $asc_desc </th>";
}
else
{
echo "<th><a href='table1.php?order_by=$v'>$v</a></th>";
}
}
echo "</tr>";
...
foreach($ARRAY as $k=>$v)
	...
	echo "<tr$tr>";
		...
		foreach($v as $k1=>$v1){// each field, e.g., $tempID=$v[tempID];
			...
			if($k1==$primaryField){echo "<td>$v1 <a href='table1.php?edit=y&$k1=$v1'>Edit</a></td>";} else  {echo "<td>$v1</td>";}
