...
$query1="SELECT * FROM project_substeps_detail where cid='$cid'";
...
echo "<form name='form1' method='post' action='edit_project_substeps_detail_duplicate_insert.php'>";
...
echo "<table border=1>";
	   ...
	   echo "<tr><td><font color='red'>substep_num</td></font><td><input type='text' name='substep_num' value='$substep_num'></td></tr>";
	   echo "<tr><td><font color='blue'>substep_name</td></font><td><input type='text' size='70' name='substep_name' value='$substep_name'></td></tr>";
