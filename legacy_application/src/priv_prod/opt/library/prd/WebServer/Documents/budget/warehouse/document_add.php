...
$query12="insert into warehouse_documents(user,system_entry_date,project_category,project_name,project_note)
values('$beacnum','$system_entry_date','$project_category','$project_name','$project_note')";


$result12=mysqli_query($connection, $query12) or die ("Couldn't execute query 12. $query12");

$query13="select max(project_note_id) as 'project_note_id' from warehouse_documents where user='$beacnum' ";
