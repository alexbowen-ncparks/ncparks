...
$db="$today_date";
$ta21="crs_tdrr_division_history_parks_manual";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta21.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta21$ct`
SELECT *
FROM `budget`.`$ta21` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta21$ct` 
(
...
$query2a="select count(*) as 'record_count21' from `budget_daily_backup`.`$db$ta21$ct` ";
