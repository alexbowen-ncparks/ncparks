...
$ta="appropriated_revenues_non1280";
$ct=date("His");
...
(  `center` varchar( 14  )  NOT  NULL default  '',
 `new_center` varchar( 15  )  NOT  NULL ,
 `project_num` varchar( 10  )  NOT  NULL default  '',
 `amount` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `date` varchar( 15  )  NOT  NULL default  '',
 `postnew` varchar( 15  )  NOT  NULL default  '',
 `comments` varchar( 75  )  NOT  NULL default  '',
 `xtnd` char( 1  )  NOT  NULL default  'y',
