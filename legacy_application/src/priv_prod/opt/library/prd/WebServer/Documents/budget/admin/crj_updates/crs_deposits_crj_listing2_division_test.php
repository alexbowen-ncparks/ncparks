...
$query1="SELECT min(orms_deposit_date) as 'start_date',max(orms_deposit_date) as 'end_date'
...
$query11="SELECT park,center,orms_start_date as 'transdate_start',
orms_end_date as 'transdate_end',orms_deposit_id,orms_deposit_date,orms_deposit_amount,download_date,days_elapsed,trans_table,controllers_deposit_id,bank_deposit_date,controllers_deposit_amount
from crs_tdrr_division_deposits
WHERE 1
order by park asc, orms_deposit_id asc ";
}			
...
"<tr> 
	   ...
	   <th align=left><font color=brown>ORMS <br />Deposit Date</font></th>
	   <th align=left><font color=brown>ORMS <br />Deposit Amount</font></th>
	   <th align=left><font color=brown>Download Date</font></th>
	   <th align=left><font color=brown>Days Elapsed</font></th>
	   <th align=left><font color=brown>Trans Table</font></th>
	   <th align=left><font color=brown>Controllers<br />Deposit ID</font></th>
	   <th align=left><font color=brown>Bank Deposit Date</font></th>
	   <th align=left><font color=brown>Controllers<br />Deposit Amount</font></th>
...
echo "<td>$park</td>";  
echo "<td>$center</td>";
echo "<td>$transdate_start</td>";
echo "<td>$transdate_end</td>";
