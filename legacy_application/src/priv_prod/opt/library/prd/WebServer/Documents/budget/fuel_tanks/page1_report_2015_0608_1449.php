...
"<tr> 
       ...
       <th align=left><font color=brown>Cashier<br />Update</font></th>
	   <th align=left><font color=brown>PASU<br />Approval</font></th>
...
"<tr$t>
		   ...
		   */
		   ...
		   if($cashier=='' and $cashier_count==1)
			{
		   echo "<td bgcolor='lightpink'><a href='page2_form.php?parkcode=$parkcode&cash_month=$cash_month&fyear=$fyear&cash_month_calyear=$cash_month_calyear' >Update</a></td>";
		   }  
