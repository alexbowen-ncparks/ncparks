...
echo "<form enctype='multipart/form-data' method='post' action='concessions_vendor_fees_document_add2.php'>";
echo "<input type='hidden' name='MAX_FILE_SIZE' value='20000000'>";
echo "<input type='file' id='document' name='document'>";
echo "<input type='hidden' name='source_id' value='$source_id'>";
//echo "<input type='hidden' name='header_var_admin' value='$header_var_admin'>";
echo "</td></tr>";
