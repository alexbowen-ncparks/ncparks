...
$query11="SELECT park,center,fyear,cash_month,cash_month_number,cash_month_calyear,cashier,cashier_amount,cashier_date,manager,score,valid,id,sum(reimbursement_gallons*reimbursement_rate*1.12) as 'refund_total' 
from fuel_tank_usage
WHERE 1
and park='$parkcode'
and fyear='$fyear'
