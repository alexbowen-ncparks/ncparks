...
$query33="select * from project_steps_detail
		 ...
		 and step_group='D'  and step_num='1c' "; 
...
echo "<H3 ALIGN=left><A href='/budget/admin/weekly_updates/step_group.php?project_category=$project_category&project_name=$project_name&step_group=$step_group&step_name=$step_name&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date'>Return to Weekly Updates </A></H3>";
