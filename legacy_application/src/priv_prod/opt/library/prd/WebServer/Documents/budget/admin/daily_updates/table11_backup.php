...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta11.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta11$ct`
SELECT *
FROM `budget`.`$ta11` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta11$ct` 
(
...
$query2a="select count(*) as 'record_count11' from `budget_daily_backup`.`$db$ta11$ct` ";
