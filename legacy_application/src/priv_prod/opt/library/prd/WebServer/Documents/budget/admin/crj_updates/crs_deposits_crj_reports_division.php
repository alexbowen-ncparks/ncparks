...
//echo "deposits=$deposits";
 ...
 <a href='/budget/admin/crj_updates/bank_deposits_menu_division.php?menu_id=a&menu_selected=y'>
 <img height='50' width='50' src='/budget/wake_tech/images/bank.jpg' alt='picture of bank'></img></a></th><th>Cash Receipts Journal- ORMS Deposit ID</th><td>$GCN <a href=crs_deposits_crj_reports_division.php?deposit_id=$deposit_id&GC=n><font $shade_deposit_id>$deposit_id</font></a></td>";
 if($deposits > 1){echo "<td>$GCY<a href=crs_deposits_crj_reports_division.php?deposit_id=$deposit_id&GC=y><font $shade_deposit_id_GC>$deposit_id_GC</font></a></td>";}
 "</tr></table>";}
...
"<tr$t> 
            <td colspan='2'>Justification:</td><td colspan='5'>Collection Period:_________________________________________________<br >_______________________________________________________________</td>
		    <td></td>
		    <td></td>
		    <td></td>
...
echo "<tr><td colspan='2'>Prepared by:<br />Approved by:<br />Entered by</td><td colspan='3'>___________________Phone#___________________<br />__________________Date:_____________________<br />__________________Date:____________________</td><td>Total Debits</td><td>$var_total_debit</td></tr>";
