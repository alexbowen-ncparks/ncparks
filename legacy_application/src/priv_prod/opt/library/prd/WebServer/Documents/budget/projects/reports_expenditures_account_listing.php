...
$query2="select distinct account,account_description,budget_group,gmp from $table where 1 
         and cash_type='disburse' and budget_group='pfr_expenses' order by account";
		 
$result2 = mysqli_query($connection, $query2) or die ("Couldn't execute query 2.  $query2");
$num2=mysqli_num_rows($result2);


echo "<H1 ALIGN=left><font color=brown><i>Expenditure Accounts(Purchase4resale ONLY)-$num2</i></font></H1>";
echo "<table border=1>";
