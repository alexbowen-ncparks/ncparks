...
if($f_year=='1213'){$shade_1213="class=cartRow";}
 ...
 {echo "<br />";  echo "<table><tr><th>Cash Receipts Report- ORMS Deposit ID</th><td> <a href=crs_deposits_crj_reports.php?deposit_id=$deposit_id&GC=n><font $shade_deposit_id>$deposit_id</font></a></td>";
 if($deposits > 1){echo "<td><a href=crs_deposits_crj_reports.php?deposit_id=$deposit_id&GC=y><font $shade_deposit_id_GC>$deposit_id_GC</font></a></td>";}
 "</tr></table>";}
