...
foreach($ARRAY AS $index=>$array)
	...
	foreach($array as $fld=>$value)
		...
		if($fld=="employee_status")
			...
			$value.="</td><td>Email DPR  <a href=\"mailto:$email?cc=$cc&subject=$park_code Worker Comp for $full_name&body=/work_comp/review_submission_steps.php?wc_id=$wc_id You will need to login to the Worker's Comp db application to view. 
			$value.="</td><td>Email DPR  <a href=\"mailto:$email?cc=$cc&subject=$park_code Worker Comp for $full_name&body=/work_comp/review_submission_steps.php?wc_id=$wc_id You will need to login to the Worker's Comp db application to view. 
\">DPR-HR-Staff & Safety Officer</a>";
		...
		if($fld=="wc_approved")
			...
			$value=$new_value;
			$body="/work_comp/review_submission_steps.php?wc_id=$wc_id  You will need to login to the Worker's Comp db application to view.";
			$body="/work_comp/review_submission_steps.php?wc_id=$wc_id  You will need to login to the Worker's Comp db application to view.";
