...
echo "<td align='center'><font size='5' color='brown'>$park_header PreApproval<br />PurchaseCosts<br />$vehicle_repair_icon</font></td><th><a href='preapproval_list.php' target='_blank'>PreApproval List</a></th>";
/*
if($level < '3')
{
echo "<td><font size='5' color='brown'>$concession_location</font></td>";
