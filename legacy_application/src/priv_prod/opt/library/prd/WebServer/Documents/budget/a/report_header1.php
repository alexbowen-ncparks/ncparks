...
echo "<td><a href='reports_all_centers_summary_by_division.php?accounts=all&report=$report&section=$section&district=$district&history=$history&period=$period&range_year_start=$range_year_start&range_month_start=$range_month_start&range_day_start=$range_day_start&range_year_end=$range_year_end&range_month_end=$range_month_end&range_day_end=$range_day_end'><font  $shade_accounts_all>ALL</font></a></td>";
...
echo "<td><a href='reports_all_centers_summary_by_division.php?accounts=receipt&report=$report&section=$section&district=$district&history=$history&period=$period&range_year_start=$range_year_start&range_month_start=$range_month_start&range_day_start=$range_day_start&range_year_end=$range_year_end&range_month_end=$range_month_end&range_day_end=$range_day_end'><font  $shade_accounts_receipt>Receipt</font></a></td>";
...
if($period=='range'){
echo "<td colspan='3'>Range Data Available: July 1,2009 thru April 6,2011</td>";
}
echo "</tr>";
...
echo "<td><a href='reports_all_centers_summary_by_division.php?period=range&report=$report&accounts=$accounts&section=$section'><font  $shade_period_range>range</font></a></td>";
if($period=='range'){
