...
$query3="SELECT `park`,`center`,`company`,`purpose`,`contract_administrator`,`po_num`,`line_num`,`ncas_account`,`fyear`,`vendor`,`id` as 'scid',`remit_name`,`remit_address`
...
echo "<form enctype='multipart/form-data' method='post' action='po_invoice_add2.php'>";
...
echo "<tr><th align='center'><font color='brown'>PayLine Amounts</font></th><td>";
include("payline_amounts.php"); 
echo "</td>";
echo "</tr>";         
...
echo "<input type='hidden' name='remit_name' value='$remit_name'>";
