...
// "Next Add Position"=>"/hr/bSeasonal/park_seasonals_add_next.php?file=Add Position",
// "Next OSBM Report"=>"/hr/bSeasonal/park_seasonals_osbm_next.php?file=OSBM Report",
// "Next OSBM Titles"=>"/hr/bSeasonal/position_justification_next.php?file=OSBM Titles",
$menuArray1=array(
"HR Home Page"=>"/hr/start.php",
"Show Positions by Park"=>"/hr/bSeasonal/park_seasonals_next.php?file=Show Positions by Park",
"Next Find Position"=>"/hr/bSeasonal/park_seasonals_find_next.php?file=Find Position",
"Next CHOP Report"=>"/hr/bSeasonal/seasonal_database_report_next.php?file=CHOP Report");
