...
include("../../../budget/~f_year.php");
include("../../../budget/header_logo_apple2.php");
...
*/
$query5="select polls.id,polls.poll_name,poll_choices.choice_id,poll_choices.choice_name as 'month_name',poll_choices.choice_points as 'amount' from polls left join poll_choices on polls.id=poll_choices.poll_id where polls.id='5' order by poll_choices.choice_id asc";
 ...
 */
 ...
 imagestring($img,5,400,60,'Poll: favorite_season',$bar_color);
	# ----------- Draw the bars here ------
	for($i=0;$i< $total_bars; $i++){ 
		...
		$y2= $y1 + $bar_width; 
		//140+20=160
		imagestring($img,5,$x2+3,$y1+5,$value,$bar_color);
