...
$month=date(m);
if($month<7){
$thisYear=date(Y);//2006
$otherYear=$thisYear-1;}//2005
else
{
$thisYear=date(Y);//2006
$otherYear=$thisYear+1;}//2007
}

//   returns true for period 2005-7-1 to 2006-6-30	 
		echo "result = (allDigits(elems[2]) && (day > 0) && (day < 32)) &&
			 		(allDigits(elems[1]) && (month > 6) && (month < 13) && (year == $otherYear) || allDigits(elems[1]) && (month > 0) && (month < 7) && (year == $thisYear))";
?>
...
function validateForm(theForm)
{
	...
	// if (!validRequired(theForm.presenter,"Presented by")) 
	//	return false;
		
	// if (!validRequired(theForm.progtitle,"Program Title"))
	//	return false;
