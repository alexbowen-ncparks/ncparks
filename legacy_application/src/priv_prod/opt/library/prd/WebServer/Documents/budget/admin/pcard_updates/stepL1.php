...
echo "<H2 ALIGN=center><font size=4><b><A href=/budget/admin/pcard_updates/step_group.php?project_category=fms&project_name=pcard_updates&step_group=L> Return Pcard Updates-HOME </A></font></H2>";
echo "<br />";
echo
"<form method=post autocomplete='off' action=stepL1.php>";
echo "<font size=5>"; 
...
if($num4!=0)
*/
{header("location: stepL1_update1.php?project_category=$project_category&project_name=$project_name&step_group=$step_group&step_num=$step_num&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date");}
}
