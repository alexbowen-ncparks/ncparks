...
if(empty($submit))
	...
	<body>";
$file_array=array("pcard");
	
	echo "<form method=post action=test_upload_cs2.php enctype='multipart/form-data'>";
...
//echo "<br />Line 144: Upload Complete<br />"; exit;


include("aDiv/pcard_weekly_report_add.php");
