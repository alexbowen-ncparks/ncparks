...
order by game_name; ";
*/
$query5="SELECT survey_scores_summary.gid,survey_scores_summary.game_name,survey_scores_summary.record_complete,player
FROM survey_scores_summary
where 1 and playstation='$concession_location'
...
echo "<td align='center'><img height='25' width='25' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of green check mark'></img><br />$player2</td>";
}	
