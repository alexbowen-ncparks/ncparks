...
echo "<font color='brown' size='5'>Oops: Documents Module is under Construction. <br /><br /> Click the BACK button on your Browser to return to previous Page. Thanks</font><br />";exit;
...
$query2a="insert ignore into infotrack_projects
(user,system_entry_date,project_category,project_name,project_note,weblink,note_group) 
values ('$tempID','$system_entry_date','$project_category','$project_name',
'$project_note','$web_address','web')";
...
$query2b="insert ignore into infotrack_projects_community
(user,system_entry_date,project_category,project_name,project_note,weblink,note_group) 
values ('$tempID','$system_entry_date','$project_category','$project_name',
'$project_note','$web_address','web')";
