...
for ($n=0;$n<count($arrayInitial_c);$n++)
	{
	echo "<a href=\"_photoID.php?init_c=$arrayInitial_c[$n]\" target=\"_parent\">[ $arrayInitial_c[$n] ]</a>&nbsp;&nbsp;";
       }
   echo "</td></tr></table>";
...
foreach($ARRAY as $k=>$v)
	...
	echo "<tr><td>$j</td>";
		...
		if(array_key_exists($tempID,$SIG_ARRAY))
			...
			$v2="[ <a href='https://10.35.152.9/divper/$link' target='_blank'>VIEW</a> ] [<a href='https://10.35.152.9/divper/_photoID.php?init_c=$init_c&del_sig=y&tempID=$tempID'>Delete</a>]";
			$v2="[ <a href='https://10.35.152.9/divper/$link' target='_blank'>VIEW</a> ] [<a href='https://10.35.152.9/divper/_photoID.php?init_c=$init_c&del_sig=y&tempID=$tempID'>Delete</a>]";
			}
		else
			{
...
if($sel)
	...
	<FORM>
	<INPUT TYPE='button' name='submit' value='Clear Print List' onClick=\"parent.location='_photoID.php?sel=y'\">
	</FORM></td>";
	}
	else
	{$clear="";}
