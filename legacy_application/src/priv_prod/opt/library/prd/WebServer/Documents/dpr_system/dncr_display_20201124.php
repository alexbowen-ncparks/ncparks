...
// 	$line="<tr><td>$fld</td><td><input type='text' name=\"$fld\" value=\"$value\" size='84'></td></tr>";
	...
	$line="<tr><th colspan='2'> $value</th></tr>";
	}
	}
if($fld=="contact")
	{
...
// 	$line="<tr><td>$fld</td><td><input type='text' name=\"$fld\" value=\"$value\" size='84'></td></tr>";
	if ($pr) {
	$line="<tr><td></td><td><b>Contact:</b> $value</td></tr>";
	} else {
...
// 	$line="<tr><td>$fld</td><td><input type='text' name=\"$fld\" value=\"$value\" size='84'></td></tr>";
	if ($pr) {
	$line="<tr><td></td><td><b>Physical Address:</b> $value</b></td></tr>";
	} else {
...
// 	$line="<tr><td>Office Phone</td><td><input type='text' name=\"$fld\" value=\"$value\" size='84'></td></tr>";
	if ($pr) {
	$line="<tr><td></td><td><b>Office: </b>$value</td></tr>";
	} else {
...
// 	https://www.ncparks.gov/carolina-beach-state-park/home
	...
	if ($pr) {
	$line="<tr><td></td><td><b>URL: </b><a href='$value' target='_blank'>$value</a></td></tr>";
	} else {
...
if($fld=="Acquisition Date by State")
	...
	if(!empty($ARRAY[$fld]))
		{$value=$ARRAY[$fld];}
	if ($pr) {
	$line="<tr><td></td><td colspan='2'><b>Acquisition Date:</b> $value </td></tr>";
	} else {
...
// 	$line.="$value => <b>".number_format($value,0)."</b> acres";
	...
	$line.="<tr><td></td><td><b>Acres Comments and any Satellite Areas:</b> $var_ac</td></tr>";
...
// 		echo"v=$value";
	...
	$line="<tr><td colspan='2'><font color='green'>*$fld</font> = $total_fac</td></tr><tr><td></td><td><textarea name=\"$fld\" cols='123' rows='$num_rows'>$value</textarea></td></tr>";
		...
		if ($pr) {
	$line="<tr><td></td><td colspan='2'><b>Structures: </b>$total_fac $value</td></tr>";
	} else {
...
if($fld=="Description of Site")
	...
	if ($pr) {
	$line="<tr><td></td><td><b>Description of Site</b> $value</td></tr>";
	} else {
...
// 	$line="<tr><td>$fld</td><td><textarea name=\"$fld\" cols='123' rows='1'>$value</textarea></td></tr>";
	...
	if ($pr) {
	$line="<tr><td></td><td><b>Site Activities:</b> $value</b></td></tr>";
	} else {
...
if($fld=="Educational Services")
	...
	if ($pr) {
	$line="<tr><td></td><td><b>Educational Services:</b> $value</td></tr>";
	} else {
...
if($fld=="Outreach Efforts")
	...
	if ($pr) {
	$line="<tr><td></td><td><b>Outreach Efforts:</b> $value</td></tr>";
	} else {
...
if($fld=="Bond Project")
	...
	if ($pr) {	
	$line="<tr><td></td><td><b>Bond Project:</b> $value</td></tr>";
	} else {
...
// 	echo "<pre>"; print_r($park_year_attend['FALA']); echo "</pre>"; // exit;
	if(!empty($park_year_attend[$park_code]))
		...
		if ($pr) {
		$line="<tr><td></td><td><b>FY19-20 Visitation:</b>";
...
if($fld=="Admission Fees")
	...
	if(!empty($ARRAY[$fld]))
		{$value=$ARRAY[$fld];}
	if ($pr) {
	$line="<tr><td></td><td><b>Admission Fees</b> $value</td></tr>";
	} else {
...
if($fld=="Other Fees")
	...
	if ($pr) {
	$line="<tr><td></td><td><b>Other Fees:</b> $value</td></tr>";
	} else {
...
if($fld=="Hours of Operations")
	...
	if(!empty($ARRAY[$fld]))
		{$value=$ARRAY[$fld];}
	if ($pr) {
	$line="<tr><td></td><td><b>Hours of Operation: </b></td></tr><tr><td></td><td>".nl2br($value)."</td></tr>";
	} else {
...
// 	$line="<tr><td>$fld</td></tr><tr><td></td><td><textarea name=\"$fld\" cols='73' rows='4'>$value</textarea></td></tr>";
	...
	if ($pr) {
	$line="<tr><td></td><td colspan='3'><b>Positions as of November 2019 </b>Total=$tot_per</td></tr><tr><td></td><td>$temp</td></tr>";
	} else {
	$line="<tr><td colspan='2'><b><font color='green'>*$fld</font></b> (db=divper.BO149) Total=$tot_per</td></tr><tr><td></td><td>$temp</td></tr>";
	}
...
// 	$line="<tr><td colspan='5'><font color='green'>*$fld</font> (query in dpr_system/fiscal_year_budget.php)</td></tr><tr><td></td><td><textarea name=\"$fld\" cols='53' rows='3' $RO>$value</textarea></td></tr>";
	...
	if ($pr) {
	$line="<tr><td></td><td colspan='2'><b>Fiscal Year 2019-20</b></td></tr>
	<tr><td></td><td>
	<table>
...
// 	$num_hours=$value;
	...
	<tr><td>Valuation=$" . number_format($value_dollars, 2) . "<br />$24.72 per hr. for NC from <a href='https://independentsector.org/resource/vovt_details/'>https://independentsector.org/resource/vovt_details/</a></td></tr></table></td></tr>";
	} else {
...
// 	$value=$park_contact[$park_code]['office_hours'];
	if(!empty($ARRAY[$fld]))
		{$value=$ARRAY[$fld];}
	if ($pr) {
	$line="<tr><td></td><td><b>Future Needs: </b>$value</td></tr>";
	} else {
...
// 	$value=$park_contact[$park_code]['office_hours'];
	if(!empty($ARRAY[$fld]))
		{$value=$ARRAY[$fld];}
	if ($pr) {
	$line="<tr><td></td><td><b>Private Support:</b> $value</td></tr>";
	} else {
	$line="<tr><td><font color='green'>*$fld</font></td></tr><tr><td></td><td><textarea name=\"$fld\" cols='123' rows='4'>$value</textarea></td></tr>";
	}
	}
...
if($fld=="Restrictions or Limitations on the use of Site")
	...
	if ($pr) {
	$line="<tr><td></td><td><b>Restrictions or Limitations on the use of Site:</b> $value</td></tr>";
	} else {
...
if($fld=="Friends Group")
	...
	if ($pr) {
	$line="<tr><td></td><td><b>Friends Group:</b> $value</td></tr></table>";
	} else {
