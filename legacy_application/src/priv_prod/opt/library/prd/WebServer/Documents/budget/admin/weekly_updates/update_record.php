...
$query1="insert into cid_vendor_invoice_payments2 SET";
for($j=1;$j<6;$j++)
	{	
	if($invoice_number[$j] ==""){continue;}
	$query2=$query1;
		$query2.=" con='y',";
		$query2.=" con_reportperiod='$reporting_period',";
		$query2.=" con_location='$con_location',";
		$query2.=" con_num='$contract_number',";
		$query2.=" con_purpose='$con_purpose',";
		$query2.=" con_original='$con_original',";
		$query2.=" con_payments='$con_payments',";
		$query2.=" ncas_invoice_number='$invoice_number[$j]',";
		$query2.=" ncas_company='$company[$j]',";
		$query2.=" ncas_account='$account[$j]',";
		$query2.=" ncas_invoice_number='$invoice_number[$j]',";
		$query2.=" code_1099='$code_1099[$j]',";
		$query2.=" ncas_center='$center[$j]',";
		$query2.=" ncas_invoice_amount='$amount[$j]' ";
		//echo $query2;exit;
