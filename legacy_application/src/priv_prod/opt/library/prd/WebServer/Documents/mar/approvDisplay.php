...
if($level==5){
if($under_review=="x"){$ck="checked";}else{$ck="";}
$under_review="<input type='checkbox' name='under_review[$id]' value='x'$ck> $cN1 Under Review$cN2";
}else{
if($under_review=="x"){$under_review="<font color='purple'>[Item under review]</font>";}
}

$flagWeek="";
if($week>$previousWeek){$flagWeek="x";}// NEXT
if($week<$previousWeek){$flagWeek="y";}// PREVIOUS

if($week>"51" and $previousWeek=="1"){$flagWeek="y";}
...
if(!$noEdit){$title = "$park - <a href=\"#\"
onClick=\"window.open('update.php?id=$id&thisWeek=$thisWeek&s=$s','newWindow','height=600,width=825','scrollbars=yes','alwaysRaised=yes');\">$title</a>";}
else {$title=$park." - ".$title;}

if($flagWeek){
if($flagWeek=="x"){
$title = "<font color='red'>Entered for NEXT week's MAR?</font> ".$title;}
if($flagWeek=="y"){
$title = "<font color='orange'>Entered for a PREVIOUS week's MAR?</font> ".$title;}
}
             ...
             if (@$sectionC != $section)
                  ...
                  if(!isset($da)){$da="";}
                             ...
                             <td></td>
                               ...
                               <td><b>$title</b>&nbsp;&nbsp;&nbsp;Entered on: <font color='brown'>$dateEntered $under_review</font>&nbsp;&nbsp;&nbsp;$da<br>$xyz</td></tr></table>";
                                $sectionC = $section;
                                $distC = $dist;
                                $parkC = $park;
                                $counterOPE++;
...
$counterCON = 1;
                  if(!isset($da)){$da="";}
                  echo "<br><table cellpadding='2'><tr><td colspan='5'>$sectLong</td></tr>
                              <tr><td colspan='5'>$dist</td><tr>
 ...
 $counterADM = 1; 
 if(!isset($da)){$da="";}
 echo "<table cellpadding='2'><tr><td colspan='5'>$sectLong</td></tr>
                              <tr><td colspan='5'>$dist</td><tr>
                              <td></td><td valign='top' align='center'>$park</td>
...
<input type='submit' name='Submit' value='Checked Entries Reviewed'></td>
