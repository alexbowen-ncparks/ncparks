...
$query1="insert into wex_report(center,center_code,ncas_account,amount,month,calyear,valid,invoice_number,invoice_date,rebate_amount)
         select center,center_code,ncas_account,sum(net_cost) as 'amount',month,calyear,valid,invoice_number,invoice_date,rebate_amount
