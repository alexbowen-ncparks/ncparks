...
$query3="select cash_type,budget_group,gmp,
         ...
         from $table where 1 
		 and gmp='y'
		 group by budget_group order by budget_group desc ";
...
echo "<H1 ALIGN=left><font color=brown><i>GMP Budget Group Totals-Division</i></font></H1>";
echo "<H2 ALIGN=left><font color=brown><i>Budget Groups-$num3</i></font></H2>";
...
"<tr$t> 
           ...
           <td>$cash_type</td>
           <td><a href='reports_gmp_budget_group_summary_division_drill.php'>$budget_group</a></td> 	
           <td>$gmp</td> 	
           <td>$cy_amount</td> 
           <td>$py1_amount</td> 
           <td>$py2_amount</td> 
