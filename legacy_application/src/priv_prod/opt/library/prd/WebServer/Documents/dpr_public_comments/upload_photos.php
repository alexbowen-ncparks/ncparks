...
*/
	...
	if($error==0){
		...
		extract($_POST);
		$form_name="DPR_photo_".$proj_number."_".time();
		$e=explode(".",$_FILES['photos']['name']);
		$ext=array_pop($e);
		$file_name = $form_name.".".$ext;

//echo " $file_name"; exit;

		$uploaddir = "upload_photos"; // make sure www has r/w permissions on this folder
		...
		$sql="INSERT INTO upload_photos SET proj_id='$proj_id', proj_number='$proj_number', file_name='$name', link='$uploadfile' ";
