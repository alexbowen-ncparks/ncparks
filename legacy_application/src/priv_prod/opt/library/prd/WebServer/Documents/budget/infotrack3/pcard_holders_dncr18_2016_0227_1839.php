...
echo "<html><body>";
echo "<h2 align='center'>TABLE: $table</h2>";

include("style1.html");
echo "<table><tr><td><a href='pcard_holders_dncr18.php?add=y'>ADD Record</a></td></tr></table>"; 
//$skip_array=array("");
//$decimalFields=array("");
