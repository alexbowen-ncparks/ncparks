...
if($type=='add')
{
echo "<table ALIGN='center' ><tr><th><font color=brown></th><td><font $shade_add><a href='sspd1.php?menu_fa=fa1&type=add'>Add</a></font></td><td><font $shade_search><a href='sspd1.php?menu_fa=fa1&type=search'>Search</a></font></td></tr></table>";
echo "<br />";	
...
echo "<table  align='center'>";
	  ...
	  echo "<tr>";
	   ...
	   echo "<tr>";
	   echo "<th><font color='brown'>Document Description</font></th><td><input name='document_title' type='text' size='30' value='$document_title' id='document_title' autocomplete='off'></td>";
	   echo "</tr>";
...
{	
echo "<table ALIGN='center' ><tr><td><font $shade_add><a href='sspd1.php?menu_fa=fa1&type=add&menu=$menu'>Add</a></font></td><td><font $shade_search><a href='sspd1.php?menu_fa=fa1&type=search'>Search</a></font></td></tr></table>";
echo "<br />";	
...
echo "<table  align='center'>";
	  ...
	  echo "<tr>";
	   echo "<th><font color='brown'>FAS#</font></th><td><input name='fas_numS' type='text' size='10' value='$fas_num' id='fas_num' autocomplete='off'></td>";
	   echo "</tr>";
...
echo "<table ALIGN='center' ><tr><th><font color=brown><i>FAS#</font></i></th><td><font $shade_add><a href='sspd1.php?menu_fa=fa1&type=add&menu=$menu'>Add</a></font></td><td><font $shade_search><a href='sspd1.php?menu_fa=fa1&type=search&menu=$menu'>Search</a></font></td></tr></table>";
echo "<br />";	
...
$query1="select id,park,fas_num,fas_description,payment_source,source_id,document_location,sed,entered_by
         from fixed_assets where 1 and menu='$menu' ";		 
...
echo "<tr><th>Park</th><th>FAS#</th><th>Description</th><th>Payment</th><th>Document</th></tr>";
...
echo "<td><a href=sspd1.php?menu_fa=fa1&type=edit&id=$id>edit</a></td>";
if($id!=$idS)
{
echo "<td><a href=sspd1.php?menu_fa=fa1&type=search&fas_search=search&parkS=$parkS&fas_numS=$fas_numS&del=yes&idS=$id><img height='15' width='15' src='/budget/infotrack/icon_photos/mission_icon_photos_263.png' alt='red trash can' title='delete'></img></a></td>";
}
if($id==$idS)
{
echo "<td><font class='cartRow'><font color='red'>Delete Record?</font><br /><br /><table align='center' cellpadding='10'><tr$t><th><a href='sspd1.php?menu_fa_fa1&type=search&fas_search=search&parkS=$parkS&fas_numS=$fas_numS'>Yes</a></th><th><a href='sspd1.php?menu_fa_fa1&type=search&fas_search=search&parkS=$parkS&fas_numS=$fas_numS'>No</a></th></tr></table></font></td>";
...
echo "<table  align='center'>";
	   ...
	   */
	    echo "<tr>";
	   echo "<th><font color='brown'>FAS Description</font></th><td><textarea rows='1' cols='40' name='fas_description'>$fas_description</textarea></td>";
	   echo "</tr>";
