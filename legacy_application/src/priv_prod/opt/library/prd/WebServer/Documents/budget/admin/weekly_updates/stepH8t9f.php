...
$query13="insert into crj_posted2_v2(center,invoice,description,acct,amount,f_year,calyear,month,acctdate,
          description_f3,crj)
          select center,invoice,description,acct,amount,f_year,calyear,month,acctdate,description_f3,crj
          from crj_posted1_v2
