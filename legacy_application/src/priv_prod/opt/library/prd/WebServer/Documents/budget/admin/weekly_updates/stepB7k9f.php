...
(  `rcc` varchar( 4  )  NOT  NULL default  '',
 ...
 `OA1` varchar( 50  )  NOT  NULL ,
 `OA2` varchar( 50  )  NOT  NULL ,
 `email` varchar( 75  )  NOT  NULL ,
 `orms` char( 1  )  NOT  NULL default  'n',
 `bd_first3` varchar( 3  )  NOT  NULL ,
 `ceid` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `ceid`  ) ,
 UNIQUE  KEY  `center` (  `center`  ) ,
 KEY  `CenterMan` (  `CenterMan`  ) ,
 KEY  `fund` (  `fund`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
";
