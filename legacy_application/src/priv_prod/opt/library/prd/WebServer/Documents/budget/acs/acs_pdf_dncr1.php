...
// 		pdf_show_xy ($pdf, $text, $hor ,$line_y);
		...
		$xstart=30;
		$just=100;
		text_block($pdf,$text,30,$hor,$line_y,$xstart,$just);		
...
$ncas_account_f2=substr($ncas_account,0,2);
if($ncas_account_f2=='43')
{
$refund_comments="This is a refund to a customer.  Refunds to customers are a Pay Entity 46PN.
Please assign a dummy FID# and then pass back to AP for them to issue a check to the customer.
...
Tammy Dodd
DPR BUDGET OFFICER";	
$text="Refund Comments: ".$refund_comments;
text_block($pdf,$text,50,150,$line_y-65,200,0);
}
