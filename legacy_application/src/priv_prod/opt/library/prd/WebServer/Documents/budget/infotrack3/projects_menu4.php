...
$result4_players = mysqli_query($connection, $query4_players) or die ("Couldn't execute query 4_players.  $query4_players");
$num4_players=mysqli_num_rows($result4_players);
...
"<tr$t> 
           ...
           <td><a href='projects_menu4.php?folder=$folder&project_category=$project_category&category_selected=y&add_record=y'>$project_category</a></td> 
...
while ($row4_players=mysqli_fetch_array($result4_players)){
...
"<tr$t>"; 
  //echo "<td>$rank</td>";   
  echo "<td><a href='project1_menu4.php?folder=$folder&project_category=$project_category&category_selected=y&project_name=$project_name&name_selected=y&note_group=web&add_record=y'>$project_name</a></td> 
