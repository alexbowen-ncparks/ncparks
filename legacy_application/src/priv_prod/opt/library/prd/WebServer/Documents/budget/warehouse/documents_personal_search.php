...
$warehouse_location=$_SESSION['budget']['select'];
$warehouse_center=$_SESSION['budget']['centerSess'];
...
include("../../budget/~f_year.php");
if($beacnum !="60032793" and $beacnum != '60033009'){echo "<font color='red' size='5'>Message:"; print_r($_SESSION['budget']['tempID']);echo " does not have access to this report</font>";exit;}
echo "beacon_number:$beacnum";
echo "<br />";
echo "warehouse_location:$warehouse_location";
echo "<br />";
echo "warehouse_center:$warehouse_center";
echo "<br />";
...
"<tr$t>
		   ...
		   <td><a href='rename_document.php?&project_note_id=$project_note_id&search_term=$search_term' target='_blank'>rename</a></td>
