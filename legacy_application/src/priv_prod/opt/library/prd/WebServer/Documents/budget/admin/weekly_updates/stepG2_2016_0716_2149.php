...
$query2="insert into pcard_extract_worksheet (center,fund,acctdate,invoice,pe,description,debit,credit,sys,acct,f_year,dist,debit_credit,acct6,ciad,caa6,calendar_acctdate,extract_id)
select center,fund,acctdate,invoice,pe,description,debit,credit,sys,acct,f_year,dist,debit_credit,acct6,ciad,caa6,calendar_acctdate,id
from pcard_extract
