...
$query6="insert into cash_report_days_elapsed2(playstation,complete)
         SELECT park,count(id)  FROM `crs_tdrr_division_deposits` WHERE 1  and crj_days_elapsed <= '2' and download_date >= '20140702' and trans_table='y'
