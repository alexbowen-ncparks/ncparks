...
(  `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 ...
 `undeposited_amount` decimal( 12, 2  )  NOT  NULL ,
 `transaction_amount` decimal( 12, 2  )  NOT  NULL ,
 `end_bal` decimal( 12, 2  )  NOT  NULL ,
 `last_deposit` date NOT  NULL ,
 `days_elapsed` varchar( 10  )  NOT  NULL ,
 `undeposited_transdate_min` date NOT  NULL ,
 `undeposited_transdate_max` date NOT  NULL ,
 `days_elapsed2` varchar( 10  )  NOT  NULL ,
 `weekend` char( 1  )  NOT  NULL default  'n',
 `valid` char( 1  )  NOT  NULL default  'y',
 `compliance` char( 1  )  NOT  NULL default  'y',
 `exceptions` int( 11  )  NOT  NULL ,
 `justified` int( 11  )  NOT  NULL ,
 `pasu_comment` text NOT  NULL ,
 `pasu_player` varchar( 50  )  NOT  NULL ,
 `pasu_comment_date` date NOT  NULL ,
 `disu_comment` text NOT  NULL ,
 `disu_player` varchar( 50  )  NOT  NULL ,
 `disu_comment_date` date NOT  NULL ,
 `buof_comment` text NOT  NULL ,
 `buof_player` varchar( 50  )  NOT  NULL ,
 `buof_comment_date` date NOT  NULL ,
