...
$cabe_result = mysql_query($cabe_query) or die ("Couldn't execute cabe_query.  $cabe_query");
...
$result6c1 = mysql_query($query6c1) or die ("Couldn't execute query 6c1.  $query6c1"); 
...
$result6c2 = mysql_query($query6c2) or die ("Couldn't execute query 6c2.  $query6c2");
...
$result6c3 = mysql_query($query6c3) or die ("Couldn't execute query 6c3.  $query6c3");
...
$result6c4 = mysql_query($query6c4) or die ("Couldn't execute query 6c4.  $query6c4");
...
$result17j = mysql_query($query17j) or die ("Couldn't execute query 17j.  $query17j ");
...
$result18b = mysql_query($query18b) or die ("Couldn't execute query 18b.  $query18b ");



//echo "Update Successful line 197<br /><br />";  exit;
