...
$db="$today_date";
$ta="crs_tdrr_division_deposits_manual";
$ct=date("His");
//echo $ct;exit;
...
(  `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 ...
 `deposit_complete` char( 1  )  NOT  NULL default  'n',
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `manual_deposit_id` (  `manual_deposit_id`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
";
