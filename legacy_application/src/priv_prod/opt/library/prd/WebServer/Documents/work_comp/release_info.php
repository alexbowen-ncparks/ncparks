...
if(empty($show_wc_authorizaiton_upload) and empty($_POST['submit']))
	...
	if(!empty($error_message))
		...
		<form method='POST' action='release_info.php' enctype='multipart/form-data'>
...
echo "<page2>";
echo "<form action='release_info.php' method='POST'><table cellpadding='3'><tr>";
foreach($ARRAY AS $index=>$fld)
	{
...
You are on Step 7: WC Release of Information - <font color='red'>Click for Instructions</font></a><br />
