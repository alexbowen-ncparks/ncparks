...
$query2="truncate table budget.pcard_unreconciled_xtnd_temp;
";
mysqli_query($connection, $query2) or die ("Couldn't execute query 2. $query2");

$query3="truncate table budget.pcard_unreconciled_xtnd_temp2;
";
...
/*
$query3="truncate table budget.pcu1656;
";
mysqli_query($connection, $query3) or die ("Couldn't execute query 3. $query3");

$query4="truncate table budget.pcu1669;
";
