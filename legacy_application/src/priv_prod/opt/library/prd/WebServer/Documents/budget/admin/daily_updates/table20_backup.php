...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta20.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta20$ct`
SELECT *
FROM `budget`.`$ta20` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta20$ct` 
(
...
$query2a="select count(*) as 'record_count20' from `budget_daily_backup`.`$db$ta20$ct` ";
