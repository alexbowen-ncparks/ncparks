...
FROM $table
WHERE (user_id= '$myusername'or shared_users like '%$myusername%')
...
echo "<H2 ALIGN=left><font color=purple><i>Shared Notebooks-$num </i></font></H2>";
...
"<tr>"; 
echo "<th align=left><font color=brown>Sharer</font></th>";
...
echo " <th><font color=brown>rename</font></th>
   <th><font color=brown>Un-Share</font></th>";
...
//echo "share_provider=$share_provider";
...
"<tr$t>";
   ...
   if ($myusername==$share_provider){echo "<td><a href='rename_project.php?&project_category=$project_category&project_name=$project_name'>rename</a></td>";}
   if ($myusername==$share_provider){echo "<td><a href='unshare_project.php?&project_category=$project_category&project_name=$project_name&user_id=$user_id'>Un-share</a></td>";}
