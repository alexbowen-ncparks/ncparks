...
set t1.round2_selection=t2.favorite_qid
...
set t1.round2_selection_name=t2.quote_comment
where t1.round2_selection=t2.id ";
...
set t1.round2_score=t2.round_score
where t1.round2_selection=t2.id ";
...
if($total_score==6){$rank=1;echo "<tr bgcolor='lightgreen'>";}
if($total_score==4){$rank=4;echo "<tr bgcolor='orange'>";}
if($total_score==3){$rank=5;echo "<tr bgcolor='gold'>";}
if($total_score==1){$rank=7;echo "<tr bgcolor='lightyellow'>";}
if($total_score==0){$rank=17;echo "<tr bgcolor='lightpink'>";}
//echo "<tr>";
echo "<td>$rank</td>";
if($voter2!=$tempid2)
{
