...
$query12="delete from crj_posted9_v2 where f_year='$fiscal_year' ;";
//echo "query12=$query12";exit;
$result12=mysqli_query($connection, $query12) or die ("Couldn't execute query 12. $query12");


$query13="insert into crj_posted9_v2
(park,center,f_year,transdate_min,transdate_max,deposit_id,amount_park,amount_2751,amount_1000)
select
park,center,f_year,min(acctdate),max(acctdate),deposit_id,sum(amount_park),sum(amount_2751),sum(amount_1000)
from crj_posted8_v2
where f_year='$fiscal_year' 
group by park,center,f_year,deposit_id; ";
//echo "query13=$query13";echo "<br />";//exit;
$result13=mysqli_query($connection, $query13) or die ("Couldn't execute query 13. $query13");

$query14="update crj_posted9_v2
set amount_total=amount_park+amount_2751+amount_1000
where 1; ";
