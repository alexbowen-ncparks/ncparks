...
$query2="insert into project_approve_amount(source,projnum,divapp_amount,status_amount)
select 'div_app_amt',projnum,sum(div_app_amt) as 'divapp_amount',''
from partf_projects
where 1
and projyn='y'
and reportdisplay='y'
...
$query3="insert into project_approve_amount(source,projnum,divapp_amount,status_amount)
select 'status_amount',project,'',sum(fundsin-fundsout) as 'status_amount'
...
oob)
select project_approve_amount.projnum,partf_projects.park,partf_projects.projname,projcat,sum(divapp_amount) as 'table_partf_projects' ,sum(status_amount) as 'table_partf_fund_trans',sum(divapp_amount-status_amount) as 'OOB'
...
$query6a="
update report_projects_update_approve_amount,partf_projects
set report_projects_update_approve_amount.center=partf_projects.new_center
where report_projects_update_approve_amount.projnum=partf_projects.projnum 
";
...
$query6b="
update report_projects_update_approve_amount,partf_projects
set report_projects_update_approve_amount.old_center=partf_projects.old_center
where report_projects_update_approve_amount.projnum=partf_projects.projnum 
";
...
$query6="select center,old_center,projnum,park,projname,projcat,partf_projects_amt,partf_fund_trans_amt,oob,status
...
echo "<tr>"; 
 ...
 echo " <th><font color=blue>old center</font></th>";
