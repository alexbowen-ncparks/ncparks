...
$query5="
select receive_date2,ncas_invoice_date as 'invoice_date',ncas_invoice_number as 'invoice_trans_id',vendor_name,park,comments,account_description,ncas_invoice_amount as 'invoice_amount',pcard_yn from cvip_small_purchases
		 where 1
		 and f_year='$f_year'
		 and month_number='$month_number'
		 and valid = 'y'
...
$query14="
select receive_date2 as 'received',ncas_invoice_date as 'invoice date',ncas_invoice_number as 'invoice#',vendor_name as 'vendor',park,comments as 'description of items1',account_description as 'description of items2',ncas_invoice_amount as 'amount',pcard_yn as 'pcard purchase y/n' from cvip_small_purchases
		 where 1
		 and f_year='$f_year'
		 and month_number='$month_number'
		 and valid = 'y'
