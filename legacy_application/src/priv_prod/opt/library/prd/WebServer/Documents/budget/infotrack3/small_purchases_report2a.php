...
$result45b = mysqli_query($connection, $query45b) or die ("Couldn't execute query 45b.  $query45b");
...
$result46 = mysqli_query($connection, $query46) or die ("Couldn't execute query 46.  $query46");
