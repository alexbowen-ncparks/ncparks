...
$query13="insert into vmc_posted7_v2
(center,f_year,month,invoice,description,acct,day,acctdate,amount)
select center,f_year,month,invoice,description,acct,day,acctdate,sum(amount) as 'amount'
from vmc_posted1_v2
where f_year='$fiscal_year' 
and acctdate >= '$start_date' and acctdate <= '$end_date'
group by center,f_year,month,invoice,description,acct,acctdate; ";
//echo "query13=$query13";echo "<br />";exit;
$result13=mysqli_query($connection, $query13) or die ("Couldn't execute query 13. $query13");


$query16="update vmc_posted7_v2,center
set vmc_posted7_v2.park=center.parkcode
where vmc_posted7_v2.center=center.center
