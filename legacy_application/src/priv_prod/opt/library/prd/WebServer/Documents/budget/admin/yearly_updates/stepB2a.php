...
if($gid != '')
{
$query3="select gid,f_year,score_month,score_value,completion_date_begin,completion_date_end
         from scoring_rules where gid='$gid' ";
...
//$c=1;
echo "<th align=left><font color=brown>GID</font></th>";
echo "<th align=left><font color=brown>FYear</font></th>";
echo "<th align=left><font color=brown>Score Month</font></th>";
echo "<th align=center><font color=brown>Score Value</font></th>"; 
echo "<th align=left><font color=brown>Completion Date Begin</font></th>"; 
echo "<th align=left><font color=brown>Completion Date End</font></th>"; 
echo "</tr>";
...
"<tr$t>"; 
echo "<td>$gid</td><td>$f_year</td><td>$score_month</td><td>$score_value</td><td>$completion_date_begin</td><td>$completion_date_end</td>";
