...
echo "<table><tr><th><img height='25' width='25' src='/budget/infotrack/icon_photos/bank.jpg' alt='picture of bank'></img><font color='brown'></b>Bank Deposit CRJ Approval Report </font>(Daily)-<font color='green'>$center_location</font></b></th></tr></table>";
...
$query5="select park,center,location,fyear,sum(authorized) as 'authorized',sum(jul) as 'jul',
sum(aug) as 'aug',sum(sep) as 'sep',sum(oct) as 'oct',sum(nov) as 'nov',sum(dece) as 'dece',sum(jan) as 'jan',sum(feb) as 'feb',sum(mar) as 'mar',sum(apr) as 'apr',sum(may) as 'may',sum(jun) as 'jun',sum(total) as 'total'
from cash_imprest_count
where 1
and fyear='$fyear' 
...
"<tr$t>";
     ...
     echo "<td><a href=''>$park</a></td>
           ...
           <td>$f_year</td>		   
           <td>$authorized</td>		   
           <td><input type='text' size='10' name='jul[]' value='$jul'</td>		   
           <td><input type='text' size='10' name='aug[]' value='$aug'</td>		   
