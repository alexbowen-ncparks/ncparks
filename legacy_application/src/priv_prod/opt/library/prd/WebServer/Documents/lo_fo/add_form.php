...
echo "<form action='add_form.php' name='lo_fo_form' method='POST' enctype='multipart/form-data' >";
...
var frmvalidator  = new Validator("lo_fo_form");
  frmvalidator.addValidation("park_code","req","Please enter the Park Code");
