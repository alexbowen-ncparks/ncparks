...
$query2="insert into exp_rev_ws(center,new_center,old_center,acctdate,invoice,pe,description,debit,credit,sys,acct,f_year)
select center,new_center,old_center,'1680',post_date,invoice_new,'','warehouse',pricexquantity,'','wa',acct,f_year
