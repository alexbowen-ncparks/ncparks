...
//Added 2022-07-20 TBASS-TIC399  
echo "report_date=$report_date";

$query_fyear_split="select cy as 'fyear_split' from fiscal_year where '$report_date' >= start_date and '$report_date' <= end_date ";
...
//Added 2022-07-20 TBASS-TIC399   "and mid(transdate_new,1,4) >= '$report_date_year'"  to restrict Query to Current Calenda
...
and mid(transdate_new,1,4) >= '$report_date_year';
 ";
