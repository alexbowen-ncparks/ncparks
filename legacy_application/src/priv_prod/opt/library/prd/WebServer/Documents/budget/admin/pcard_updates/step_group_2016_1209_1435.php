...
echo "<table><tr><th><i>$project_name</i></th></tr></table>";
...
"<form>";
echo "<font size=5>"; 
echo "<H5 align='left'><font color='red'>Pcard Unreconciled Count:</font><input name='pcu_count' type='text' value='$pcu_count' readonly='readonly' size='5'></H3>";
echo "<br />";
echo "</form>";
}
//echo "<br /><br />";
...
include("../../infotrack/scoring/scoreG7.php");
