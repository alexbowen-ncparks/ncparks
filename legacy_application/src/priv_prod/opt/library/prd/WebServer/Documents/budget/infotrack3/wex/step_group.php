...
echo "<tr>";
echo "<th><font color='brown'>Monthly<br />$project_name</font></th>";
echo "<th><a href='step_group.php?fyear=$fyear&report_type=vehicles'>Fuel<br />Verification</a><br />$report_vehicles </th>";
echo "<th><a href='step_group.php?fyear=$fyear&report_type=reports'>Code<br />Sheets</a><br />$report_reports </th>";
echo "<th><a href='step_group.php?fyear=$fyear&report_type=form&reset=y'>Update<br />Form</a><br />$report_form</th>";
echo "</tr>";
echo "</table>";
...
include("vehicles.php");// database connection parameters
...
echo "<br />";
/* the project_steps_detail database holds all the instructions */
...
$result4a = mysqli_query($connection, $query4a) or die ("Couldn't execute query 4a total.  $query4a ");	
...
$result4b = mysqli_query($connection, $query4b) or die ("Couldn't execute query 4b total.  $query4b ");	
*/
...
$result4c = mysqli_query($connection, $query4c) or die ("Couldn't execute query 4c total.  $query4c ");
...
$result4d = mysqli_query($connection, $query4d) or die ("Couldn't execute query 4d total.  $query4d ");	
...
$result4e = mysqli_query($connection, $query4e) or die ("Couldn't execute query 4e total.  $query4e ");
...
$result4f = mysqli_query($connection, $query4f) or die ("Couldn't execute query 4f total.  $query4f ");
