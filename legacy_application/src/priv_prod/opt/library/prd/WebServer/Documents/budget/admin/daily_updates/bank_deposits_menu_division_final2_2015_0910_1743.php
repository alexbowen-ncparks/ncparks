...
echo "<table><tr><th>CRS Deposits: $num11</th></tr></table>";
...
echo "<br />";
echo "<table><tr><th><font color='brown'>Upload CSV File for $header_message</font></th></tr><tr><th><font>(a)Browse for File (b)click: Upload CSV File</th></tr></table><br /></font>";
...
{
echo "<br /><table><tr><th><font color='brown'>ALL CSV Files have been uploaded</font><img height='20' width='20' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of green check mark'></img></th></tr></table><br /><br />";
