...
datemod,
blank_field)
SELECT '','','','',fund,sum(credit),'','',description,'','','','',acct,'','','','','','',acctdate,f_year,'',''
FROM exp_rev
WHERE 1
and credit > '0' 
and acctdate >= '$start_date2'
and acctdate <= '$end_date2'
and fund != '1280'
and fund != '2802'
and fund != '2803'
and fund != '1680'
and (acct not like '531%' 
and acct not like '532%'
and acct not like '533%'
and acct not like '534%'
and acct not like '535%' )
group by whid
