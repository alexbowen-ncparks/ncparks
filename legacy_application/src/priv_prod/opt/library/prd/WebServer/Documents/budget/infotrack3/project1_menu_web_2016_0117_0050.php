...
<a href='project1_menu.php?comment=y&add_comment=y&folder=community&project_category=$project_category&category_selected=y&project_name=$project_name&name_selected=y&note_group=$note_group&project_note_id=$project_note_id&im=y'><b>ON&nbsp;&nbsp;</b></a>
*/
echo "<a href='project1_menu.php?comment=y&add_comment=y&folder=community&project_category=$project_category&category_selected=y&project_name=$project_name&name_selected=y&note_group=$note_group&project_note_id=$project_note_id&im=n&edit=y'><b>EDIT Comments&nbsp;&nbsp;</b></a>
";
...
$query = "select user,project_note,comment_note,weblink,note_group,project_note_id as 'project_note_id2' from infotrack_projects_community4 where 1 and project_category='$project_category' and project_name='$project_name' and note_group='$note_group' and comment_id='$project_note_id' and valid_record='y' order by project_note_id asc ";	
...
if($table_bg2==''){$table_bg2='burlywood';}
	...
	$display_string .= "<td><a href='project1_menu.php?comment=y&add_comment=y&folder=community&project_category=$project_category&category_selected=y&project_name=$project_name&name_selected=y&note_group=$note_group&project_note_id=$project_note_id&im=n&edit=y&delrec=$edit_record'>D</font></td>";
	$display_string .= "<form><td><input type='text' value='$comment_note'><input type='hidden' name='project_note_id' id='project_note_id' value='$project_note_id'></td>";
	$display_string .= "<td><input type='hidden' name='project_note_id' id='project_note_id' value='$project_note_id'><input type='submit' value='Save'</td></form>";
	$display_string .= "</tr>";
