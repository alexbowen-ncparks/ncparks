...
if(empty($submit))
	...
	<body>";
$file_array=array("bd725_dpr_temp.csv", "beacon_payments_temp.csv", "cab_dpr_center_temp.csv", "cab_dpr_temp.csv", "exp_rev_down_temp.csv","exp_rev_down_fund1000_temp.csv", "pcard_utility_xtnd_1646_ws_temp.csv","pcard_utility_xtnd_1656_ws_temp.csv","pcard_utility_xtnd_1669_ws_temp.csv", "warehouse_billings_2_temp.csv", "xtnd_po_encumbrances_temp.csv","xtnd_vendor_payments_temp.csv","xtnd_vendor_payments_tax_temp.csv","pcu1656.csv","pcu1669.csv","fixed_assets1.csv");
