...
echo "<form name='form1' method='post' action='edit_record_update.php'>";
...
echo "<table border=1>";
	   ...
	   echo "<tr><td><font color='blue'>project_category</font></td><td><input type='text' name='project_category' value='$project_category' ></td></tr>";
	   echo "<tr><td><font color='blue'>project_name</font></td><td><input type='text' name='project_name' value='$project_name'></td></tr>";
