...
if ($submit == "Add File")
	...
	$folder = "position_desc_files/cover_sheet";
	if (!file_exists($folder)) {mkdir ($folder, 0777);}
...
//	echo "$uploadfile";exit;
	...
	$sql = "REPLACE position_cover_pdf set beacon_num='$beacon_num', form_name='$form_name', beacon_title='$beacon_title', file_link='$uploadfile'";
	//  echo "$sql";exit;
