...
//	echo "<pre>";print_r($_POST);echo "</pre>"; exit;
	...
	for($i=0;$i<count($arrayTransID);$i++)
		...
		if($check1616Center!="1280" AND $check1616Center!="2803" and $check1616Center!="2801" and $check1616Center!="1680" and $check1616Center!="1685"){$center[$id]="INCORRECT";$m=1;}
		}
...
// Budget Office Staff(Dodd-Budget Officer-60032781,Gooding-PCARD Administrator-60032997,Bass-Accounting Specialist-60032793) can use Administrator Tool in MoneyCounts to restrict
...
//echo "<br />pcard_report_type=$pcard_report_type<br />";
	if($report_type==""){
		if($level<3)
			...
			{
			$header="<tr><th>admin #</th><th>card<br>holder</th><th>pcard number</th><th>location</th><th>transid<br />transdate</th>
			<th>vendor&nbsp;name</th><th>amount</th><th>item purchased</th><th>ncasnum</th><th>ncas_description</th><th>center</th><th>projnum</th><th>equipnum</th><th>Invoice</th>";
			}
