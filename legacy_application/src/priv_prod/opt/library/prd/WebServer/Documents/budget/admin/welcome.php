...
//echo "username=";echo $username;exit;
$table="projects";
...
from $table
WHERE 1 and (user_id='$tempid' or shared_users like '%$tempid%')
...
echo "<H1 ALIGN=left><font color=brown><i>ProjectManager: $tempid &nbsp&nbsp Level($level) </i></font></H1>";
...
/*if(($level=='5')){ 
	   ...
	   echo "<font size=4><b><A href='welcome_admin.php'>Administrator</b></A></font>";
	   echo "<br />";
...
*/
echo "<br /><br />";
echo "<H2 ALIGN=left><font size=4><b><A href=/budget/menu.php?forum=blank> Return HOME </A></font></H2>";
...
echo "<br /><br />";
echo "<font size=4><b><A href='project_share_add.php'>Shared Projects-$num8</A></b></font>";
