...
function showUser(str) {
  ...
  xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
      document.getElementById(<?php $txtHint="txtHint".$id; echo "$txtHint"; ?>).innerHTML=xmlhttp.responseText;
    }
  }
...
<br>
<div id=<?php $txtHint="txtHint".$id; echo "$txtHint"; ?>><b><?php $person="person for ".$id; echo "$person";?></b></div>
