...
$query1="SELECT park,center,orms_deposit_id,orms_depositor,id
...
echo "<th align='left'><font color='brown'>orms_depositor</font></th>"; 
...
if($c==''){$t=" bgcolor='$table_bg2' ";$c=1;}else{$t='';$c='';}
 ...
 echo "<tr class=\"normal\" id=\"row$id\" onclick=\"onRow(this.id)\">";	 
     ...
     // echo "<td><input type='text' name='orms_deposit_id[]' value='$orms_deposit_id' size='10' readonly='readonly' ></td>";
        ...
        echo "<td><input type='text' name='orms_depositor[]' value='$orms_depositor' size='25' ></td>";
