...
//echo "<br />filepath=$file_path";//exit;	
        ...
        mysqli_query($connection, "TRUNCATE TABLE `exp_rev_down_temp` ") or die(mysqli_error()); 
...
$sql="INSERT INTO exp_rev_down_temp 
...
header("location: import_csv_form_exp_rev_down_temp?upload=y");
