...
$database="budget";
$db="budget";
$table="pcard_holders_dncr2";   //**CHANGE for New TABLE**
$filename="table.php";
...
//$decimalFields=array("");
$skip_array=array("employee");   //**CHANGE for New TABLE**
$primaryField="id";      //**CHANGE for New TABLE**
...
if($order_by==''){$order_by='admin_num';}   //**CHANGE for New TABLE**
