...
<tr>
<td>
<img src="favorite_sitcom_option6.png"
width='<?php echo(300*round($option6/($option1+$option2+$option3+$option4+$option5+$option6),2)); ?>'
height='35'>
<?php echo(100*round($option6/($option1+$option2+$option3+$option4+$option5+$option6),2)); echo "%"; ?>
</td>
</tr>
