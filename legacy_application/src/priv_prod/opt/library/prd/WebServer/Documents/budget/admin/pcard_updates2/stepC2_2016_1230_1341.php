...
where 1; ";
$result1g = mysql_query($query1g) or die ("Couldn't execute query 1g.  $query1g");

$query1h="update pcard_works
set report_date='20161221'
where 1; ";
$result1h = mysql_query($query1h) or die ("Couldn't execute query 1h.  $query1h");
...
where location='1656';
 ";
$result1j = mysql_query($query1j) or die ("Couldn't execute query 1j.  $query1j");
...
where location='1669';
 ";
$result1k = mysql_query($query1k) or die ("Couldn't execute query 1k.  $query1k");
...
and pcard_holders_dncr2.center != 'none' ;
 ";
$result1m = mysql_query($query1m) or die ("Couldn't execute query 1m.  $query1m");
...
where pcard_works.account_id=pcard_holders_dncr2.pcard_num ; ";
$result1n = mysql_query($query1n) or die ("Couldn't execute query 1n.  $query1n");


$query1p="update pcard_works
set admin_num='sodi',center='1680531'
where admin_num='nodi' ; ";
$result1p = mysql_query($query1p) or die ("Couldn't execute query 1p.  $query1p");
