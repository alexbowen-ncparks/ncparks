...
$query="select back_date_yn,fiscal_year,start_date,end_date from project_steps_mode where project_category='$project_category' and project_name='$project_name' ";
...
$query1a="update project_steps set fiscal_year='$fiscal_year',start_date='$start_date',end_date='$end_date',back_date_yn='$back_date_yn' where project_category='$project_category' and project_name='$project_name' ";
$result1a = mysqli_query($connection, $query1a) or die ("Couldn't execute query 1a.  $query1a");


$query1b="update project_steps_detail set fiscal_year='$fiscal_year',start_date='$start_date',end_date='$end_date',back_date_yn='$back_date_yn' where project_category='$project_category' and project_name='$project_name' ";
...
$query0="update table_menu2 set backup='n'
         where project_category='fms' and project_name='weekly_updates' and project_group='D' ";
...
$query="SELECT table_name,backup,id FROM `table_menu2`
        WHERE  project_category='fms' and project_name='weekly_updates' and project_group='D' and backup='n' 
...
echo "<tr><td colspan='3'><a href='stepC0.php?mark_complete=y&project_category=$project_category&project_name=$project_name&step_group=$step_group&step_num=$step_num&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date'>Mark Complete</a></td></tr>";
echo "</table>";
...
echo "<br />";
echo "<table align='center' border='1'><tr><td><a href='step_group.php?fyear=&report_type=form&reset=y'>Return to Weekly Updates</a></td></tr></table>";
