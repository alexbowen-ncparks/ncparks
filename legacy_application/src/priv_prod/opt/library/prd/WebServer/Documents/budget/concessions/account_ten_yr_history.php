...
$query3="select account,account_description,budget_group,cash_type,gmp,
...
// 2022-08-12: CCOOPER - excel?
if($rep=="excel"){
header('Content-Type: application/vnd.ms-excel');
header('Content-Disposition: attachment; filename=current_year_budget.xls');
}
// 2022-08-12: End CCOOPER
echo "<table><tr><td>Accounts:<font color='red'> $num3 </font></td></tr></table>";
...
"<tr$t>"; 
	...
	//echo "<td><a href='budget_group_three_yr_history_accounts.php?report=$report&section=$section&district=$district&accounts=$accounts&history=$history&period=$period&budget_group=$budget_group'>$account</a></td>";
	
	     echo "<td><a href='budget_group_five_yr_history_account_centers.php?report=$report&section=$section&district=$district&history=$history&period=$period&budget_group=$budget_group&account=$account'>$account</a></td>
