...
$db="$today_date";
$ta22="crs_tdrr_division_deposits_manual";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta22.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta22$ct`
SELECT *
FROM `budget`.`$ta22` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta22$ct` 
(
...
$query2a="select count(*) as 'record_count22' from `budget_daily_backup`.`$db$ta22$ct` ";
