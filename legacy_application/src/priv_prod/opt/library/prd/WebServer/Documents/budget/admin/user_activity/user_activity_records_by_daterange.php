...
extract($_REQUEST);
if($tempid2=="")$tempid2=$_SESSION['budget']['tempID'];
$today=date("Ymd");
//echo $today;exit;
...
echo "<H2 ALIGN=center><font size=4><b><A href=/budget/admin/user_activity/user_activity_summary_by_daterange> User Activity-HOME </A></font></H2>";

echo "<br />";

echo "<table border=1>";
echo "<tr><td><H3><font color=blue>Current View:</font> <font color=red>User_Activity_records_by_daterange</font></H3></td></tr>";
echo "<tr><td></td></tr>";
//echo "<tr><td>Other Views</td></tr>";
	 
//echo "<tr><td><A href=/budget/admin/user_activity/user_activity_summary_by_daterange.php> User Activity Summary by Daterange </A></td></tr>";
...
//////mysql_close();
	...
	echo"<form method=post action=user_activity_records_by_daterange.php>";
	 echo "<table border=1>";
	 echo "<tr><td>start_date</td><td>end_date</td><td>tempid</td></tr>";
	 echo "<tr>";

echo"<td><input type='text' name='start_date' value='$start_date'>";
echo"<td><input type='text' name='end_date' value='$end_date'>";
echo"<td><input type='text' name='tempid2' value='$tempid2'>";
...
//if($start_date != '' and $end_date != '' and $tempid != '') {
/*$query2="select count(id) as 'pages_used' from activity where 1 and 
time2>='$start_date' and time2<= '$end_date' and tempid='$tempid2'
group by id";
...
$query3="SELECT tempid, user_level, location, filename as 'page',time1,id
FROM `activity`
WHERE 1 and time2>='$start_date' and time2<='$end_date' and tempid='$tempid2'
group by page,time1
order by time1 desc";
...
echo "<br />";
echo "<font color='red'>Pages Used: $num3</font>";
/*echo "<tr>"; 
...
"<tr> 
       ...
       <th><font color=blue>page</font></th>
       <th><font color=blue>time1</font></th>
