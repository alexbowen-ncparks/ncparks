...
$sql="select 'dprcoe', t2.ann_100, t2. park
from dprcoe.event as t2
where t2.dateE = '$pass_edit' and ann_100='x'
order by t2.ann_100, park
"; //echo "$sql";
...
if(empty($geArray))
	{echo "No 100th events entered for $pass_edit. You may close this window."; exit;}
