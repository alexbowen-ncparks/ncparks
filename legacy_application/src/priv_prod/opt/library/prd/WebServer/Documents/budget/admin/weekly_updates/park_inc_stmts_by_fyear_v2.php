...
//////////echo "<font color='brown'>query5=$query5<br /><br />Query 5 from PHP: <br /><b>park_inc_stmts_by_fyear_v2.php (Line: 146)</b></font>";	 
...
echo "<br /><br />query6=$query6<br /><br /><font color='brown'>Query 6 from PHP: <br /><b>park_inc_stmts_by_fyear_v2.php (Line: 182)</b></font>";	 
...
// get district for each Park User
...
/*
$query5="SELECT parkcode, center,center_description,f_year, SUM( disburse_amt ) AS  'expenditures', SUM( receipt_amt ) AS  'receipts',sum(disburse_target)/2 as 'disburse_target',sum(receipt_target)/2 as 'receipt_target', ROUND( (
(
SUM( receipt_amt ) / SUM( disburse_amt ) ) *1
), 0
) AS  'receipt_percent'
FROM report_budget_history_inc_stmt_by_fyear_pfr
WHERE f_year =  '$fyear'
...
$query5="SELECT parkcode, center,center_description,f_year, SUM( disburse_amt ) AS  'expenditures', SUM( receipt_amt ) AS  'receipts',sum(disburse_target) as 'disburse_target',sum(receipt_target) as 'receipt_target', ROUND( (
(
SUM( receipt_amt ) / SUM( disburse_amt ) ) *10000
), 0
) AS  'receipt_percent'
...
//12/7/19
//Accounting Specialist or Budget Officer or Concessions Manager. 
if($beacnum=='60032793' or $beacnum=='60032781' or $beacnum=='60033162')
{
//echo "<br />hello line 551<br />";
//if($fyear=='1920') removed hardcoding.  The if statement below should only run if $fyear=$cy    $cy is established via previous Include of File=inc_stmt_by_fyear_head1_v2.php   (bass 12/9/19)
//echo "<br />cy=$cy<br />";
if($fyear==$cy)
{
echo "<br />";	
echo "<table align='center'><tr><td><a href='pfr_set_tentative_budget.php?fyear=$fyear'>SET Tentative Budget</a></td></tr></table>";
echo "<br />";
}
}	
...
/*
if($f_year != '1819')
{$disburse_target='not_available';$receipt_target='not_available';$receipt_percent_target='not_available';$disburse_total='not_available';$receipt_total='not_available';$receipt_to_expenditures_total_target='not_available';}
*/
...
//echo "<td>$profit_remaining2</td>";	                      
//echo "<td>$receipt_percent</td>";	                      
//echo "<td>$profit_progress_percent2</td>";	                      
