...
$query = "select user,project_note,comment_note,weblink,note_group,project_note_id as 'project_note_id2' from infotrack_projects_community3 where 1 and project_category='$project_category' and project_name='$project_name' and note_group='$note_group' and comment_id='$project_note_id' order by project_note_id desc ";		 
//echo "query=$query<br />";		 
...
if($table_bg2==''){$table_bg2='cornsilk';}
	...
	$display_string .= "<td><font color='brown'>$row[user]</font></td>";	$display_string .= "<td><font color='brown'>$row[project_note_id2]</font></td>";	
