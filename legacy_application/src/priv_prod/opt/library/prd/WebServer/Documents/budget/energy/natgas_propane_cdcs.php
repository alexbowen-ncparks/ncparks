...
$query3a="select max(system_entry_date) as 'last_update', max(cvip_id) as 'last_cdcs' from energy1 where ncas_account='532220' ";
...
echo "<form method='post' action='natgas_propane_cdcs_import.php?f_year=$f_year&egroup=$egroup&report=$report&valid_account=$valid_account&last_cdcs=$last_cdcs'>";
...
echo "</tr>";
echo  "<form method='post' autocomplete='off' action='natgas_propane_cdcs_update.php'>";
...
//These individual variables are the names of the fields queried from MySQL
extract($row3);
if($ncas_account=='532220'){$egroup='natgas_propane';}
