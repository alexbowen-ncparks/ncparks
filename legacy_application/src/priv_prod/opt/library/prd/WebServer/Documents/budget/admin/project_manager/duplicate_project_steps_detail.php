...
echo "<form name='form1' method='post' action='duplicate_project_steps_detail_insert.php'>";
...
echo "<table border=1>";
	   ...
	   echo "<tr><td><font color='red'>step_group_name</td></font><td><input type='text' name='step' ></td></tr>";
	   ...
	   echo "<tr><td><font color='blue'>statuslink</td></font><td><input type='text' name='link' ></td></tr>";
