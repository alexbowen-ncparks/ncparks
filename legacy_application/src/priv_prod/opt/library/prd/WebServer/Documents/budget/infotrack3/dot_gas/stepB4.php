...
$query14m="update dot_gas_detail
         set user_id='$tempid2'
		 where 1
         and valid='n' ";
...
$query14n="update dot_gas_detail
           set system_entry_date='$system_entry_date',prepared_date='$prepared_date',prepared_by='$prepared_by',received_by='$received_by'
           where 1
           and valid='n'  ";
...
$query14r="update dot_gas_detail
...
$query14s="update dot_gas_detail
...
$query14t="update dot_gas_detail
           set ncas_invoice_amount=bill_amount+admin_fee_allocation,invoice_total=bill_amount+admin_fee_allocation 
           where 1
           and valid='n'  ";
...
(prefix,ncas_number,ncas_account,ncas_budget_code,prepared_by,prepared_date,comments,ncas_company,ncas_invoice_date,datesql,system_entry_date,
 due_date,ncas_invoice_number,ncas_invoice_amount,invoice_total,ncas_remit_code,vendor_name,vendor_address, pay_entity,vendor_number,group_number,user_id,parkcode,ncas_fund,ncas_rcc,ncas_center,received_by,approved_by,energy_group,energy_subgroup,cdcs_uom,energy_quantity)
 ...
 due_date,ncas_invoice_number,sum(ncas_invoice_amount),sum(invoice_total),ncas_remit_code,vendor_name,vendor_address, pay_entity,vendor_number,group_number,user_id,parkcode,ncas_fund,ncas_rcc,ncas_center,received_by,approved_by,energy_group,energy_subgroup,cdcs_uom,sum(energy_quantity)
 from dot_gas_detail
 where 1
 and valid='n'
