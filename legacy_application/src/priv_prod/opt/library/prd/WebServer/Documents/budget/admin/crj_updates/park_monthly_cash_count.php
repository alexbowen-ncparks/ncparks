...
"<tr$t>";
     ...
     echo "<td><a href='park_posted_deposits_drilldown1_v2.php?f_year=$f_year&park=$park&center=$center'>$park</a></td>
           <td>$center</td>		   
           <td>$f_year</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$jul'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$aug'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$sep'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$oct'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$nov'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$dece'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$jan'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$feb'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$mar'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$apr'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$may'</td>		   
           <td><input type='text' size='10' name='proj_out[]' value='$jun'</td>		   
