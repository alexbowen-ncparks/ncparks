...
echo "<table><tr valign='top'><th colspan='2' valign='top'>DNCR Request FY1920</th><td>";
...
echo "</select></form></td>";
//<td><a href='missing.php' target='_blank'>Missing Key Facts</a></td>";
if(!empty($park_code))
	{
...
echo "<td>Items in <font color='green'>green</font> are to be included in report.</td></tr></table>";
...
echo "<table>";
echo "<tr><td><font color='green'>*Photo</font><br />";
if($level>4)
	{
	echo "<a href='https://auth1.dpr.ncparks.gov/photos/search.php?parkC=$park_code&cat=Scenic&source=photos' target='_blank'>The ID</a>";
	}
echo "</td><td><img src='$photo_link' width='1024'><br />Photo Link:
