...
where 1 $where
order by t1.wc_approved, t1.timestamp, t1.park_code
";
...
echo "<table border='1' cellpadding='3'><tr><td colspan='16' bgcolor='beige'>Workers' Comp Review</td></tr>";
foreach($ARRAY AS $index=>$array)
	...
	if($index==0)
		...
		foreach($ARRAY[0] AS $fld=>$value)
			...
			if($fld=="wc_approved"){$rename="entered into Corvel";}
