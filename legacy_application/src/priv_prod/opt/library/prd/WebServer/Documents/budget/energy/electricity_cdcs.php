...
echo "<td><input type='submit' name='submit' value='search'></td><td><a href='electricity_cdcs_park_summary.php?num3=$num3&f_year=$f_year' >Summary by Park</a></td>";
echo "</form>";
...
echo  "<td>$ncas_invoice_number<br />";
echo "$datesql2 ($invoice_month$date_sql_year)<br />$system_entry_date<br />";
if($account_number!='')
{
echo "<a href='/budget/energy/energy_reporting.php?f_year=$f_year&center_codeS=$center_code&new_center=$ncas_center&egroup=$egroup&vendor_name2=$vendor_name&account_number=$account_number&report=accounts&energy1_id=$id'>$account_number</a>";
}

if($account_number=='')
{
echo "<a href='/budget/energy/energy_reporting.php?f_year=$f_year&center_codeS=$center_code&new_center=$ncas_center&egroup=$egroup&vendor_name2=$vendor_name&account_number=$ncas_invoice_number&report=accounts&energy1_id=$id'>$ncas_invoice_number</a>";
}
...
echo  "<td><input type='text' size='20' name='num3[]' value='$num3' readonly='readonly'></td>";
echo  "<td><input type='text' size='5' readonly='readonly' name='f_year[]' value='$f_year'></td>";
*/
...
echo "<input type='text' name='num3' value='$num3'>";
echo "<input type='text' name='center_code' value='$center_code'>";
echo "<input type='submit' name='submit2' value='Update'>";
echo "<br />Line 402:num3=$num3<br /></td>";
echo "</tr>";
}
*/
