...
$query3="select account,account_description,cash_type,gmp,
		 ...
		 and postdate >='$range_start'
		 and postdate <='$range_end'		 
		 group by account ";
/*		 
if($level=='5' and $tempID !='Dodd3454')
...
$query3="select account,account_description,cash_type,gmp,sum(year1) as 'year1',sum(year2) as 'year2',sum(year2-year1) as 'difference'
