...
AND datenew <=  
'$end_date'
and center.section='design_development'
...
echo  "<td>$invoice</td>";
echo  "<td><a href='stepJ91_update.php?&xtid=$xtid&proj_num=$proj_num&center=$center&account=$account&project_category=$project_category&project_name=$project_name&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date&step_group=$step_group&step=$step&step_num=$step_num&submit=contract_info_lookup' target='_blank'>$amount</a></td>";
echo  "<td>$proj_num</td>";
echo  "<td>$datenew</td>";
echo  "<td>$xtid</td>";
...
echo "<form method=post action=stepJ91_mark_complete.php>";	  
