...
echo "<H2 ALIGN=center><font size=4><b><A href=/budget/admin/user_activity/main.php?project_category=fms&project_name=user_activity> Return User Activiy-HOME </A></font></H2>";
...
"<tr$t>";	
	...
	echo "<td align='center'>$step_num</td>
 	...
 	echo "<td><form method='post' action='status_change.php'>
			  ...
			  <input type='submit' name='submit2' value='EditRecord-$cid'
			  </form>
