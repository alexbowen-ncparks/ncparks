...
//echo "<table><tr><td><font color=brown class='cartRow'>Procedures</font></td></tr></table>";
echo "<table><tr><td bgcolor='darkseagreen'><img height='50' width='50' src='/budget/infotrack/icon_photos/property_photos_45.png' alt='picture of blue light bulb'></img></td></tr></table>";
if($level=='5')
{
echo "<table>";
echo "<tr>";
...
echo "<td><a href='bright_idea_score1.php?comment=y&add_comment=y&folder=community&pid=$pid'>$procedure_name</a></td>"; 
...
$query4a="select procedure_name,procedure_document from procedures where pid='$pid' ";
...
echo "<table>";
echo "<tr>";
echo "<td><font color=brown class='cartRow'><a href='bright_idea_score1.php?folder=community&menu=1'>Procedures</a></font></td>";
echo "</tr>";
echo "</table>";
*/
echo "<table><tr><td bgcolor='darkseagreen'><img height='50' width='50' src='/budget/infotrack/icon_photos/property_photos_45.png' alt='picture of blue light bulb'></img></td><th>Score</th></tr></table>";
echo "<br />";
?>
...
if($level=='5')
{
echo "<td><a href='bright_idea_score1.php?comment=y&add_comment=y&folder=community&pid=$pid&editP=y'>Edit</a></font></td>";
/*
if($pid=='12'){
echo "pid=$pid";
...
echo "<table border='1'><td><a href='bright_idea_score1.php?comment=y&add_comment=y&folder=community&pid=$pid><font color='brown' $shade_comment>Comments</font></a></td>";
...
echo "<td><a href='bright_idea_score1.php?comment=y&add_comment=y&folder=community&pid=$pid&show_order=newest'><font size='3' $shade_newest>Newest on top</font></a></td>";
echo "<td><a href='bright_idea_score1.php?comment=y&add_comment=y&folder=community&pid=$pid&show_order=oldest'><font size='3' $shade_oldest>Newest on bottom</font></a></td>";
