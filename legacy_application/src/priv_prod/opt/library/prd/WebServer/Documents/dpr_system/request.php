...
$sql="SELECT distinct park_code from survey_2013 where pasu_approve='yes'";
$result = mysqli_query($connection,$sql);
while($row=mysqli_fetch_assoc($result))
	{
...
$exclude_unit=array("EADI","NODI","SODI","WEDI","RUBA","SCRI","WARE","WOED");
...
if($level>2)
	{
	echo "Export for <a href='request_word.php?park_code=$park_code&nophoto=' target='_blank'>Printing w/photo</a>";
	echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='request_word.php?park_code=$park_code&nophoto=1' target='_blank'>Printing wo/photo</a>";
	}
	else
	{echo "Export for <a href='request_word.php?park_code=$park_code' target='_blank'>Printing</a>";}
