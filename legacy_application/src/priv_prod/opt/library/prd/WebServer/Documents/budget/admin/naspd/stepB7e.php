...
$query0="delete from bd725_dpr_exp_rec_projects where f_year='$fiscal_year' ";
...
$query1="insert into bd725_dpr_exp_rec_projects
(center,projnum,projname,projcat,projyn,f_year)
select center,projnum,projname,projcat,projyn,'$fiscal_year'
from partf_projects
