...
echo "<td>Project: <input type='radio' name='report_type' value='project' checked></td>";
echo "</tr>";
...
//row2
echo "<tr>";
echo "<th><font color='brown'>Category</font></th>";


if($ci=='yes'){$ck_ci="checked";}
echo "<td></td><td>CI<input type=checkbox name='ci' value='yes' $ck_ci</td>"; 

if($de=='yes'){$ck_de="checked";}
echo "<td>DE<input type=checkbox name='de' value='yes' $ck_de</td>";

if($er=='yes'){$ck_er="checked";}
echo "<td>ER<input type=checkbox name='er' value='yes' $ck_er</td>";

if($la=='yes'){$ck_la="checked";}
echo "<td>LA<input type=checkbox name='la' value='yes' $ck_la</td>";

if($mi=='yes'){$ck_mi="checked";}
echo "<td>MI<input type=checkbox name='mi' value='yes' $ck_mi</td>";

if($mm=='yes'){$ck_mm="checked";}
echo "<td>MM<input type=checkbox name='mm' value='yes' $ck_mm</td>";

if($tm=='yes'){$ck_tm="checked";}
echo "<td>TM<input type=checkbox name='tm' value='yes' $ck_tm</td>";
