...
if(empty($submit))
	...
	<body>";
$file_array=array("bd725_dpr_temp.txt", "beacon_payments_temp.txt", "cab_dpr_center_temp.txt", "cab_dpr_temp.txt", "exp_rev_down_temp.txt","exp_rev_down_fund1000_temp.txt", "pcard_utility_xtnd_1646_ws_temp.txt","pcard_utility_xtnd_1656_ws_temp.txt","pcard_utility_xtnd_1669_ws_temp.txt", "warehouse_billings_2_temp.txt", "xtnd_po_encumbrances_temp.txt","xtnd_vendor_payments_temp.txt","xtnd_vendor_payments_tax_temp.txt","pcu1656.txt","pcu1669.txt","fixed_assets1.txt");
	
	echo "<form method=post action=test_upload.php enctype='multipart/form-data'>";
...
echo "<H3 ALIGN=left><A href='/budget/admin/weekly_updates/stepD1c.php?status=complete'>Return to Weekly Updates </A></H3>";
echo "<table>";

echo "<tr><td><A href='/budget/admin/pcard_updates/step_group.php?project_category=fms&project_name=pcard_updates&step_group=L'>Return to PCARD Updates</a></td></tr>";

echo "<tr><td><A href='/budget/admin/fixed_asset_updates/step_group.php?project_category=fms&project_name=fixed_asset_updates&step_group=M'>Return to Fixed Asset Updates</a></td></tr>";
