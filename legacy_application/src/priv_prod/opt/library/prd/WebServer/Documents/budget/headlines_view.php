...
$query1="update mission_headlines set message='$messageS' where hid='$hidS2'";
...
$query5="SELECT *
FROM $table
WHERE 1 and ((date = '$today') or (hid='$hidS'))
and weekend='n'
order by date desc ";
}
...
echo "<table><tr><th>Headline History</th></tr></table>";
...
"<tr>"; 
  ...
  echo "<th align=left><font color=brown>hid</font></th>";
  echo "<th align=left><font color=brown>Date</font></th>";
  echo "<th align=left><font color=brown>Headline Message</font></th>";
...
$deposit_date_dow=date('l',strtotime($date));
...
if($hidS=='')
{	
	  echo "<td><a href='headlines_view.php?hidS=$hid'>$hid</td>";	 
     echo "<td align='center'>&nbsp;$deposit_date_dow<br />$date2</td>";
	 echo "<td><form>$message</form></td>";	
...
{	
	  echo "<td><a href='headlines_view.php?hidS=$hid'>$hid</td>";	 
     echo "<td align='center'>&nbsp;$deposit_date_dow<br />$date2</td>";
     echo "<td><form method='post' action='headlines_view.php'><textarea rows='4' cols='50' name='messageS'>$message</textarea><input type='hidden' name='hidS2' value='$hid'><input type='submit' name='submit' value='update'></form></td>";	   
}
