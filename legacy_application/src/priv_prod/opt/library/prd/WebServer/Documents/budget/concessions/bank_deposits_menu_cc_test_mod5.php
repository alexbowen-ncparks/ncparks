...
$query25a="insert into crs_taxes1(center,taxbal)
select revenue_location_id,sum(amount) from crs_tdrr_cc_import
where (revenue_code='434410004' and (revenue_location_id='12802854' or revenue_location_id='12802856'))
or
((revenue_code='000434420' or revenue_code='434150004'
or revenue_code='434140003') and product_name != 'fuel-gasoline')
group by revenue_location_id;
";		   
...
$oob_total=number_format($oob_total,2);
 ...
 {echo "<br />";  echo "<table border=1><tr><th>DepositID</th><th> $deposit_id</th></tr><tr><th>Tax Adjustments</th><th>$oob_total</th></table>";}
 {echo "<form  method='post' autocomplete='off' action='bank_deposits_menu_cc_test.php'>";
  echo "<br />"; 
  echo "<table><tr><th>Step4: Pass Tax Adjustments to 434410003-campsite rentals</th>
...
"<tr> 
       ...
       <th align=left><font color=brown>Tax Adjustment</font></th>
