...
echo "<table><tr><th><font color='brown' size='5'>New Survey</font></th></tr></table>";
echo "<br />";
...
echo "<th>SurveyName<br><input type=\"text\" name=\"game\" value=\"$game\" size=\"50\" autocomplete=\"off\"></th>";

echo "<th align=\"center\">#questions <br><input type=\"text\" name=\"questionC\" value=\"$questionC\" size='3' autocomplete=\"off\"></th>";

echo "<th><input type='submit' name='submit' value='Show_Form'>";
echo "</form>";
echo "</th>";
...
$rec2add=$questionC;
$query1a="insert into survey_games set pid='$pid',game_name='$game2',qcount='$rec2add',author='$player' ";
$result1a = mysqli_query($connection, $query1a) or die ("Couldn't execute query 1a. $query1a");
//echo "query1a=$query1a";

$query1b="select max(gid) as 'gid' from survey_games where pid='$pid' ";
...
echo "<table><tr><th>SurveyName:<font class='cartRow'> $game</font></th></tr></table>";echo "<br />";
...
echo "<tr><th align='center'>line</th><th align='center'>Question</th><th align='center'>Example<br />Answer</th>";

//echo "<th>Answer1</th><th>Answer2</th><th>Answer3</th><th>Answer4</th>";

echo "</tr>";
for($i=1;$i<=$questionC;$i++){
echo "<tr>";
echo "<th align=\"center\">$i</th>";
echo "<th align=\"center\"><textarea name=\"question[$i]\" rows=\"4\" cols=\"30\">$question</textarea></th>";
echo "<th align=\"center\"><textarea name=\"example_answer[$i]\" rows=\"4\" cols=\"30\">$example_answer</textarea></th>";
/*
...
$game_encode=urlencode($game);
   ...
   <td><input type='hidden' name='questionC' value='$questionC'></td>
