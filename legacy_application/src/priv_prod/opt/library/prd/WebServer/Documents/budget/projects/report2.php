...
$query4a="update cid_fund_balances as t1,center as t2 set t1.section=t2.section,t1.f_year_funded=t2.f_year_funded,t1.center_description=t2.center_desc where t1.center=t2.new_center and t2.new_center != '' ";
//echo "<br />Line 40: query4a=$query4a<br />";			 
$result4a = mysqli_query($connection, $query4a) or die ("Couldn't execute query 4a.  $query4a");
 
 
$query4b="update cid_fund_balances as t1,center as t2 set t1.section=t2.section,t1.f_year_funded=t2.f_year_funded,t1.center_description=t2.center_desc where t1.center=t2.center and t2.new_center = '' ";
//echo "<br />Line 40: query4b=$query4b<br />";			 
...
//added 7/22/22-TBASS
$where3=$where3." and center != '2235' ";
}

if($fiscal_year_start!='' and $fiscal_year_end!='')
{
$where3=$where2." and f_year_funded >= '$fiscal_year_start' and f_year_funded <= '$fiscal_year_end' and center != '2235' ";
}

//echo "<br />where3=$where3<br />";
//echo "<br />where4=$where4<br />";
//$where4=" and park=cabe ";
...
$query5="SELECT center, upper(concat_ws('_',center,center_description,f_year_funded)) as center_num_name_year, sum( fundsin - fundsout )  AS  'funds_allocated', sum( payments )  AS  'expenses', sum( fundsin - fundsout - payments )  AS  'balance'
         FROM cid_fund_balances
         $where3 $where4
         GROUP  BY center
		 order by f_year_funded,center";		 
		 
		 
		 
		 
//echo "<br />Line 128:query5=$query5<br />";
...
echo "<th align=center><font color=brown>Budget</font></th>"; 
