...
echo "<table><tr><th><img height='25' width='25' src='/budget/infotrack/icon_photos/feedback1.png' alt='picture of bank'></img><font color='brown'><b>Surveys-</b></font><font color='green'><b>$center_location</b></font></th></tr></table>";
...
//if($level=='5')
//{
 echo "<td align='center'><font size=4 color=brown >Survey</font></td>";
 //}      
...
echo "<br />record_complete=$record_complete<br />";
...
if($level==5)
{
$query3a="SELECT survey_scores.playstation,survey_scores.player as 'player2', survey_scores.qid, survey_scores.question, survey_scores.park_answer
FROM survey_scores
...
if($level==5)
{
echo "<td>$playstation<br />$player3</td> ";
}
echo "<td>$question</td> ";
