...
if($level=='5')
{
include("../../budget/infotrack/slide_toggle_procedures_module2_pid93.php");
}
*/
...
//beacnum=60032781=Budget Officer=Tammy Dodd (temporary fix to allow Budget Officer to see Pcard Reconcilement for Report Date 20200521 before the rest of the division. (5/22/20 AM. removed 5/22/20 PM).
// Menu 1
...
if(@$report_date)
	...
	</form></td><td>$fund_1680</td><td>$fund_ci</td>";
	}
echo "</tr></table><hr>";
}// end else Print
?>