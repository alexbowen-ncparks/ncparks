...
$query2="insert into cash_handling_roles
         set first_name='$first_name',last_name='$last_name',tempid='$tempid',beacnum='$beacnum',role='$role',park='$park',sig_scale='.30',role_change_by='$manager_name',role_change_date='$system_entry_date' ";
...
if($sig_count==0)
{echo "<table align='center'><tr><td><font color='brown' size='5'><br />Oops: User ID <b>$tempid</b> can not be added as Cashier (Signature not on File).<br /><br /> ADD Employee Signature via FORM  <a href='/budget/infotrack/position_reports/position_report_125.doc'>HERE</a> (Instructions on Form)<br /></font></td>";
exit;
} 
...
if($cashier_role=="yes"){echo "<font color='brown' size='5'>Oops: $tempid can not be added as Cashier, because $tempid is already listed as Cashier.  Click Browser Back Button to Return to Form<br /><br/>"; exit;}
...
if($manager_role=="yes"){echo "<font color='brown' size='5'>Oops: $tempid can not be added as Cashier, because $tempid is currently in Role of Manager. User can not be in both Roles. <br />If you would like to add $tempid into Role of Cashier, you must first remove from Manager Role<br />Click Browser Back Button to Return to Form<br />"; exit;}



	
$query3="insert into cash_handling_roles
         set first_name='$first_name',last_name='$last_name',tempid='$tempid',beacnum='$beacnum',role='$role',park='$park',sig_scale='.20',role_change_by='$manager_name',role_change_date='$system_entry_date'
		  ";
