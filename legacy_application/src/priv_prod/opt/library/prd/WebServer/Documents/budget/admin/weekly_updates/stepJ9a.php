...
echo "</tr>";
echo  "<form method='post' action='stepJ9a_update_all.php'>";
//exit;
...
echo  "<td><input type='text' size='25' readonly='readonly' name='section[]' value='$section'</td>";
...
echo  "<td><input type='text' size='25' readonly='readonly' name='invoice[]' value='$invoice'</td>";
echo  "<td><input type='text' size='10' readonly='readonly' name='amount[]' value='$amount'</td>";
echo  "<td><input type='text' size='25' readonly='readonly' name='vendorname[]' value='$vendorname'</td>";
echo  "<td><input type='text' size='15' readonly='readonly' name='datenew[]' value='$datenew'</td>";
echo  "<td><input type='text' size='5'  readonly='readonly' name='proj_num[]' value='$proj_num'</td>";
echo  "<td><input type='text' size='5'  readonly='readonly' name='charg_proj_num[]' value='$charg_proj_num'</td>";
...
echo  "<td><input type='text' size='5' readonly='readonly' name='contract_num[]' value='$contract_num'</td>";
echo  "<td><input type='text' size='10' readonly='readonly' name='contract_amt[]' value='$contract_amount'</td>";
echo  "<td><input type='text' size='5' readonly='readonly' name='xtid[]' value='$xtid'</td>";
echo  "<td><input type='text' size='5' readonly='readonly' name='record_complete[]' value='$record_complete'</td>";
