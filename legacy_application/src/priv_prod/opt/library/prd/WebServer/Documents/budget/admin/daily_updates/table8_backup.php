...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta8.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta8$ct`
SELECT *
FROM `budget`.`$ta8` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta8$ct` 
(
...
$query2a="select count(*) as 'record_count8' from `budget_daily_backup`.`$db$ta8$ct` ";
