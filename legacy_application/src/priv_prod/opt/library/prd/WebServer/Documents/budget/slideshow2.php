...
$query4="select mission_icon_photos.photo_location,mission_icon_photos.comments,mission_icon_photos.comments2
         from slideshow2
...
echo "<tr>";
echo "<th align='center'><img src='$Photo_location[$j]'  width='750' height='500' title='$Comments2[$j]' /><br />$Comments[$j]</th>";
...
echo "<td>
<form method='post' action='slideshow2.php'>";
