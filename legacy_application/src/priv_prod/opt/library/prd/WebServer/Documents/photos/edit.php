...
$result = @mysql_query($sql, $connection);
	$park_code_array['ARCH']='ARCH';
	$park_code_array['BUOF']='Budget Office';
...
//	echo "$sql";
	...
	if($public_hide){$publicCKED="checked";}
	...
	if(!isset($publicCKED)){$publicCKED="";}
	if(!isset($cd)){$cd="";}
	...
	Hide from Public: <input type='checkbox' name='public_hide' value='x' $publicCKED>
	 <br>
...
if ($submit == "Submit any Edit") 
	...
	if(!isset($public_hide)){$public_hide="";}

	$sql = "UPDATE images set sciName='$sciName',majorGroup='$majorGroup',cat='$category',subcat='$subcategory',photoname='$photoname',cd='$cd',date='$datePhoto',photog='$photog',comment='$comment',park='$park',personID='$personID',website='$website',sys_plan='$sys_plan' ,lat='$lat' ,lon='$lon' ,fire_gallery='$fire_gallery' ,public_hide='$public_hide' 
	where pid='$pid'";
