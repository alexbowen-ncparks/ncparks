...
$query1="truncate table energy_532230_water_meters;
";

$result1=mysqli_query($connection, $query1) or die ("Couldn't execute query 1.  $query1");


$query2="insert into energy_532230_water_meters(division,ncas_center,centerpark,utility_account_number,building_name,address,city,vendor_name)
...
$query3="update energy_532230_water_meters
