...
//$query="SELECT * FROM $table WHERE 1 order by parkcode";
$query="SELECT flags.fid, flag.flag, flag.referee, flag.team, flags.pid, flags.player, flags.pinit, flags.pintime
FROM flags
LEFT JOIN flag ON flags.fid = flag.id
WHERE flag.team =  'somo'";
...
echo "<tr><td><font color='red'>$num records<br /></font></td></tr>";
echo "<tr>";
