...
xtnd_rundate,date_purchased_new,primary_account_holder,trans_id,date_posted_new,report_date,center,company,last_name,first_name,report_date
...
"<tr$t>	      
	   ...
	   <td>$id</td>
	   <td><form action='pcard_lookup.php'><input type='submit' name='submit' value='Add'><input type='hidden' name='insert_id' value='$id'></form></td>
