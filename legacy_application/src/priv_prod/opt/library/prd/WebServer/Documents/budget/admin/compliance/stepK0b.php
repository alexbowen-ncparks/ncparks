...
$query3b="update energy1 as t1,energy_report_electricity_accounts as t2 
          set t1.account_number=t2.electricity_account_number
          where t1.ncas_invoice_number like concat('%',t2.electricity_account_number,'%') and t1.ncas_account='532210' and t1.parkcode=t2.park and t1.f_year='$cy' and t2.f_year='$cy'";
		  
echo "<br />Line 218: query3b=$query3b<br />";
//exit;
