...
$query3a="select scores.qid,questions.question,questions.a,questions.b,questions.c,questions.d,questions.fyi,
...
$fyi=htmlspecialchars_decode($fyi);
...
//echo "<td>$qid</td>";
echo "<td><font color='red'>$question</font><br /><br />$fyi</td>";
if($beacnum != '60032793')
{
...
//echo "query3a=$query3a"; echo "hello line 358";//exit;
}
...
left join games on scores.gid=games.gid
left join players on scores.pid=players.pid
where 1 and scores.gid='$gidS' and valid_record='y'
group by scores.pid,scores.sid
order by scores.sed desc,games.game_name asc,players.player asc; ";
...
<a href='questions.php' 'target=_blank'>Create Game</a>
</th>";
echo "</tr></table>";
}	
...
echo "<tr>"; 
echo "<th>Game</th>";
if($level==5 or $beacnum == '60036015' or $one_game_score=='y')
{
echo "<th>Player</th>";
}       
echo "<th>Score</th>";
...
if($level>'0'){echo "<td><a href=\"score_hide.php?sid=$sid&pid=$pid&one_game_score=y&gidS=$gidS\" onClick='return confirmLink()'>Remove</a></td>";}

if($level>'0' and $posted=='n'){echo "<td><a href=\"score_post.php?sid=$sid&pid=$pid&gid=$gid&score=$score&one_game_score=y&gidS=$gidS\" onClick='return confirmLink2()'>Approve</a></td>";}
