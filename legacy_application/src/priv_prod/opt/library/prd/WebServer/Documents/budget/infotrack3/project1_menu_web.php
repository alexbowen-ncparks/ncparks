...
echo "<table>";
echo "<tr>";
echo "<th><font color='brown'>Meeting<br />Name</font></th><th><font color='brown'>Meeting<br />Link</font></th><th>";
//echo "<font color='brown'>Embed Address</font></th>";
echo "</tr>";

//echo "<td></td>";
echo "<form method=post action=article_add2.php>";
echo "<tr>";
echo "<td><textarea name= 'project_note' rows='4' cols='40' ></textarea></td>            
      <td><textarea name= 'web_address' rows='4' cols='40'></textarea></td>";
     // echo "<td><textarea name= 'embed_address' rows='8' cols='20'></textarea></td>";
	  ...
	  if($folder=='community'){echo "<td><input type=submit name=submit value=Add_Meeting></td>";}
echo "</tr>";	  
...
if($embed_address=='')
{echo "<br /><br /><font color='brown' class='cartRow'>$project_note</font> <br /><iframe width='900' height='700' src='$weblink' frameborder='0' allowfullscreen></iframe>";
}
...
function ajaxFunction3(){
	...
	ajaxRequest.open("GET", "ajax_example_output3.php" + queryString1 , true);
	ajaxRequest.send(null); 
...
if($im=='y'){echo "setInterval(ajaxFunction3,10000);";}
?>
...
//echo "<table><tr><td>TonyBa</td></tr></table>";
echo "<div id='ajaxDiv3'></div>";
echo "<br />";
...
echo "<table>";
echo "<tr>";
echo "<td>Instant Messenger</td>";
echo "<td><a href='project1_menu.php?comment=y&add_comment=y&folder=community&project_category=$project_category&category_selected=y&project_name=$project_name&name_selected=y&note_group=$note_group&project_note_id=$project_note_id&im=y'>";
if($im=='y')
{
echo "<font class='cartRow'><b>ON&nbsp;&nbsp;</b></font>";
}
else
{
echo "<b>ON&nbsp;&nbsp;</b>";
...
echo "<td><a href='project1_menu.php?comment=y&add_comment=y&folder=community&project_category=$project_category&category_selected=y&project_name=$project_name&name_selected=y&note_group=$note_group&project_note_id=$project_note_id&im=n'>";
if($im=='n')
{
echo "<font class='cartRow'><b>OFF&nbsp;&nbsp;</b></font>";
}
else
{
echo "<b>OFF&nbsp;&nbsp;</b>";
...
if($im=='n')
{
echo "<form method='post' action='conference_comment_add.php'>";
//echo "Name: <input type='text' id='comment_note2' />"; 
echo "$myusername Comment: <textarea rows='6' cols='40' name='comment_note' id='comment_note2'></textarea>"; 
...
//	 echo "<input type='hidden' name='folder' value='$folder'>";	   
	 ...
	 echo "<input type='hidden' name='project_note_id' id='project_note_id' value='$project_note_id'>";	
//echo "Name: <input type='hidden' id='project_category' />"; 
echo "<input type='submit'  value='Add_Record' />";
//echo "<input type='button' onclick='submitForm()' value='Reset' />";
...
$delete_rec_result = mysqli_query($connection, $delete_rec) or die ("Couldn't execute query delete_rec.  $delete_rec ");
...
$update_rec_result = mysqli_query($connection, $update_rec) or die ("Couldn't execute query update_rec.  $update_rec ");
}
...
echo " line 335<br /> query=$query<br />";
