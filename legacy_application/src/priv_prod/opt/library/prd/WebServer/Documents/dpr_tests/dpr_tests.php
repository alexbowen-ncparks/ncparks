...
//print_r($_REQUEST);
echo "The DPR Online Test has has been taken offline. Contact database.support@ncparks.gov.";  exit;
...
$sql = "SELECT $dbName as level,emplist.tempID,t2.park_reg as park,accessPark,t2.working_title_reg as working_title, concat(t3.Fname,' ',t3.Mname,' ',t3.Lname) as full_name, t2.beacon_num
FROM emplist 
...
if($num<1)
	{
	$sql = "SELECT $dbName as level,nondpr.currPark as park,nondpr.Fname,nondpr.Lname
	FROM nondpr 
