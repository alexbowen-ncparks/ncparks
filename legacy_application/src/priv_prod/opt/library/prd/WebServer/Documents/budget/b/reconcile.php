...
echo "</tr>";
echo "<tr><td colspan='6' align='right'><a href='/budget/admin/weekly_updates/step_group.php?project_category=fms&project_name=weekly_updates&step_group=C'>Return Home</a></td></tr>";
