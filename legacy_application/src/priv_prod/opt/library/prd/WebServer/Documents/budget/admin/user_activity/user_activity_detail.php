...
echo "<table border=1>";
echo "<tr><td><H3><font color=blue>Current View:</font> <font color=red>User_Activity_by_level</font></H3></td></tr>";
echo "<tr><td></td></tr>";
echo "<tr><td>Other Views</td></tr>";
	 
echo "<tr><td><A href=/budget/admin/user_activity/user_activity_detail_day.php>User_Activity_by_Day</A></td></tr>";
echo "<tr><td><A href=/budget/admin/user_activity/user_activity_summary_by_daterange.php>User_Activity_Summary_by_Daterange</A></td></tr>";
...
//////mysql_close();
	...
	// echo "</table>";
	 echo "<table border=1>";
	 echo "<tr>";
echo"<td><form method=post action=user_activity_detail.php>";
echo "<font size=5>"; 

$query4="select distinct (user_level) as user_level_menu from activity where 1 
order by user_level asc";
$result4= mysqli_query($connection, $query4) or die ("Couldn't execute query 4. $query4");
$countRecords=mysqli_num_rows($result4);
//echo $countRecords;exit;
while ($row4=mysqli_fetch_array($result4)){
extract($row4);$menuArray[]=$user_level_menu;}

echo "<td align='center'>User_Level<br><select name=\"user_level\"><option selected></option>";
for ($n=0;$n<count($menuArray);$n++){
if($user_level==$menuArray[$n] and $user_level!=""){$s="selected";}else{$s="value";}
$con=$menuArray[$n];
...
if($user_level !="")
{
$query3="SELECT * FROM activity where 1 and user_level='$user_level' 
order by user_level asc,tempid asc,id desc";
