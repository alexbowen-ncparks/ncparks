...
$table="project_documents_community";
//echo "<pre>";print_r($_REQUEST);"</pre>";//exit;
...
echo "<form method=post action=documents_community_search.php>";
...
echo "<tr bgcolor='yellow'><th align=left><A href='documents_menu_community.php'>Community</A></th>
...
echo "<form method=post action=documents_menu_community.php>";
...
"<tr$t> 
           ...
           <td><a href='documents_community_edit.php?&project_category=$project_category&category_selected=y'>$project_category</a></td> 
...
//echo "<th align=left><A href='articles_community_edit.php'>Download from Community</A></th><th><A href='article_add.php?&add_your_own=y'>Add your own</A></th>";
echo "<tr><th align=left><A href='documents_community_edit.php'>Community</A></th></tr>";
...
"<tr$t>
		   ...
		   <td><a href='rename_document.php?&project_note_id=$project_note_id' target='_blank'>rename</a></td>
		   <td><a href='copy_document.php?&project_note_id=$project_note_id&project_category=$project_category' target='_blank'>share</a></td> 
		   <td><a href='delete_document_verify.php?&project_note_id=$project_note_id' target='_blank'>delete</a></td>
