...
$source_table="menu_add_records1";
...
$query1="insert into menu_add_records1
...
$query2="update menu_add_records1,center
         set menu_add_records1.center=center.center
		 where menu_add_records1.park=center.parkcode; ";
...
header("location: menu_add_records1.php?add_your_own=y&message=update_successful");
