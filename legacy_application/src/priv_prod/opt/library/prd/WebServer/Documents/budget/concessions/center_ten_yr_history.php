...
"<tr$t>"; 
        ...
        // echo "<td><a href='reports_one_budget_group_summary_by_center.php?budget_group=$budget_group'>$budget_group</a></td>"; 
		 echo "<td><a href='center_ten_yr_history_budget_groups.php?report=$report&section=$section&district=$district&accounts=$accounts&history=$history&period=$period&parkcode=$parkcode'>$parkcode</a></td> 
           <td>$section</td> 	
           <td>$district</td> 	
           <td>$cy_amount</td> 
           <td>$py1_amount</td> 
