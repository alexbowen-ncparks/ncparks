...
echo "<table><tr><th><img height='25' width='25' src='/budget/infotrack/icon_photos/bank.jpg' alt='picture of bank'></img><font color='brown'></b>Bank Deposit Compliance Report (Daily)-$center_location</b></font></th></tr></table>";
...
"<tr$t>";
     ...
     echo "<td>$park</td>		   
		   ...
		   echo "<input type=submit name=submit value=PASU_Update></form>";
		    ...
		    if($compliance=='n' and $pasu_comment!='')
		   {echo "$pasu_comment_date<br />$pasu_player2";echo "<img height='25' width='25' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of green check mark'></img><br />$pasu_comment";}
