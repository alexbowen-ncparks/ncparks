...
$db="$today_date";
$ta17="infotrack_projects_community_com";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta17.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta17$ct`
SELECT *
FROM `budget`.`$ta17` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta17$ct` 
(
...
$query2a="select count(*) as 'record_count17' from `budget_daily_backup`.`$db$ta17$ct` ";
