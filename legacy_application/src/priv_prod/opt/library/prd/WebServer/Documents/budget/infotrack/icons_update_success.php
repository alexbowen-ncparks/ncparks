...
$source_table="mission_icon_success";
...
$query1="insert into mission_icon_success
...
$query3="select max(id) as 'maxid'
         from mission_icon_success where 1 ; ";
...
$query="update mission_icon_success set photo_location='$target2'
where id='$maxid' ";
...
header("location: icons_success.php");
