...
select center,mid(deposit_id,1,8),min(transdate_new),max(transdate_new),deposit_date_new,sum(amount),'$system_entry_date'
from crs_tdrr_division_history
where 1
and deposit_transaction = 'y'
and deposit_id != 'none'
group by mid(deposit_id,1,8) "; 
...
if($num24!=0)
*/	
header("location: bank_deposits_menu_division.php?menu_id=a&menu_selected=y&step=1");
