...
extract($row11a);
 ...
 $query12="SELECT reimbursement_rate
...
$administrative_fee=number_format($gas_cost*.12,2);
 ...
 */
 ...
 //echo "<tr><td></td><td></td><td>Total Gallons</td><td>$gallons_total</td></tr>";
  ...
  echo "<tr><td></td><td></td><td><font color='brown' class='cartRow2'>Gas Rate</td><td>$reimbursement_rate</td></tr>";
 echo "<tr><td></td><td></td><td><font color='brown' class='cartRow2'>Gas Cost</td><td>$gas_cost</td></tr>";
 echo "<tr><td></td><td></td><td><font color='brown' class='cartRow2'>Administrative Fee</td><td>$administrative_fee</td></tr>";
 echo "<tr><td></td><td></td><td><font color='brown' class='cartRow2'>Refund Total</td><td>$refund_total</td></tr>";
 echo "</table>";
