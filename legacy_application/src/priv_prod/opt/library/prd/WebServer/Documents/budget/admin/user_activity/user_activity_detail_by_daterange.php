...
echo "<H2 ALIGN=center><font size=4><b><A href=/budget/admin/user_activity/user_activity_summary_by_daterange.php> User Activity-HOME </A></font></H2>";

echo "<br />";

echo "<table border=1>";
echo "<tr><td><H3><font color=blue>Current View:</font> <font color=red>User_Activity_detail_by_daterange</font></H3></td></tr>";
echo "<tr><td></td></tr>";
echo "<tr><td>Other Views</td></tr>";
	 
echo "<tr><td><A href=/budget/admin/user_activity/user_activity_records_by_daterange.php> User Activity Records by Daterange </A></td></tr>";
...
//////mysql_close();
	...
	echo"<form method=post action=user_activity_detail_by_daterange.php>";
	 echo "<table border=1>";
...
$query3="SELECT tempid, user_level, location, filename as 'page',count(filename) as 'page_count'
FROM `activity2`
WHERE 1 AND tempid != '' and time2>='$start_date' and time2<='$end_date' and tempid='$tempid2'
GROUP BY tempid,page
ORDER BY tempid,page ASC ";
...
"<tr> 
       ...
       <th><font color=blue>page_count</font></th>
       </tr>";
