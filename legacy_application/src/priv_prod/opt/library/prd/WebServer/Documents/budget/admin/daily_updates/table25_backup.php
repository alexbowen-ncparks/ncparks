...
$db="$today_date";
$ta25="crs_tdrr_deposits_daily_summary";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta25.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta25$ct`
SELECT *
FROM `budget`.`$ta25` ;";
...
$query2a="select count(*) as 'record_count25' from `budget_daily_backup`.`$db$ta25$ct` ";
