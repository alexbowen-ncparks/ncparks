...
if($submit=='Add_Mission')

{
$alert_note=addslashes($alert_note);

$query2=" insert into missions set
location='$location',
...
header("location: missions.php?comment=y&location=$location&folder=community&category_selected=y&name_selected=y&project_note_id=$project_note_id&add_comment=y");
