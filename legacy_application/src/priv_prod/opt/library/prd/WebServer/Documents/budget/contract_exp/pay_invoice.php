...
//echo "<tr><td><font color='blue'>Division/Section/Prog</font></td><td><input type='text' name='con_location' size='70' autocomplete='off' value='Parks & Recreation-$center_desc2' ></td><td><font color='blue'>PO Line-Original Amount</font><td><input type='text' name='con_original' size='10' autocomplete='off' value='$con_original' ></td></tr>";
	   echo "<tr><td><font color='blue'>Division/Section/Prog</font></td><td><textarea name='con_location' rows='2' cols='30'>Parks&Recreation-$center_desc2</textarea></td><td><font color='blue'>PO Line-Original Amount</font><td><input type='text' name='con_original' size='10' autocomplete='off' value='$con_original' ></td></tr>";
	   ...
	   echo "<tr><td><font color='blue'>Purpose</font></td><td><textarea name='con_purpose' rows='2' cols='30' >$con_purpose</textarea></td></tr>";
