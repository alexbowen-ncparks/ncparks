...
{
$query1="update pcard_users set employee_number='$employee_number',affirmation_abundance='$affirmation_abundance' where id='$id' ";
...
echo "<H1 ALIGN=LEFT > <font color='$color'><i>$affirmation_abundance($color)</font></i></H1>";
...
{
$query3g="select 
admin,last_name,first_name,position_number,job_title,photo_location,location,act_id,card_number,comments,justification,document_location,id
...
if($document_location_final != ""){$document="yes";} else {$document="";}
if($document_location_final != ""){$bgc="lightgreen";} else {$bgc="lightpink";}
