...
//echo "Line 49: center=$center<br />";

$query10="SELECT new_center
from center
WHERE old_center='$center'
";

//echo "Line 56: query10=$query10<br />";
...
//echo "Line 64: new_center=$new_center<br />";
...
echo "<td><font color='blue'><b>Current Year budget for</b></font> => <font color='blue'><b>$budget_group_menu</b></font></td>";

// Menu 000
// tbass deleted on 12/23/18
/*
 ...
 */ 
 // line 124 changed to below on 2/4/16
 
 if($budget_group_menu=="equipment"){echo "<td>View Approved  <a href='/budget/aDiv/equipment_division.php?passParkcode=$passParkcode&passLevel=1&pay_center=$new_center&f_year=$f_year&division_approved=y&submit=Submit'>Equipment Items</a></td>";}
...
// changed to below on 2/4/16

if($budget_group_menu=="equipment")
		{
		$link2="<td>View Approved  <a href='/budget/aDiv/equipment_division.php?pay_center=$new_center&f_year=$f_year&division_approved=y&submit=Submit' target='_blank'>Equipment Items</a></td>";
		}
...
//echo "Line 252: Center=$center<br />";
// *********** Level 1 ************
...
if($budget_group_menu=="equipment"){$link2="<td>View Approved  <a href='/budget/aDiv/equipment_division.php?pay_center=$new_center&f_year=$f_year&submit=Submit' target='_blank'>Equipment Items</a></td>";}
...
include_once("../../../include/parkcountyRCC_i.inc");
...
else{$center=$_SESSION['budget']['centerSess_new'];}
}// end Level = 1
...
";
 $result = @mysqli_query($connection, $query);
if(@$showSQL=="1"){echo "$query<br><br>";}
 //echo "Line 404: Center=$center<br />";
...
";
 $result = @mysqli_query($connection, $query);
/*
  $query = "update budget1_available1,center 
            set budget1_available1.center=center.old_center 
...
$groupBy
order by parkcode,account";
//echo "<br /><br /><br />Line 485: sql=$sql<br /><br /><br />";
}
...
//$dontShow=array("center","dist","section","budget_group","cy_allocation");
...
//echo "Line523: parkcode=$parkcode<br />";
...
(
/*
$budget_group_menu=="opex-repairs_building" 
   or $budget_group_menu=="opex-supplies_admin" 
   or $budget_group_menu=="opex-repairs_equipment"
   or $budget_group_menu=="opex-repairs_vehicles"
   or $budget_group_menu=="opex-services"
   or $budget_group_menu=="opex-supplies_admin"
   or $budget_group_menu=="opex-supplies_facility"
   or $budget_group_menu=="opex-supplies_safety"
   or $budget_group_menu=="opex-supplies_vehicles"
   or $budget_group_menu=="opex-utilities"
   
 */  
   
 $budget_group_menu=="opex-other_services" 
   or $budget_group_menu=="opex-supplies_admin" 
   or $budget_group_menu=="opex-outside_vendor_repairs"
   or $budget_group_menu=="opex-supplies_purchased_by_dpr"
   or $budget_group_menu=="opex-utilities"
 ...
 {	
echo "<td colspan='3'><a href='op_exp_transfer.php?f_year=$f_year&center=$center&budget_group_menu=$budget_group_menu&submit=Submit' target='_blank'>Transfer Funds</a> between Accounts</td></tr>";
}
