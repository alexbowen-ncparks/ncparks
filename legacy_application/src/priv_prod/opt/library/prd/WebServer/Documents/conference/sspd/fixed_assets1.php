...
if($type=='add')
{
echo "<table ALIGN='center' ><tr><th><font color=brown></th><td><font $shade_add><a href='fixed_assets1.php?menu_fa=fa1&type=add'>Add</a></font></td><td><font $shade_search><a href='fixed_assets1.php?menu_fa=fa1&type=search'>Search</a></font></td></tr></table>";
echo "<br />";	
...
{	
echo "<table ALIGN='center' ><tr><td><font $shade_add><a href='fixed_assets1.php?menu_fa=fa1&type=add&menu=$menu'>Add</a></font></td><td><font $shade_search><a href='fixed_assets1.php?menu_fa=fa1&type=search'>Search</a></font></td></tr></table>";
echo "<br />";	
...
echo "<table ALIGN='center' ><tr><th><font color=brown><i>FAS#</font></i></th><td><font $shade_add><a href='fixed_assets1.php?menu_fa=fa1&type=add&menu=$menu'>Add</a></font></td><td><font $shade_search><a href='fixed_assets1.php?menu_fa=fa1&type=search&menu=$menu'>Search</a></font></td></tr></table>";
echo "<br />";	
...
if($id!=$idS)
{
echo "<td><a href=fixed_assets1.php?menu_fa=fa1&type=search&fas_search=search&parkS=$parkS&fas_numS=$fas_numS&del=yes&idS=$id><img height='15' width='15' src='/budget/infotrack/icon_photos/mission_icon_photos_263.png' alt='red trash can' title='delete'></img></a></td>";
}
if($id==$idS)
{
