...
echo "<tr><th colspan='4'>Detail Check List</th></tr>";
echo "<tr>"; 
...
echo "<th align=left><font color=brown>Payor/Vendor Name</font></th>";
...
echo "</tr>";
 ...
 echo "<tr><td></td><td></td><td></td><td>Detail Total Debits</tr>";
 echo "<tr><td></td><td></td><td>$total_check_amount</td><td>Detail Total Credits</tr>";
  echo "</table>";
 echo "</div>";
 echo "</body></html>";
