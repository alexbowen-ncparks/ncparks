...
$query3="select parkcode,park_name,district,section,
...
"<tr$t>"; 
        ...
        // echo "<td><a href='reports_one_budget_group_summary_by_center.php?budget_group=$budget_group'>$budget_group</a></td>"; 
		 echo "<td><a href='center_three_yr_history_budget_groups.php?report=$report&amp;section=$section&amp;district=$district&amp;accounts=$accounts&amp;history=$history&amp;period=$period&amp;parkcode=$parkcode'>$parkcode</a></td>"; 
