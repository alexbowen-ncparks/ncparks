...
//if(@$rep==""){include_once("../menu_js.php");}
if(@$rep==""){include_once("../menus3_js_tony.php");}
...
and ncas_credit != 'x' 
group by id";
    $result = @mysqli_query($connection, $query) or die ("Couldn't execute query line 100. $query".mysqli_error());
...
and ncas_yn != 'y' group by id";
    $result = @mysqli_query($connection, $query) or die ("Couldn't execute query line 133. $query".mysqli_error());
if(@$showSQL=="1"){echo "$query<br><br>";}
//echo "$query<br>";//exit;
/*
 $query = "insert into budget1_unposted(
...
where 1 and coa.budget_group='$budget_group_menu'
...
where 1 and coa.budget_group='$budget_group_menu' and fy_req='$f_year'
group by center,ncas_acct;";
//echo "$query<br>";//exit;

 $result = @mysqli_query($connection, $query) or die ("Couldn't execute query line 211. $query".mysqli_error());
if(@$showSQL=="1"){echo "$query<br><br>";}
...
//echo "$query<br>";//exit;
 ...
 $result = @mysqli_query($connection, $query) or die ("Couldn't execute query line 237. $query".mysqli_error());
if(@$showSQL=="1"){echo "$query<br><br>";}
...
//echo "$query<br>";//exit;
 ...
 $result = @mysqli_query($connection, $query) or die ("Couldn't execute query line 260. $query".mysqli_error());
if(@$showSQL=="1"){echo "$query<br><br>";}
/*
$query = "update opexpense_transfers_4_form,center 
            set opexpense_transfers_4_form.center=center.old_center 
            where opexpense_transfers_4_form.center=center.new_center
";
...
$headerArray=array("center_code","ncas_number","acct_description","cy_budget","cy_actual","cy_unposted","available_balance","transfer_request");
...
left join center on opexpense_transfers_4_form.center=center.new_center
where 1
