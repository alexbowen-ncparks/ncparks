...
if(@$_REQUEST['location']!="" and @$_REQUEST['ts']!="")
	{
	$today="0000-00-00";
...
if(empty($ARRAY)){echo "There are no items approved for surplus at this time."; exit;}
$c=count($ARRAY);
...
foreach($ARRAY AS $index=>$array)
	...
	//		echo "<td bgcolor='allceblue'>Mark as complete: <input type='checkbox' name='location' value='$curr_loc' onchange=\"this.form.submit()\"></td>";
			echo "</tr>";
			}
		}
	echo "</tr>";
...
if($c==1)
	...
	echo "<tr>
			...
			if($_SESSION['fixed_assets']['original_level']>3)
				{
				echo "<td bgcolor='allceblue'>Unmark as incomplete: 
