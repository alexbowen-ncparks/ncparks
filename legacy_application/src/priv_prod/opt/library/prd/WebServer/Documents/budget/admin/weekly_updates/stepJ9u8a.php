...
$query0="update partf_projects
         set funding_source='',funding_source_tab=''
		 where 1 ";
...
$query1="update partf_projects as t1,bd725_dpr_funding_sources3a as t2
         set t1.funding_source=t2.funding_source,t1.funding_source_tab='bd725_dpr'
		 where t1.center=t2.center and t1.funding_source='' ";
...
$query2="update partf_projects
         set funding_source='missing'
