...
<html><head>
 ...
 <title>
 <?php
 echo "$sciName Record at $park_code";
if(isset($s)){$form="setForm_add_new_form()";}else{$form="setForm()";}
 ?>
 </title>
<script language="JavaScript">
function setForm() {
    opener.document.autoSelectForm.lat.value = document.setLatLonForm.lat.value;
    opener.document.autoSelectForm.lon.value = document.setLatLonForm.lon.value;
    self.close();
    return false;
}
...
<table>
<tr><td><?php echo "Record at $park_code"; ?></td></tr>
<tr>
	...
	<div style="width: 800px;" class="smalltekst">
		<font color='red'>
		Click "Set" to set the coordinates.</font>
		<br />
	...
	var baseLink = "https://10.35.152.9/exhibits/lat_long.php";
	var baseLink = "https://10.35.152.9/exhibits/lat_long.php";
