...
echo "<table align='center'><tr><td>Report=Y</td></tr></table>";//{echo "create check report" ;}

{
echo "<br />";


$query4="select center,center_code_temp,invoice_number,invoice_date,ncas_account,sum(bill_amount) as 'amount',sum(admin_fee_allocation) as 'admin_fee',sum(bill_amount+admin_fee_allocation) as 'adjusted_amount'
...
$query4_total="SELECT sum(bill_amount) as 'total_amount1',sum(admin_fee_allocation) as 'admin_fee_total',sum(bill_amount+admin_fee_allocation) as 'adjusted_amount_total'
          from dot_gas_detail
		  where valid='n' ";
...
$admin_fee_total=number_format($admin_fee_total,2);
...
echo "<td>$center</td>";
echo "<td>$center_code_temp</td>";
echo "<td>$ncas_account</td>";
echo "<td>$amount</td>";
echo "<td>$admin_fee</td>";
echo "<td>$adjusted_amount</td>";

echo "</tr>";

}
echo "<tr><td></td><td></td><td></td><td></td><td></td><td>Total</td><td>$total_amount1</td><td>$admin_fee_total</td><td>$adjusted_amount_total</td></tr>";
...
//echo "<table align='center'><tr><td>DOT Reports</td></tr></table>"; //exit;




include("fyear_head_dot_gas.php");// database connection parameters
echo "<br />";
