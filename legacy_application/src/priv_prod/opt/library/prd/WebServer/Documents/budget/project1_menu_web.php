...
//$where1=" and project_category='$project_category' and project_name='$project_name' and note_group='$note_group' and comment_id='' ";

if($level<'3'){$location=$location;} else {$location="";}

if($location != ""){$where2=" and location = '$location' ";}
if(!isset($where2)){$where2="";}

$query4="select project_note,weblink,note_group,project_note_id,record_complete from infotrack_projects_community where 1 $where1 $where2 order by project_note_id desc";
