...
//	$xx=$x_legend[$row['section']]-110;
	$xx=$xx+$barW+$gap;
		pdf_show_xy ($pdf, number_format($numA,0),$xx, $a+95);
		pdf_show_xy ($pdf, $b,$xx-5, $a+85);

$link="http://nature123.net/work_order/r_num_hours_work_order.php?hours=$b&submit=Enter";
			$starting_xpos = $xx+1;
			$starting_ypos = $a+83;
