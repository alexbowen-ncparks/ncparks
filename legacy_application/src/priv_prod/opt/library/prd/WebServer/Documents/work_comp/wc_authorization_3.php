...
$rename1=array("agency"=>"Employing Agency","last_name"=>"Employee's Last Name","first_name"=>"Employee's First Name","date_of_injury"=>"Date of Injury","name_of_employer"=>"Name of Employer","employer_sig"=>"Employee's Signature","treating_physician"=>"Treating Physician (if known)","location_injury"=>"Location of Injury (if known)","sup_man_name"=>"Supervisor/Manager Name","date_today"=>"Today's Date","emp_phone"=>"Employee's Phone","time_of_injury"=>"Time of Injury","sup_man_phone"=>"Supervisor/Manager Phone");
...
if(!empty($_FILES))
	...
	if(@$_POST['reupload']=="reupload")
		...
		{
		echo "<p><font size='+1'>We will now work with uploading the <b>Injury Data Collection for Supervisors</b> form.</font></p>";
		echo "Go to Step 4 <a href='incident_investigate_4.php?wc_id=$wc_id'>Form</a>";
		}
	exit;
	}
...
if(empty($show_wc_authorizaiton_upload) and empty($_POST['submit']))
	...
	echo "<img src='Step3_1.jpg' width='800'>";
	echo "<img src='Step3_2.jpg' width='800'>
	</WCform>";
	}
	else
	{
	if(!empty($error_message))
		...
		{
		echo "<WCupload><font size='+2'>You have indicated that all required <b>WC Authorization</b> fields are properly completed.<br /><br />You can now upload the form that has been scanned and saved as a PDF.</font><br /><br />
		<table align='center'><tr><td>
		<form method='POST' action='wc_authorization_3.php' enctype='multipart/form-data'>
...
$na=array("treating_physician","location_injury");

echo "<page2>";
echo "<form action='wc_authorization_3.php' method='POST'><table cellpadding='3'><tr>";
foreach($ARRAY AS $index=>$fld)
	{
	...
	if($fld=="agency")
		{
		echo "<td bgcolor='beige'><fieldset><legend>Section A: Patient Information</legend><table>";
		}
...
5.	Scan and save your paper form as a PDF file<br />
