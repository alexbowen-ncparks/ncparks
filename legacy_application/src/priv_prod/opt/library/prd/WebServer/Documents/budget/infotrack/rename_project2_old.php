...
if($num0==1){echo "<font color='red' size='5'>Error Message:</font> <font color='blue'>Notebook with Category: $project_category_new Topic: $project_name_new already exists.</font><br />Click the BACK button on your Browser to return to the Form";exit;}
...
$query2="update projects set project_category='$project_category_new',project_name='$project_name_new' where
