...
echo "<H2><font color='blue'>records=$num</font></H2>";
while($col=mysqli_fetch_array($result)){
$tables[]=$col[0];
}
//echo "<pre>";print_r($tables);"</pre>";exit;

if($tabdel != ""){echo "Table $tabdel has been deleted";}
echo "<table border=1>";
...
echo  "<td><input type='text' size='60' readonly='readonly' name='tabname' value='$tables[$n]'</td>";
