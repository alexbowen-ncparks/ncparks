...
$query2a="update energy_controllers_3,center
          set energy_controllers_3.ncas_center=center.old_center
		  where energy_controllers_3.centerpark=center.parkcode
...
$query6="update energy_controllers_3
set thm_quantity=uom_quantity*.955
where 1 and energy_group = 'propane'; ";

$result6=mysqli_query($connection, $query6) or die ("Couldn't execute query 6.  $query6");


$query6a="update energy_controllers_3
set avg_rate=dollar_amount/thm_quantity
where 1 and energy_group = 'propane'; ";
...
where 1 and energy_group = 'electricity'; ";
