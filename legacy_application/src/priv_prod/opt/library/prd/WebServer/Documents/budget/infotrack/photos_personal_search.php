...
echo "</table>";
echo "<h2 ALIGN=left><font color=brown>$search_term photos:$num5</font></h2>";
...
"<tr$t>
		   ...
		   <td><a href='rename_photo.php?&project_note_id=$project_note_id&search_term=$search_term' target='_blank'>rename</a></td>
