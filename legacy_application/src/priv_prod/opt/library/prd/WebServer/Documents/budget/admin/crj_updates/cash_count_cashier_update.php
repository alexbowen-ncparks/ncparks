...
extract($_REQUEST);
// Necessary when Regional Manager is approving as Park Manager  9/6/2019
if($level==2){$concession_location=$parkcode;}
/*
if($beacnum=='60033019')
{
...
$query4a="update cash_imprest_count_detail
          set player_match='n',score='0.00',player_match_amount='0.00',player_match_date='0000-00-00',authorized_match='n'
          where park='$concession_location' and fyear='$fyear' and cash_month='$cash_month'  ";
...
$query5="update cash_imprest_count_detail
         set player_match='y',player_match_date='$system_entry_date',player_match_amount='$manager_amount_total'
		 where cashier != '' and manager != '' and cashier_amount=manager_amount
		 and park='$concession_location' and fyear='$fyear' and cash_month='$cash_month' ";
...
$query6="select player_match_date,authorized_match from cash_imprest_count_detail
         where park='$concession_location' and fyear='$fyear' and cash_month='$cash_month' ";
...
if($player_match_date=='0000-00-00' or $authorized_match=='n'){$score='0.00';}

if($player_match_date != '0000-00-00' and $authorized_match=='y')
//echo "player_match_date=$player_match_date<br />";
//echo "authorized_match=$authorized_match<br />";exit;
{
...
if($mission_score=='0.00'){$mission_score='0.01';}
...
if($level==1)
{
{header("location: cash_imprest_count2.php?fyear=$fyear ");}
}

if($level==2)
{
{header("location: cash_imprest_count2.php?fyear=$fyear&park=$parkcode ");}
}
