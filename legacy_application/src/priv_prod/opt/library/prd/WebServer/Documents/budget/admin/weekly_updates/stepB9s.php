...
$ta="report_project_expenditures_summary2";
$ct=date("His");
...
(  `project_category` varchar( 5  )  NOT  NULL default  '',
 ...
 `project_manager` varchar( 35  )  NOT  NULL default  '',
 `status` varchar( 5  )  NOT  NULL default  '',
 `project_number` varchar( 10  )  NOT  NULL default  '',
 `center_number` varchar( 15  )  NOT  NULL default  '',
 `center_year_funded` varchar( 10  )  NOT  NULL default  '',
 `center_name` varchar( 75  )  NOT  NULL default  '',
