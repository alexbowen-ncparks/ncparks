...
echo "<html>";
if($upload=='y'){echo "<font color='red'>exp_rev_down_fund1000_temp  upload successful</font>";}
echo "<form enctype='multipart/form-data' method='post' action='import_csv_form_exp_rev_down_fund1000_temp_update.php'>
