...
(  `report_date` date NOT  NULL default  '0000-00-00',
 ...
 `count_1656` decimal( 10, 0  )  NOT  NULL default  '0',
 `count_1656_travel` decimal( 10, 0  )  NOT  NULL default  '0',
 `count_1669` decimal( 10, 0  )  NOT  NULL default  '0',
 `count_park_recon` decimal( 10, 0  )  NOT  NULL default  '0',
 `budget_ok` char( 1  )  NOT  NULL default  '',
 `budget2controllers` date NOT  NULL default  '0000-00-00',
 `deadline_ok` char( 1  )  NOT  NULL ,
