...
$db="$today_date";
$ta16="purchase_approval_report_dates";
...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta16.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta16$ct`
SELECT *
FROM `budget`.`$ta16` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta16$ct` 
(
...
$query2a="select count(*) as 'record_count16' from `budget_daily_backup`.`$db$ta16$ct` ";
