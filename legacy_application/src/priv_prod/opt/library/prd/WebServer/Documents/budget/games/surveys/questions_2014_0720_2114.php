...
echo "</head>"; 
echo "<body>";
echo "<table><tr><th>New Survey</th></tr></table>";
echo "<br />";
...
echo "<td align=\"center\">SurveyName<br><input type=\"text\" name=\"game\" value=\"$game\" size=\"50\" autocomplete=\"off\"></td>";
...
echo "<body>";
echo "<table><tr><th>SurveyName: $game</th></tr></table>";echo "<br /><br />";
echo "<form method='POST'>";
//echo "<table border='1'>";

//echo "</table>";//exit;
echo "<table border='1'>";
echo "<tr><th>line</th><th>Question</th>";
