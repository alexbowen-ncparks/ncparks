...
if($summary=='y'){$shade_summary="class=cartRow";}


echo "<table><tr><td><a href='user_activity_matrix.php?report=file_group&summary=y&section=$section&user_level=$user_level&history=$history&period=$period&range_year_start=$range_year_start&range_month_start=$range_month_start&range_day_start=$range_day_start&range_year_end=$range_year_end&range_month_end=$range_month_end&range_day_end=$range_day_end'><font  $shade_summary>Summary</font></a></td></tr></table>";
