...
if($idS!='' and $del=='yes' and $conf=='y')
{
//echo "Query to Delete Record here";	
$query1="update sspd1 set active='n' where id='$idS' ";
...
//if($type==''){$type='add';}
if($type==''){$type='search';}
if($type=='edit' and $id==''){$type='search';}
if($type=='add'){$shade_add="class='cartRow'";}
if($type=='search'){$shade_search="class='cartRow'";}

if($type=='add')
{
if($tempid=='Gallagher9613' or $tempID=='Gallagher9613')
{
echo "<br />";	
echo "<table ALIGN='center' ><tr><th><font color=brown></th><td><font $shade_add><a href='sspd1.php?menu=$menu&type=add'>Add</a></font></td><td><font $shade_search><a href='sspd1.php?menu=$menu&type=search'>Search</a></font></td></tr></table>";
echo "<br />";	
}
...
echo "<table  align='center'>";
	   ...
	   echo "<tr>";
	   echo "<th><font color='brown'>User Location</font></th><td>$user_location</td>";
	   echo "</tr>";
...
{	
echo "<br />";
echo "<table ALIGN='center' ><tr><td><font $shade_add><a href='sspd1.php?type=add&menu=$menu'>Add</a></font></td><td><font $shade_search><a href='sspd1.php?type=search&menu=$menu'>Search</a></font></td></tr></table>";
echo "<br />";	
}
...
$query1="select id,menu,park,document_description,document_location,sed,entered_by
         from sspd1 where 1 and menu='$menu' and active='y' ";		 
...
echo "<tr><th>User<br />Location</th><th>User<br />Name</th><th>Document<br />Description</th><th>Document</th></tr>";
...
if
(
$tempid=='Gallagher9613' or $tempID=='Gallagher9613'
)
{
echo "<td><a href=sspd1.php?menu=$menu&type=edit&id=$id>edit</a></td>";
if($id!=$idS)
{
echo "<td><a href=sspd1.php?type=search&menu=$menu&del=yes&idS=$id><img height='15' width='15' src='/budget/infotrack/icon_photos/mission_icon_photos_263.png' alt='red trash can' title='delete'></img></a></td>";
}
if($id==$idS)
{
echo "<td><font class='cartRow'><font color='red'>Delete Record?</font><br /><br /><table align='center' cellpadding='10'><tr$t><th><a href='sspd1.php?type=search&menu=$menu&del=yes&conf=y&idS=$id'>Yes</a></th><th><a href='sspd1.php?type=search&menu=$menu'>No</a></th></tr></table></font></td>";
...
echo "<table ALIGN='center' ><tr><th><font color=brown></th><td><font $shade_add><a href='sspd1.php?menu=$menu&type=add'>Add</a></font></td><td><font $shade_search><a href='sspd1.php?menu=$menu&type=search'>Search</a></font></td><td><font class='cartRow'>Edit</font></td></tr></table>";
echo "<br />";	

echo "<br />";	
if($comp=='yes')
{
echo "<table ALIGN='center' ><tr><th><font color=brown><i>Update Complete <img height='25' width='25' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of green check mark'></img></font></i></th></tr></table>";
echo "<br />";

}	
$query1="select park,document_description,document_location,sed,entered_by
         from sspd1 where id='$id' and active='y' ";
