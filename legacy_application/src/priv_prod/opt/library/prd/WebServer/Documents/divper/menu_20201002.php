...
if($_SESSION['divper']['level']<3)
	{
	$menuArray1=array("/divper/email_dpr.php","/divper/form.php","/divper/formEmpInfo_reg.php?f=park","/divper/lead_rangers.php","/divper/position_desc.php");
...
// 	"/divper/ssn.php",
// 	"Edit SSN by Park",
	$menuArray1=array("/divper/email_dpr.php","/divper/form.php","/divper/formEmpInfo_reg.php?f=park","/divper/lead_rangers.php","/divper/position_desc.php","/divper/vacancy/request2post.php","/divper/supervisor_levels.php");
...
$menuArray1=array("/divper/formEmpInfo_reg.php?q=name","/divper/formEmpInfo_reg.php?q=beacon","/divper/contactInfoUnit.php?q=park","/publications/listing.php");
...
$menuArray2=array("Find Employee by Last Name","Find Employee by BEACON Position Number","Contact Info for a Park","Publications Inventory");
//echo "<pre>"; print_r($_SESSION); echo "</pre>"; // exit;
...
if($_SESSION['divper']['level']>5)
	{
// 	$menuArray1[]="/divper/contactInfo1_reg.php";
// 	$menuArray2[]="Personnel by Section-Region";
	}
...
// 		"/divper/form_excel_dept.php",
		$menu2=array("/divper/findVacant_reg.php","/divper/form_excel_DNCR.php","/divper/form_excel_div.php","/divper/track_vacant.php","/divper/assignPosition.php?admin=traPos", "/divper/formEmpInfo_reg.php?q=name", "/divper/contactInfo1_edit.php","/divper/formEmpInfo_reg.php?submit=New","/divper/~photoID.php","/divper/~photoID_retired.php","/divper/lack_emer_contact.php","/divper/cdl_report.php","/divper/cdl_active.php","/divper/leo_active.php","/divper/combo_cdl_leo.php","/divper/import_B0149.php");
		...
		$menu2=array("/divper/findVacant_reg.php","/divper/work_comp.php","/divper/assignPosition.php?admin=traPos", "/divper/formEmpInfo_reg.php?q=name", "/divper/formEmpInfo_reg.php?submit=New");
		}
	...
	$con=$menu2[$n];
		...
		$menu2=array("/divper/findVacant_reg.php","/work_comp/index.html");
		if($tempLevel==2)
			{
