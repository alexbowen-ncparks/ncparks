...
//echo "<br />"; 
//echo "today_date=$today_date <br />";exit;
...
$query1="update partf_projects,report_projects_update_approve_amount
          set partf_projects.div_app_amt='$partf_projects_amt'
		  where partf_projects.projnum='$projnum';";
		  
mysqli_query($connection, $query1) or die ("Couldn't execute query 1. $query1");		  
		  
$query2="update partf_projects,report_projects_update_approve_amount
          set partf_projects.div_app_amt_set='yes'
		  where partf_projects.projnum='$projnum';";
...
$query3="update partf_projects,report_projects_update_approve_amount
          set partf_projects.div_app_amt='$partf_fund_trans_amt'
		  where partf_projects.projnum='$projnum';";
		  
mysqli_query($connection, $query3) or die ("Couldn't execute query 3. $query3");		  
		  
$query4="update partf_projects,report_projects_update_approve_amount
          set partf_projects.div_app_amt_set='yes'
		  where partf_projects.projnum='$projnum';";
...
{header("location: stepJ9n.php?project_category=$project_category&project_name=$project_name&step_group=$step_group&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date");}
//exit;
/*
