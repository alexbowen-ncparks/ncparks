...
$query14="
select receive_date2,ncas_invoice_date as 'invoice_date',ncas_invoice_number as 'invoice_trans_id',vendor_name,comments,account_description,ncas_invoice_amount as 'invoice_amount',pcard_yn from cvip_small_purchases
		 where 1
		 and f_year='$f_year'
		 and month_number='$month_number'
		 and valid = 'y'
