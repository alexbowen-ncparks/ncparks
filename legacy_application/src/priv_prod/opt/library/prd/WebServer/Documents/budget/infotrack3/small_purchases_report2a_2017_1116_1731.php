...
if($fyear=='1415'){$start_date='20140701'; $end_date='20150630';}
if($fyear=='1516'){$start_date='20150701'; $end_date='20160630';}
if($fyear=='1617'){$start_date='20160701'; $end_date='20170630';}
if($fyear=='1718'){$start_date='20170701'; $end_date='20180630';}

//echo "start_date=$start_date<br /><br />";
...
WHERE datesql >=  '$start_date'
and datesql <= '$end_date'
AND (ncas_center LIKE  '1280%' or ncas_center LIKE '1680%')
group by id; ";
...
WHERE transdate_new >=  '$start_date'
and transdate_new <= '$end_date'
AND (center LIKE  '1280%' or center LIKE '1680%')
group by id ; ";
...
$result26a = mysql_query($query26a) or die ("Couldn't execute query 26a.  $query26a");


$query26b="update cvip_small_purchases
           set comments=replace(comments,'\"','') ";

$result26b = mysql_query($query26b) or die ("Couldn't execute query 26b.  $query26b");
...
$result29b = mysql_query($query29b) or die ("Couldn't execute query 29b.  $query29b");
...
$result29c = mysql_query($query29c) or die ("Couldn't execute query 29c.  $query29c");
...
$result29d = mysql_query($query29d) or die ("Couldn't execute query 29d.  $query29d");
...
$result29e = mysql_query($query29e) or die ("Couldn't execute query 29e.  $query29e");
...
// populate "park" field for records with NEW Centers beginning with 1680
$query44a="update cvip_small_purchases,center
set cvip_small_purchases.park=center.parkcode
where cvip_small_purchases.ncas_center like '1680%'
and cvip_small_purchases.ncas_center=center.new_center; ";

$result44a = mysql_query($query44a) or die ("Couldn't execute query 44a.  $query44a");


// populate "park" field for records with OLD Centers beginning with 1280
$query45="update cvip_small_purchases,center
set cvip_small_purchases.park=center.parkcode
where cvip_small_purchases.ncas_center like '1280%'
and cvip_small_purchases.ncas_center=center.old_center; ";

$result45 = mysql_query($query45) or die ("Couldn't execute query 45.  $query45");


// populate "district" field for records with NEW Centers beginning with 1680
...
$result45a = mysql_query($query45a) or die ("Couldn't execute query 45a.  $query45a");


// populate "district" field for records with OLD Centers beginning with 1280
$query45b="update cvip_small_purchases,center
set cvip_small_purchases.district=center.dist
where cvip_small_purchases.ncas_center like '1280%'
and cvip_small_purchases.ncas_center=center.old_center; ";


$result45b = mysql_query($query45b) or die ("Couldn't execute query 45b.  $query45b");





$query46="update cvip_small_purchases
          set f_year='$fyear'
          where 1  ";

$result46 = mysql_query($query46) or die ("Couldn't execute query 46.  $query46");
...
if($level=='5')
{			 
$spreadsheet_icon="<a href='small_purchases_report2a.php?rep=spreadsheet&f_year=$fyear&month_number=$month_number' target='_blank'><img height='50' width='50' src='/budget/infotrack/icon_photos/csv1.png' alt='reports icon' title='spreadsheet download'></img>";
