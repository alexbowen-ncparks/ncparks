...
include ("park_deposits_report_menu.php");
//include ("park_posted_deposits_widget1.php");
include ("park_posted_deposits_fyear_header2.php");
...
$query5="select f_year,month,day,deposit_id,sum(amount) as 'amount' from crj_posted6
where f_year='$f_year'
and center='$center'
group by center,f_year,month,day,deposit_id
...
$query6="select sum(amount) as 'amountT' from crj_posted6
where f_year='$f_year'
and center='$center' ;";
...
echo "<table><tr><td><font size='4' color='red'>Deposits: $num5</font></td></tr></table>";
