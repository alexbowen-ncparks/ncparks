...
$sql="SELECT distinct park from piers"; ////echo "$sql";
 $result = @mysqli_QUERY($connection,$sql);
while($row=mysqli_fetch_assoc($result))
		{
		$park_array[]=$row['park'];
...
if($object=="all")
	{
// 	echo "<pre>"; print_r($all_objects); echo "</pre>";  //exit;
	echo "<table align='center' border='1'><tr><td>$year $park</td></tr>
	<tr>";
...
echo "<td><form action='revenue.php'>
<select name='park' onchange=\"this.form.submit()\">";
echo "<option selected=''>Select a Park</option>";
...
if($year!="")
	{
	echo "<tr><td><form action='revenue.php'>
	<input type='hidden' name='object' value='all'>
	<input type='hidden' name='year' value='$year'>";
	if(!empty($park))
		{
		echo "<input type='hidden' name='park' value='$park'>";
		echo "<input type='submit' name='submit' value='Total Revenue for Year and Park'>";
		}
		else
		{
		echo "<input type='submit' name='submit' value='Total Revenue for Year'>";
		}
	echo "</form></td>";
	}
if(empty($year))
...
echo "
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=buoy_fee'>Buoy Fee</a></td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=ramp_fee'>Ramp Fee</a></td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=pier_mod_fee'>Pier Modification Fee</a></td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=pier_fee_50'>Annual Pier Fee <51</a> feet</td>
</tr>
<tr>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=pier_fee_51'>Annual Pier Fee >50</a> feet</td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=pier_fee_101'>Annual Pier Fee >100</a> feet</td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=pier_fee_151'>Annual Pier Fee >150</a> feet</td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=commercial_fee_225'>Commercial Pier Fee <226</a> feet</td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=commercial_fee_226'>Commercial Pier Fee >225</a> feet</td>
</tr>
<tr>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=commercial_ramp'>Commercial Ramp Fee</a></td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=commercial_buoy'>Commercial Buoy Fee</a></td>
<td valign='top' align='center'><a href='revenue.php?$pass_var&&object=swim_line'>Swim Line Fee</a></td>
</tr></table>";
