...
(  `hid` int( 10  )  unsigned NOT  NULL  auto_increment ,
 `date` date NOT  NULL ,
 `header_message` varchar( 200  )  NOT  NULL ,
 `message` text NOT  NULL ,
 `header_message2` varchar( 200  )  NOT  NULL ,
 `header_message2_date` date NOT  NULL ,
 `weekend` char( 1  )  NOT  NULL default  'n',
 `undeposited_message` char( 1  )  NOT  NULL default  'n',
 `special_notice` text NOT  NULL ,
 `gid` int( 10  )  NOT  NULL ,
 `headline_mission_file` varchar( 150  )  NOT  NULL ,
 PRIMARY  KEY (  `hid`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
