...
$db="$today_date";
$ta="crs_tdrr_division_adjustments";
$ct=date("His");
//echo $ct;exit;
...
(  `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 ...
 `orms_adjustments` int( 11  )  NOT  NULL ,
 `orms_adjust_date` date NOT  NULL ,
 `orms_adjust_amount` decimal( 12, 2  )  NOT  NULL ,
 ...
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `orms_deposit_id_2` (  `orms_deposit_id` ,  `orms_adjust_date`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
";
