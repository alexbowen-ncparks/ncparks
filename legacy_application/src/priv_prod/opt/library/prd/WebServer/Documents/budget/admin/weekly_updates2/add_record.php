...
echo "<form name='form1' method='post' action='add_record_update.php'>";
...
echo "<table border=1>";
	   ...
	   echo "<tr><td><font color='red'>step_group_name</td></font><td><input type='text' name='step' value='$step'></td></tr>";
