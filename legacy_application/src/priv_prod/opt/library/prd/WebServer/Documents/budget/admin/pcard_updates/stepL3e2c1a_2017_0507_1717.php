...
and (pcard_unreconciled_xtnd_temp2.division='' or pcard_unreconciled_xtnd_temp2.division='canc') ";
...
mysql_query($query1d) or die ("Couldn't execute query 1d.  $query1d");


$query1e="update pcard_unreconciled_xtnd_temp2
         set dpr='n' where dpr!='y' ";



mysql_query($query1e) or die ("Couldn't execute query 1e.  $query1e");
...
$query5="SELECT xtnd_report_date,cardholder,card_number2,division2,count(id) as 'records' FROM pcard_unreconciled_xtnd_temp2 where
        (division='' or division='canc') group by xtnd_report_date,cardholder,card_number2 order by xtnd_report_date,cardholder,card_number2 ";
...
if($num5==0){echo "<table align='center'><tr><td>NO Cardholders Missing Division</td><td><a href='stepL3e2c1a.php?status=complete'>Mark Complete</a></tr></table>"; exit;}
