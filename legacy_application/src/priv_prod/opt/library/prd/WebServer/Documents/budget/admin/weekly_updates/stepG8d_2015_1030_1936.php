...
echo  "<td>$amount</td>";
echo  "<td>$sign</td>";
echo  "<td><a href=stepG8d_update?pcard_trans_id=$pcard_trans_id&id=$id&project_category=$project_category&project_name=$project_name&step_group=$step_group&step_num=$step_num&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date>$pcard_trans_id</td>";
