...
echo  "<td>$invoice</td>";
echo  "<td><a href='stepJ9_update.php?&xtid=$xtid&center=$center&project_category=$project_category&project_name=$project_name&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date&step_group=$step_group&step=$step&step_num=$step_num&submit=center_match'>$amount</a></td>";
...
echo "<form method=post action=stepJ9_mark_complete.php>";	  
