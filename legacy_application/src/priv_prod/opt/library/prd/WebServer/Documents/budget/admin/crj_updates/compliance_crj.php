...
echo "</head>";
/* 2022-07-26: CCOOPER {TIC # 406} - Shimel does not have approval access to EADI parks
echo "<table>
<tr><td>tempID</td><td>pasu_role</td><td>disu_role</td></tr>
<tr><td>$tempID</td><td>$pasu_role</td><td>$disu_role</td></tr>
</table>"; */

/* 2022-07-26: End CCOOPER {TIC # 406}*/
extract($_REQUEST);
...
extract($row1b);
//echo "Line 86: manager_count=$manager_count<br />";
...
//if($beacnum=='60032781'){$cashier_count=0; $manager_count=0;}
...
group by park
";
//echo "Line 331: query4=$query4<br />";
$result4 = mysqli_query($connection, $query4) or die ("Couldn't execute query 4.  $query4");

$row4=mysqli_fetch_array($result4);
extract($row4);
//echo "Line 336: complianceYes=$complianceYes<br />";
