...
echo "<table border='3' align='center'>";
	   ...
	   echo "<tr><td><font color='brown'>(B)</font></td><td><font color='brown'>Enter Cost per gallon from invoice</font><br /><input name='invoice_amount' type='text'  size='15'></th></tr>";	   
	   //echo "<th>deposit amount<br /><input name='bank_deposit_ type='text'</th>";	   
	   echo "<tr><td><font color='brown'>(C)</font></td><td><font color='brown'>Locate JPEG Image of Invoice</font><br /><input type='file' id='document' name='document'><input type='hidden' name='content_mode' value='$content_mode' /><input type='hidden' name='MAX_FILE_SIZE' value='2000000'></td>";	   
	   
	   echo "</tr>";
	   echo "<tr><td><font color='brown'>(D)</font></td><td><font color='brown'>Click Submit</font><br /><input type='submit' name='submit' value='Submit'></td></tr>";
	   //echo "<tr><th></th></tr>";
