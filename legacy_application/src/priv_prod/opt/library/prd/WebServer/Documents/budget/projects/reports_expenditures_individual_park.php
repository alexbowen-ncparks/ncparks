...
echo "<H1 ALIGN=left><font color=brown><i>Expenditure Centers(Purchase4resale ONLY)- $num2 </i></font></H1>";
echo "<table border=1>";
...
"<tr$t> 
           ...
           <td><a href='reports_expenditures_individual_park.php?&parkcode_selected=y&parkcode=$parkcode'>$parkcode</a></td> 	
...
$query3="select account,account_description,budget_group,gmp,
...
echo "<H2 ALIGN=left><font color=brown><i>Expenditure Accounts(Purchase4resale ONLY)-$num3</i></font></H2>";
