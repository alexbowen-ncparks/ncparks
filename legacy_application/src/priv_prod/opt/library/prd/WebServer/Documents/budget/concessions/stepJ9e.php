...
echo "</tr>";
echo  "<form method='post' autocomplete='off' action='stepJ9e_update_all.php'>";
//exit;
...
{	
echo "<td><a href='stepJ9e.php?fund=$fund_out&start_date=$start_date&end_date=$end_date&projout_look=y'>projlist</a></td>";
}
...
{	
echo "<td><a href='stepJ9e.php?fund=$fund_in&start_date=$start_date&end_date=$end_date&projin_look=y'>projlist</a></td>";
}
...
$query11="select partf_projects.projnum,partf_projects.projcat,partf_projects.park,partf_projects.projname,partf_projects.statusper,partf_projects.div_app_amt as 'approve_amount',sum(partf_payments.amount) as 'payments_amount'
          from partf_projects
