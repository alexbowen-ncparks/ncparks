...
$oob=$ware_credits+$park_charges;

//echo "<br />ware_credits=$ware_credits<br />";
//echo "<br />park_charges=$park_charges<br />";
//echo "<br />oob=$oob<br />";


if($oob==0){$warehouse_balanced_exprev='y';}else{$warehouse_balanced_exprev='n';}

//echo "<br />warehouse_balanced_exprev=$warehouse_balanced_exprev<br />";

//exit;


if($warehouse_balanced_exprev=='n')
{

{echo "<br /><font color='red' size='8'>Table=exp_rev_ws (Warehouse Billings) are NOT in BALANCE</font><br />"; exit;}

}

/*
if($warehouse_balanced_exprev=='y')
{
