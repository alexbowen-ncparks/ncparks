...
$ta="report_budget_history_inc_stmt_by_fyear_net1";
$ct=date("His");
...
(  `center` varchar( 15  )  NOT  NULL ,
 ...
 `disburse_amt` decimal( 12, 2  )  NOT  NULL ,
 `receipt_amt` decimal( 12, 2  )  NOT  NULL ,
 `camping_cabin` decimal( 12, 2  )  NOT  NULL ,
 `concessions` decimal( 12, 2  )  NOT  NULL ,
 `other` decimal( 12, 2  )  NOT  NULL ,
 `center2` varchar( 15  )  NOT  NULL ,
 `scope` varchar( 10  )  NOT  NULL default  'other',
 `center_description` varchar( 100  )  NOT  NULL ,
