...
if($beacnum==60032794){$level=4;} //nrc laura fuller (Fuller1234)

if ($beacnum == 65027685 or $beacnum == 65027686)
{
	$level = 4;
	$_SESSION['budget']['level'] = $level;
}
...
if($submit=="Update"){
	...
	and projyn='y';
	";
$result = mysqli_query($connection, $sql) or die ("Couldn't execute update. $sql");
...
if($_SESSION['budget']['beacon_num']=="60032781"){$edit_yes=1;} //Budget Officer-Tammy Dodd
if($_SESSION['budget']['beacon_num']=="60032793"){$edit_yes=1;} //Accountant-Tony Bass
...
echo "<tr><td colspan='11' align='center'>Close this window or tab when done.</td><td><a href='prtf_center_budget.php?projnum=$projnum&center=$center&q=e'>Return to ProjNum $projnum payments</a></td></table>";
exit;}
