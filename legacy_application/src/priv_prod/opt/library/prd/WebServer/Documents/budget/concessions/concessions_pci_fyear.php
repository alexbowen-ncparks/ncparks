...
if($fyear==''){$fyear='2223';}
//if($fyear=='1617' and $force=='y'){$fyear='1617';}
//if($fyear=='1617' and $force!='y'){$fyear='1718';}
...
echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=2223&parkcode=$parkcode'><font  $shade_2223>2223</font></a></td>";
echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=2122&parkcode=$parkcode'><font  $shade_2122>2122</font></a></td>";
echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=2021&parkcode=$parkcode'><font  $shade_2021>2021</font></a></td>";
echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=1920&parkcode=$parkcode'><font  $shade_1920>1920</font></a></td>";
echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=1819&parkcode=$parkcode'><font  $shade_1819>1819</font></a></td>";
echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=1718&parkcode=$parkcode'><font  $shade_1718>1718</font></a></td>";
echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=1617&parkcode=$parkcode&force=y'><font  $shade_1617>1617</font></a></td>";
//echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=1516&parkcode=$parkcode'><font  $shade_1516>1516</font></a></td>";
//echo "<td><a href='concessions_pci_report.php?menu=pci&fyear=1415&parkcode=$parkcode'><font  $shade_1415>1415</font></a></td>";
