...
if(empty($submit))
	...
	<body>";
$file_array=array("dot_gas_import.csv");
	
	echo "<form method=post action=dot_gas_upload_cs1.php enctype='multipart/form-data'>";
...
echo "<H3 ALIGN=left><A href='/budget/infotrack3/dot_gas/step_group.php?project_category=ITS&project_name=dot_gas&step_group=B&report_type=form'>Return to DOT Gas</A></H3>";
echo "<table>";
