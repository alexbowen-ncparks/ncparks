...
//echo "<br />hello line 918<br />"; //exit;
$database=$db;
...
//echo "$sql";exit;
$result = @mysqli_query($connection,$sql) or die("$sql Error 1# c=$connection". mysqli_errno($connection) . ": " . mysqli_error($connection));
...
//echo "<br />hello line 1608<br /><br />page=$page<br />"; exit;
