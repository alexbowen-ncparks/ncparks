...
echo "<table border=1>";
echo "<tr><td><H3><font color=blue>Current View:</font> <font color=red>project_steps</font></H3></td></tr>";
echo "<tr><td></td></tr>";
...
if($project_name !=""){$query3="SELECT * FROM project_steps where 1 and project_name='$project_name' order by project_name,step_group asc";}
else {$query3="SELECT * FROM project_steps where 1  order by project_name,step_group asc";}
...
//////mysql_close();
	...
	// echo "</table>";
	 echo "<table border=1>";
	 echo "<tr><font color=red>Select Project</font></tr>";
	 echo "<tr>";
