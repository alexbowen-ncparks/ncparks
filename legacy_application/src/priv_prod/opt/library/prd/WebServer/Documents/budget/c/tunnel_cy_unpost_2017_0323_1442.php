...
echo "<tr><th>vendor</th><th>transaction_date</th><th>transaction_number</th><th>amount</th><th>transaction_type</th><th>Source ID</td></tr>";
$i=1;}

echo "<tr><td align='left'>$vendor_name</td><td align='center'>$transaction_date</td><td align='center'>$transaction_number</td><td align='right'>$transaction_amount</td><td align='center'>$transaction_type</td><td align='center'>$source_id</td><td><table border='1'><tr><td><a href='post_update.php?transaction_type=$transaction_type&source_id=$source_id&center=$center&acct=$acct' target='_blank'>Mark Paid</a></td></tr></table></td></tr>";
}
