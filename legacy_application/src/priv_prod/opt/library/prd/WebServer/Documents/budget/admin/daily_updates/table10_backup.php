...
$table_create3a = "CREATE TABLE "."`"."budget_daily_backup"."`"."."."`".$db.$ta10.$ct."`"." ";
...
$query2=" INSERT INTO `budget_daily_backup`.`$db$ta10$ct`
SELECT *
FROM `budget`.`$ta10` ;";
...
/*
$query1=" CREATE TABLE `budget_daily_backup`.`$db$ta10$ct` 
(
...
$query2a="select count(*) as 'record_count10' from `budget_daily_backup`.`$db$ta10$ct` ";
