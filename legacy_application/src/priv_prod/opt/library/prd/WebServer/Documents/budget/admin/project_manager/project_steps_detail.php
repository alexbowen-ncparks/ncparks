...
echo "<table border=1>";
echo "<tr><td><H3><font color=blue>Current View:</font> <font color=red>project_steps_detail</font></H3></td></tr>";
echo "<tr><td></td></tr>";
echo "<tr><td>Other Views</td></tr>";
	 
echo "<tr><td><A href=/budget/admin/project_manager/main.php> project_steps </A></td></tr>
      <tr><td><A href=/budget/admin/project_manager/project_substeps_detail.php> project_substeps_detail </A></td></tr>
</table>";
...
//if($project_name !=""){$query3="SELECT * FROM project_steps_detail where 1 and project_name='$project_name' order by project_name,step_group,step_num asc";}
//else {$query3="SELECT * FROM project_steps_detail where 1  order by project_name,step_group,step_num asc";}
...
//////mysql_close();
	...
	// echo "</table>";
	 echo "<table border=1>";
	 echo "<tr>";
echo"<td><form method=post action=project_steps_detail.php>";
echo "<font size=5>"; 
...
if($project_name !="")
{
$query5="SELECT * FROM project_steps_detail where 1 and project_name='$project_name' 
order by project_name,step_group,step_num asc";
$result5 = mysqli_query($connection, $query5) or die ("Couldn't execute query 5.  $query5");
$num5=mysqli_num_rows($result5);
echo "<font color='red'>Records: $num5</font>";
echo "<tr>"; 
    
	   echo   "<td><form method='post' action='duplicate_project_steps_detail.php'>";
	...
	echo "<input type='submit' name='submit' value='Add_Record'>
	 </form></td></tr>"; 
	   //echo "<br />";
...
"<tr$t>	
	   ...
	   <td>	   
	   <form method='post' action='edit_project_steps_detail.php'>
	   ...
	   <form method='post' action='edit_project_steps_detail_delete_verify.php'>
	   <input type='hidden' name='cid' value='$cid'>
       <input type='hidden' name='fiscal_year' value='$fiscal_year'>	   
	   <input type='hidden' name='project_category' value='$project_category'>	   
	   <input type='hidden' name='project_name' value='$project_name'>	   
       ...
       <form method='post' action='edit_project_steps_detail_duplicate.php'>
	   <input type='hidden' name='cid' value='$cid'>
       <input type='hidden' name='fiscal_year' value='$fiscal_year'>	   
	   <input type='hidden' name='project_category' value='$project_category'>	   
	   <input type='hidden' name='project_name' value='$project_name'>	   
