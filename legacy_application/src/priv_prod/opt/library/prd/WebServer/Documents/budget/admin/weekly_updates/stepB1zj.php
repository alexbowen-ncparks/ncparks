...
(  `f_year` varchar( 4  )  NOT  NULL ,
 ...
 `propane_account_number` varchar( 50  )  NOT  NULL default  '',
 `building_name` varchar( 75  )  NOT  NULL default  '',
 `energy_group` varchar( 75  )  NOT  NULL ,
 ...
 `average_rate` decimal( 12, 2  )  NOT  NULL default  '0.00',
 `total_cost_dollars` decimal( 12, 2  )  NOT  NULL ,
 `total_usage_thm` decimal( 12, 2  )  NOT  NULL ,
 `id` int( 10  )  unsigned NOT  NULL  auto_increment ,
 PRIMARY  KEY (  `id`  ) ,
 UNIQUE  KEY  `park` (  `park` ,  `propane_account_number` ,  `f_year`  ) ,
 KEY  `centerpark` (  `park`  ) ,
 KEY  `utility_account_number` (  `propane_account_number`  )  ) ENGINE  =  MyISAM  DEFAULT CHARSET  = latin1;
