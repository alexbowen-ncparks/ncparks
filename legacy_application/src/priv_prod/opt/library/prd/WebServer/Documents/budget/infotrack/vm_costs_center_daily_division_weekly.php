...
$query1="select sum(amount) as 'total_532331'
		 ...
		 where acct='532331'
		 and f_year='$f_year'
		 and acctdate >= '$start_date'
		 and acctdate <= '$end_date'
		 and parent_record != 'y' 
		 $where_park ";
...
$start_F4=substr($start_date,0,4);
$start_L4=substr($start_date,4,4);
$start_date2=$start_F4."-".$start_L4;
echo "start_date2=$start_date2<br />";

$end_F4=substr($end_date,0,4);
$end_L4=substr($end_date,4,4);
$end_date2=$end_F4."-".$end_L4;
...
echo "<table>";
echo "<tr><th><font color='brown'>Fiscal Year</font> $fiscal_year</th></tr>";
echo "<tr><th><font color='brown'>Start Date</font> $start_date2</th></tr>";
echo "<tr><th><font color='brown'>End Date</font> $end_date2</th></tr>";
echo "</table>";
