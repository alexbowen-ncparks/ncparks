...
$processed_date="2016-05-06";
$sql="SELECT t2.sort_order,t1.*, t2.product_title, t1.quantity, t2.current_cost, format(t1.quantity*t1.price,2) as cost From park_order as t1 left join base_inventory as t2 on t1.product_number=t2.product_number where t1.park_code='HABE' AND t1.ordered='x' AND t1.processed_date='2016-05-06' order by sort_order
";
$pass_sql=$sql;
//  echo "$sql"; exit;
$result = mysqli_query($connection, $sql) or die ("Couldn't execute query. $sql ".mysqli_error($connection));
