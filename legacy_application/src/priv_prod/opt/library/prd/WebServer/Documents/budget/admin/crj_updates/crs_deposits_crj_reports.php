...
//echo "deposits=$deposits";
 ...
 <img height='50' width='50' src='/budget/wake_tech/images/bank.jpg' alt='picture of bank'></img></a></th><th>Cash Receipts Journal- ORMS Deposit ID</th><td>$GCN <a href=crs_deposits_crj_reports.php?deposit_id=$deposit_id&GC=n><font $shade_deposit_id>$deposit_id</font></a></td>";
 if($deposits > 1){echo "<td>$GCY<a href=crs_deposits_crj_reports.php?deposit_id=$deposit_id&GC=y><font $shade_deposit_id_GC>$deposit_id_GC</font></a></td>";}
 "</tr></table>";}
 ...
 {$query12="SELECT crs_tdrr_history.center,center.parkcode,taxcenter,ncas_account,account_name,sum(amount) as 'amount'  from crs_tdrr_history
...
"<tr$t> 
            <td colspan='2'>Justification:</td><td colspan='3'>______________________________<br >______________________________</td>
		    <td></td>
		    <td></td>
		    <td></td>
...
$grand_total=number_format(($var_total_credit+$var_total_debit),2);



echo "<tr><td colspan='2'>Prepared by:<br />Approved by:<br />Entered by</td><td colspan='3'>___________________Phone#______________<br />__________________Date:________________<br />__________________Date:_______________</td><td>Total Debits</td><td>$var_total_debit</td></tr>";
...
"<tr$t> 
		    ...
		    <td></td>
		    <td></td>
		    <td>Total Credits<br /><br />Grand Total</td>
		    
		   <td>$var_total_credit<br /><br />$grand_total</td>
