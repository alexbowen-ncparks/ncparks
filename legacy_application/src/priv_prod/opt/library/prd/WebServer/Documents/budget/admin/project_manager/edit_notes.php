...
$query3="SELECT * FROM project_steps where cid='$cid' ";
...
echo "<table border=1>";
	   ...
	   echo "<tr><td><font color='red'>step_group</font></td><td><input type='text' name='project_name' value='$step_group'></td></tr>";	   
	   echo "<tr><td><font color='red'>step</font></td><td><input type='text' name='project_name' value='$step'></td></tr>";
