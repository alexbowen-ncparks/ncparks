...
<img height='50' width='50' src='/budget/infotrack/icon_photos/bank1.jpg' alt='picture of bank' title='Bank Deposits/Cash Receipts'></img></a>
</th>";
echo "<td><font size='5' color='brown'>Imprest Cash Verification (Monthly)</font></td>";
/*
if($level < '3')
{
echo "<td><font size='5' color='brown'>$concession_location</font></td>";
