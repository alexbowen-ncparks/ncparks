...
// 	echo "<pre>";print_r($_POST);echo "</pre>";   //exit;
	$skip=array("id","park_code","num_exist","num_need","submit_form","counter_type_need","counter_function_need","comments_need", "distance_from_VC_need", "time_to_check_need");
...
// 			echo "$sql<br />"; //exit;
	...
	$skip_need=array("id","park_code","num_exist","num_need","submit_form","counter_name","time_to_check","comments","lat","lon","counter_function","counter_type","distance_from_VC","method","counter_brand","see_insight_id");
...
// 		echo "$num_exist<pre>"; print_r($ARRAY_values); echo "</pre>"; // exit;
		}
