...
$query0="update table_menu2 set backup='n'
         where project_category='fms' and project_name='weekly_updates' and project_group='C' ";
...
$query="SELECT table_name,backup,id FROM `table_menu2`
        WHERE  project_category='fms' and project_name='weekly_updates' and project_group='C' and backup='n' 
...
echo "<tr><td colspan='3'><a href='stepB1c.php?mark_complete=y&project_category=$project_category&project_name=$project_name&step_group=$step_group&step_num=$step_num&fiscal_year=$fiscal_year&start_date=$start_date&end_date=$end_date'>Mark Complete</a></td></tr>";
echo "</table>";
