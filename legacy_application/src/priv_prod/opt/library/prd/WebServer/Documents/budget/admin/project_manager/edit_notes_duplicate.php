...
$query1="SELECT * FROM project_steps where cid='$cid'";
...
echo "<form name='form1' method='post' action='edit_notes_duplicate_insert.php'>";
...
echo "<table border=1>";
	   ...
	   echo "<tr><td><font color='red'>project_step</font></td><td><input type='text' name='step_group' value='$step_group'></td></tr>";
	   echo "<tr><td><font color='red'>project_step_name</td></font><td><input type='text' size='30' name='step' value='$step'></td></tr>";
