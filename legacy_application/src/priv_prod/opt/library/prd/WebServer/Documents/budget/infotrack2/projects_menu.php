...
$query4="select distinct project_category from infotrack_projects_community3 where 1 
...
{
//$project_category = addslashes($project_category);
$query4="select distinct project_name from infotrack_projects_community3 where 1 
