...
echo "<tr><td><img src='$picture[$a]' width='100'></td></tr>";
...
echo "<tr>";
echo "<td align='center' onMouseOver=\"this.bgColor='lightgreen'\" onMouseOut=\"this.bgColor='lightcyan'\"><a href='game_play_module.php?gid2=$Gid[$j]&gidS=none'>Play</a></td>";
echo "</tr>";
echo "</table>";
