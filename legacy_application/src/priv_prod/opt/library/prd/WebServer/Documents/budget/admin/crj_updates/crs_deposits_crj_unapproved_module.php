...
"<tr$t>
			...
			*/
			...
			if($cashier=='')
			{
		   echo "<td align='center' bgcolor='lightpink'><a href='/budget/admin/crj_updates/crs_deposits_cashier_deposit.php?deposit_id=$deposit_id&GC=$GC' >Cashier<br />Update</a></td>";
		   }
		   else
		   {
		   ...
		   */
		   ...
		   if($manager=='')
			{		   
		   echo "<td align='center' bgcolor='lightpink'><a href='/budget/admin/crj_updates/crs_deposits_cashier_deposit.php?deposit_id=$deposit_id&GC=$GC' >Manager<br />Update</a></td>";
		   }
		   else
		   {		   
		   ...
		   if($crj_days_elapsed > 2){echo "<br /><img height='50' width='50' src='/budget/infotrack/icon_photos/xmark1.png' alt='picture of green check mark'></img";}
		   echo "</td>";
           /*
		   if($fs_approver=='')
			{		   
