...
echo "<table>";
echo "<tr><td><font color=brown class=cartRow>Section<br />$section</font></td>";
if($section=='operations')
{echo "<td><font color=brown class=cartRow>District<br />$district</font></td>";}
//echo "<td><font color=brown class=cartRow>Budget Group<br />$budget_group</font></td>";
echo "<td><font color=brown class=cartRow>Account<br />$account_header</font></td>";
echo "<td><font color=brown class=cartRow>Account Description<br />$account_description_header</font></td>";
//echo "<td><font color=brown class=cartRow>Cash Type<br />$cash_type_header</font></td>";
//echo "<td><font color=brown class=cartRow>GMP<br />$gmp_header</font></td>";
echo "<td><font color=brown class=cartRow>History<br />$history</font></td>";
echo "<td><font color=brown class=cartRow>Period<br />$period</font></td></tr>";
