...
echo "report_summary_pending";	
	
}

if($report_detail=='y')
{
$sql = "SELECT cardholder,pcard_num,vendor_name,amount From pcard_unreconciled where admin_num='fala' and report_date='20170518'
...
echo "<tr><th>cardholder</th><th>CardNum</th><th>vendor</th><th>amount</th></tr>";
...
echo "<tr$t><td>$cardholder</td><td>$pcard_num</td><td>$vendor_name</td><td>$amount</td>";
