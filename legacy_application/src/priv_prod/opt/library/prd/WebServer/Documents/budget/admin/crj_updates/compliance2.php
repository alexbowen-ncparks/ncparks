...
$header_array=array("Park","Date","Beg Balance","Deposit Amount","Transaction Amount","End Balance","Days Elapsed (earliest undeposited transaction) ","PASU<br />Compliance<br />Comments","ID");
echo "<table>";
echo "<tr>"; 
    /*
...
"<tr$t>";
     ...
     echo "<td>$park</td>		   
		   ...
		   if($pasu_role=='y')
		   {
		  // echo "<input type=submit name=pasu_submit value=PASU_Update></form>";
		   }
		   }
		   
		    if($compliance=='n' and $pasu_comment!='')
		   {echo "$pasu_comment";echo "<img height='25' width='25' src='/budget/infotrack/icon_photos/green_checkmark1.png' alt='picture of green check mark'></img>";}
