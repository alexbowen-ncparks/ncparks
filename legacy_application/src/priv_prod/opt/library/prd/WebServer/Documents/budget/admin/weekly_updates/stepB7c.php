...
`step_group` char( 1 ) NOT NULL default '',
`step` varchar( 100 ) NOT NULL default '',
`step_num` varchar( 10 ) NOT NULL default '',
`step_name` text NOT NULL ,
`substep_num` varchar( 10 ) NOT NULL default '',
...
PRIMARY KEY ( `cid` ) ,
UNIQUE KEY `project_category` ( `project_category` , `project_name` , `step_group` , `step_num` , `substep_num` )
) ";
...
{$query6="update project_steps set status='complete' where project_category='$project_category'
